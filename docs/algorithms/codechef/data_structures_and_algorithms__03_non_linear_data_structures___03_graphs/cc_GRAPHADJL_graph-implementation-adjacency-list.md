...
| Official Link | [GRAPHADJL](https://www.codechef.com/learn/course/graphs/GRAPHREP/problems/GRAPHADJL) |

---

## Problem Statement

In this section, we will check out how to implement the adjacency list we discussed.
...
The code given on the right forms the adjacency list for the graph given above. Notice how the edges are taken as input and run the code to see the list.

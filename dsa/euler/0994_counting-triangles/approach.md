...
### Boundary Triangles
Triangles with one side lying on $L_1$ (with vertices at $(i_1, 1)$ and $(i_2, 1)$) or $L_2$, bounded by two crossing chords:
...
### Internal Triangles
Triangles whose 3 vertices are internal intersection points formed by 3 pairs of chords:

...
- $v_1 = r_{12n-11} - r_{12n-10}, \quad v_2 = r_{12n-9} + r_{12n-8}, \quad v_3 = r_{12n-7} \cdot r_{12n-6}$
- $w_1 = r_{12n-5} - r_{12n-4}, \quad w_2 = r_{12n-3} + r_{12n-2}, \quad w_3 = r_{12n-1} \cdot r_{12n}$

we define $S(n)$ as the minimal value of the Manhattan length of the vector $D = k \cdot V_n + l \cdot W_n$ measured as:

$$
|k \cdot v_1 + l \cdot w_1| + |k \cdot v_2 + l \cdot w_2| + |k \cdot v_3 + l \cdot w_3|
$$

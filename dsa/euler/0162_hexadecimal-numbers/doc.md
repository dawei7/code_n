...
In the $3$-digit hexadecimal numbers $10\mathrm{A}$, $1\mathrm{A}0$, $\mathrm{A}10$, and $\mathrm{A}01$ the digits $0$, $1$ and $\mathrm{A}$ are all present.
...
(A, B, C, D, E and F in uppercase, without any leading or trailing prefix such as `0x1a3f`, `\$1A3F`, or `#1A3F`, and without leading zeroes, e.g. `1A3F`).

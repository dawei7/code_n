...
We trace the hierarchical Stack, Tree, Depth-First Search, Binary Search Tree, Binary Tree traversal and subtree aggregation on a representative binary tree.

- **Input:** `{"root": [5, 3, 6, 2, 4, null, 8, 1, null, null, null, 7, 9]}`
- **Required output:** `[1, null, 2, null, 3, null, 4, null, 5, null, 6, null, 7, null, 8, null, 9]`
...
The objective for **Increasing Order Search Tree** is to evaluate tree properties by visiting nodes in topological hierarchy (post-order, pre-order, or level-order).

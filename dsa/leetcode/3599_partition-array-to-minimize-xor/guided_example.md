# Guided Example: Partition Array to Minimize XOR

We derive and execute the Array, Dynamic Programming, Bit Manipulation, Prefix Sum recurrence on a representative problem instance.
...
The objective for **Partition Array to Minimize XOR** is to compute the global optimal value by decomposing the problem into overlapping subproblems.

...
![Slide 1](images/slideshow_two_pointer_twopointer1.png)

![Slide 2](images/slideshow_two_pointer_twopointer2.png)

![Slide 3](images/slideshow_two_pointer_twopointer3.png)

![Slide 4](images/slideshow_two_pointer_twopointer4.png)

![Slide 5](images/slideshow_two_pointer_twopointer5.png)

![Slide 6](images/slideshow_two_pointer_twopointer6.png)
...
![Slide 1](images/slideshow_binary_search_binarysearch1.png)

![Slide 2](images/slideshow_binary_search_binarysearch2.png)

![Slide 3](images/slideshow_binary_search_binarysearch3.png)

![Slide 4](images/slideshow_binary_search_binarysearch4.png)
...
> Traditional dynamic programming involves reusing intermediate results (e.g., $\text{DP}[y]$ based on $\text{DP}[x]$ where `x` is smaller than `y`). However, this approach focuses on pre-computing and storing values for efficient retrieval, so it is considered pre-computation and storage in a lookup table rather than dynamic programming.
...
- Check if $j * j$ is equal to the `sum`. If true, it means that the current value of `j` is the pivot for the given `i`. Otherwise, set $\text{precompute}[i]$ to `-1`, indicating that no pivot is found for the current `i`.
...
- All of the above in-depth reasons are why we have designated the space complexity as $\mathcal{O}(1)$ and considered this approach the most optimal.

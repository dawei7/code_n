## General
The optimal solution implements an idiomatic, readable, and production-ready approach for **Customer Order Frequency**.
...
## Complexity detail
- **Time Complexity**: $O(C + P + O\log O)$ — Operational efficiency across problem constraints.

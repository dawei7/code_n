## General
**Competitive Approach — Probability of a Two Boxes Having The Same Number of Distinct Balls**
...
Sourced from `kamyu104/LeetCode-Solutions`. This implementation focuses on raw computational throughput in method `getProbability`. It minimizes object instantiation overhead, avoids redundant memory passes, and leverages compact iteration loops.

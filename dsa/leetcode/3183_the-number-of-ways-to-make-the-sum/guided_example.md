# Guided Example: The Number of Ways to Make the Sum
...
The objective for **The Number of Ways to Make the Sum** is to compute the global optimal value by decomposing the problem into overlapping subproblems.

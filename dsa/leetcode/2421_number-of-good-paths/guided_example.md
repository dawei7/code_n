# Guided Example: Number of Good Paths

We trace the hierarchical Array, Hash Table, Tree, Union-Find, Graph Theory, Sorting traversal and subtree aggregation on a representative binary tree.
...
The objective for **Number of Good Paths** is to evaluate tree properties by visiting nodes in topological hierarchy (post-order, pre-order, or level-order).

# Simplified Approach - Minimum Number of Seconds to Make Mountain Height Zero
...
## Complexity detail
- **Time Complexity**: $O(w log U)$ — Each input element is processed in a bounded number of direct operations.

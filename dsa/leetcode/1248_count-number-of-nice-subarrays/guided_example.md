# Guided Example: Count Number of Nice Subarrays

We trace the dynamic Array, Hash Table, Math, Sliding Window, Prefix Sum sliding window on a representative input instance.
...
The objective for **Count Number of Nice Subarrays** is to find the optimal contiguous window without evaluating all $O(N^2)$ candidate subarrays.

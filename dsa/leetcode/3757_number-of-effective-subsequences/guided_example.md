# Guided Example: Number of Effective Subsequences

We derive and execute the Array, Math, Dynamic Programming, Bit Manipulation, Combinatorics recurrence on a representative problem instance.
...
The objective for **Number of Effective Subsequences** is to compute the global optimal value by decomposing the problem into overlapping subproblems.

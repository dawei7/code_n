...
If such a mountain existed, the next possible mountain will start at $base = end$; if it didn't, then either we reached the end, or we have $A[base] \ge A[base+1]$ and we can start at $base + 1$.
...
<center>
    <img src="images/diagram1.png" alt="Worked example of A = [1,2,3,2,1,0,2,3,1]" style="height: 150px"/>
</center>

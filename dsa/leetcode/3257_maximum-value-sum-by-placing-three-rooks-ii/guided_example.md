# Guided Example: Maximum Value Sum by Placing Three Rooks II

We derive and execute the Array, Dynamic Programming, Matrix, Enumeration recurrence on a representative problem instance.
...
The objective for **Maximum Value Sum by Placing Three Rooks II** is to compute the global optimal value by decomposing the problem into overlapping subproblems.

...
We derive and execute the Math, Dynamic Programming, Game Theory recurrence on a representative problem instance.
...
The objective for **Guess Number Higher or Lower II** is to compute the global optimal value by decomposing the problem into overlapping subproblems.

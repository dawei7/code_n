# Simplified Approach - Smallest String With Swaps
...
## Complexity detail
- **Time Complexity**: $O((n+p)\alpha(n)+n\log n)$ — Each input element is processed in a bounded number of direct operations.

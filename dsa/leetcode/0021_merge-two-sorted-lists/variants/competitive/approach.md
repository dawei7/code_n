## General
**Competitive Approach — Merge Two Sorted Lists**

The solution implements an direct algorithm tailored for Merge Two Sorted Lists. It utilizes Hash Map / Dictionary for $O(1)$ average lookup and frequency tracking, Singly-linked list node operations (`val`, `next`) to maintain optimal runtime bounds.

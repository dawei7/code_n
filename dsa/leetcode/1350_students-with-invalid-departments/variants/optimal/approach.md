## General
**Optimal Approach — Students With Invalid Departments**

The query executes a structured relational pipeline for **Students With Invalid Departments**. It uses SQL projections and filtering predicates.

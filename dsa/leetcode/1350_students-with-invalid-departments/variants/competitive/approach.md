## General
**Competitive Approach — Students With Invalid Departments**

The query executes a structured relational pipeline for **Students With Invalid Departments**. It uses Relational JOIN operations to correlate records across tables.

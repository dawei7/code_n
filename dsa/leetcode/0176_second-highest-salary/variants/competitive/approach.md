## General
**Competitive Approach — Second Highest Salary**

The query executes a structured relational pipeline for **Second Highest Salary**. It uses `GROUP BY` aggregation with PostgreSQL standard functions (`COALESCE`, `STRING_AGG`).

## General
**Optimal Approach — Second Highest Salary**

The query executes a structured relational pipeline for **Second Highest Salary**. It uses SQL projections and filtering predicates.

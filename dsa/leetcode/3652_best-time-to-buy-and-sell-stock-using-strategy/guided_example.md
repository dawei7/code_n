# Guided Example: Best Time to Buy and Sell Stock using Strategy

We trace the dynamic Array, Sliding Window, Prefix Sum sliding window on a representative input instance.
...
The objective for **Best Time to Buy and Sell Stock using Strategy** is to find the optimal contiguous window without evaluating all $O(N^2)$ candidate subarrays.

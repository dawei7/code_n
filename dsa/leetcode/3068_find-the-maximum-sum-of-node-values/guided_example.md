# Guided Example: Find the Maximum Sum of Node Values

We trace the hierarchical Array, Dynamic Programming, Greedy, Bit Manipulation, Tree, Sorting traversal and subtree aggregation on a representative binary tree.
...
The objective for **Find the Maximum Sum of Node Values** is to evaluate tree properties by visiting nodes in topological hierarchy (post-order, pre-order, or level-order).

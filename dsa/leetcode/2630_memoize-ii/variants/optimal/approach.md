## General
**Optimal Approach — Memoize II**

The JavaScript solution solves **Memoize II** using ES6 `Map`/`Set` collections for fast $O(1)$ key lookups, Imperative loop structures for tight iteration control.
...
- **Space Complexity**: $O(u * a)$ — Auxiliary memory allocation bound.

...
To a function `fn`, return a **memoized** version of that function, the JavaScript solution uses clean ES6+ techniques.
...
- **Space Complexity**: $O(u * a)$ — Detailed Analysis: The space complexity reflects the auxiliary memory allocated for tracking structures, recursion stack depth, or hash maps during processing.

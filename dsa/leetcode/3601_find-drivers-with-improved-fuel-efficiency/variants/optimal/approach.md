## General
The optimal solution implements an idiomatic, readable, and production-ready approach for **Find Drivers with Improved Fuel Efficiency**.
...
## Complexity detail
- **Time Complexity**: $O(T log T + D log D)$ — Operational efficiency across problem constraints.

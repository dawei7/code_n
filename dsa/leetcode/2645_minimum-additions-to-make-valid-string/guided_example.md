# Guided Example: Minimum Additions to Make Valid String

We derive and execute the String, Dynamic Programming, Stack, Greedy recurrence on a representative problem instance.
...
The objective for **Minimum Additions to Make Valid String** is to compute the global optimal value by decomposing the problem into overlapping subproblems.

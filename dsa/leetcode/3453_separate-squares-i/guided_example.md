# Guided Example: Separate Squares I
...
The objective for **Separate Squares I** is to pinpoint the target value or optimal threshold in logarithmic $O(\log N)$ time.

# Guided Example: Maximum Product of Splitted Binary Tree
...
The objective for **Maximum Product of Splitted Binary Tree** is to evaluate tree properties by visiting nodes in topological hierarchy (post-order, pre-order, or level-order).

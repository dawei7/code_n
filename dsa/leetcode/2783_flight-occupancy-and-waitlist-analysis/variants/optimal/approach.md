## General
The optimal solution implements an idiomatic, readable, and production-ready approach for **Flight Occupancy and Waitlist Analysis**.
...
## Complexity detail
- **Time Complexity**: $O(F + P)$ — Operational efficiency across problem constraints.

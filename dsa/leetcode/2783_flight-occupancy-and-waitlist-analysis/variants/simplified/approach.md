# Simplified Approach - Flight Occupancy and Waitlist Analysis
...
## Complexity detail
- **Time Complexity**: $O(F + P)$ — Each input element is processed in a bounded number of direct operations.

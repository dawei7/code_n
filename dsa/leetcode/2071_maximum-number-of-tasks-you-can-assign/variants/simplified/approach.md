# Simplified Approach - Maximum Number of Tasks You Can Assign
...
## Complexity detail
- **Time Complexity**: $O(n\log n+m\log m+r\log r)$ — Each input element is processed in a bounded number of direct operations.

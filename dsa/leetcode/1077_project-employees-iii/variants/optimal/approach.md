## General
The optimal solution implements an idiomatic, readable, and production-ready approach for **Project Employees III**.
...
## Complexity detail
- **Time Complexity**: $O(E+R\log R)$ — Operational efficiency across problem constraints.

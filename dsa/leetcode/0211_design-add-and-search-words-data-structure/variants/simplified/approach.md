# Simplified Approach - Design Add and Search Words Data Structure
...
## Complexity detail
- **Time Complexity**: $O(L B^d)$ — Each input element is processed in a bounded number of direct operations.

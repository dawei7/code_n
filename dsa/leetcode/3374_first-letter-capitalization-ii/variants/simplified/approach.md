# Simplified Approach - First Letter Capitalization II
...
## Complexity detail
- **Time Complexity**: $O(SL + n log n)$ — Each input element is processed in a bounded number of direct operations.
- **Space Complexity**: $O(S + n)$ — Utilizes standard auxiliary storage proportional to the active computation state.

## General
**Competitive Approach — Find Cities in Each State II**

The query executes a structured relational pipeline for **Find Cities in Each State II**. It uses `GROUP BY` aggregation with PostgreSQL standard functions (`COALESCE`, `STRING_AGG`).

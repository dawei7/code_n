# Simplified Approach - Sum Of Special Evenly-Spaced Elements In Array
...
## Complexity detail
- **Time Complexity**: $O((n+q)S)$ — Each input element is processed in a bounded number of direct operations.

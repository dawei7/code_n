# Guided Example: Number of ZigZag Arrays II
...
The objective for **Number of ZigZag Arrays II** is to compute the global optimal value by decomposing the problem into overlapping subproblems.

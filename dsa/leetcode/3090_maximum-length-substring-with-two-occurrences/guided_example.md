# Guided Example: Maximum Length Substring With Two Occurrences
...
The objective for **Maximum Length Substring With Two Occurrences** is to find the optimal contiguous window without evaluating all $O(N^2)$ candidate subarrays.

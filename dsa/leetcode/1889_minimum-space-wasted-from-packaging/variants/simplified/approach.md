# Simplified Approach - Minimum Space Wasted From Packaging
...
## Complexity detail
- **Time Complexity**: $O(N\log N+B\log B+B\log N)$ — Each input element is processed in a bounded number of direct operations.

## General
The optimal solution implements an idiomatic, readable, and production-ready approach for **Seasonal Sales Analysis**.
...
## Complexity detail
- **Time Complexity**: $O(S log S + P log P + G log G)$ — Operational efficiency across problem constraints.

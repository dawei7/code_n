# Simplified Approach - Maximum and Minimum Sums of at Most Size K Subsequences
...
- **Space Complexity**: $O(n + k)$ — Utilizes standard auxiliary storage proportional to the active computation state.

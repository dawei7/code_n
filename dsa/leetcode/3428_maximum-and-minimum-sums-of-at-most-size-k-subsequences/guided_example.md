# Guided Example: Maximum and Minimum Sums of at Most Size K Subsequences

We derive and execute the Array, Math, Dynamic Programming, Sorting, Combinatorics recurrence on a representative problem instance.
...
The objective for **Maximum and Minimum Sums of at Most Size K Subsequences** is to compute the global optimal value by decomposing the problem into overlapping subproblems.

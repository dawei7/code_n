## General
**Optimal Approach — Design SQL**

The solution implements an direct algorithm tailored for Design SQL. It utilizes Hash Map / Dictionary for $O(1)$ average lookup and frequency tracking to maintain optimal runtime bounds.
...
## Complexity detail
- **Time Complexity**: $O(n + q + E)$ — Operation count proportional to input scale.

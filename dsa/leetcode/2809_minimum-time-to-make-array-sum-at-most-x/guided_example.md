# Guided Example: Minimum Time to Make Array Sum At Most x
...
The objective for **Minimum Time to Make Array Sum At Most x** is to compute the global optimal value by decomposing the problem into overlapping subproblems.

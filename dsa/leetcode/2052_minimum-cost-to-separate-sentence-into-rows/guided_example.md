...
The objective for **Minimum Cost to Separate Sentence Into Rows** is to compute the global optimal value by decomposing the problem into overlapping subproblems.

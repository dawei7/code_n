...
**Input:** <span class="example-io">value = [3,5,8], limit = [2,1,3]</span>
...
<table>
	<thead>
		<tr>
			...
			<th align="center" style="border: 1px solid black;">`value[i]`</th>
	...
	<tbody>
		<tr>
			...
			<td align="center" style="border: 1px solid black;">1</td>
			<td align="center" style="border: 1px solid black;">`j = 1` as `limit[1] = 1`</td>
			<td align="center" style="border: 1px solid black;">[1]</td>
			<td align="center" style="border: 1px solid black;">5</td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td align="center" style="border: 1px solid black;">1</td>
			<td align="center" style="border: 1px solid black;">2</td>
			<td align="center" style="border: 1px solid black;">`j = 0` as `limit[0] = 2`</td>
...
<div class="example-block">
**Input:** <span class="example-io">value = [4,2,6], limit = [1,1,1]</span>
...
<table style="border: 1px solid black;">
	...
	<tbody>
		<tr>
			...
			<td align="center" style="border: 1px solid black;">0</td>
			<td align="center" style="border: 1px solid black;">1</td>
			<td align="center" style="border: 1px solid black;">`j = 0, 1, 2` as `limit[j] = 1`</td>
...
<div class="example-block">
**Input:** <span class="example-io">value = [4,1,5,2], limit = [3,3,2,3]</span>
...
<table style="border: 1px solid black;">
	...
	<tbody>
		...
		<tr>
			...
			<td align="center" style="border: 1px solid black;">1</td>
			<td align="center" style="border: 1px solid black;">2</td>
			<td align="center" style="border: 1px solid black;">`j = 2` as `limit[2] = 2`</td>
			<td align="center" style="border: 1px solid black;">[2]</td>
		...
		<tr>
			...
			<td align="center" style="border: 1px solid black;">2</td>
			<td align="center" style="border: 1px solid black;">3</td>
			<td align="center" style="border: 1px solid black;">`j = 0, 1, 3` as `limit[j] = 3`</td>

...
**Input:** <span class="example-io">nums = [1,2,3], k = 2, limit = 10</span>
...
<div class="example-block">
**Input:** <span class="example-io">nums = [0,2,3], k = -5, limit = 12</span>
...
<div class="example-block">
**Input:** <span class="example-io">nums = [2,2,3,3], k = 0, limit = 9</span>

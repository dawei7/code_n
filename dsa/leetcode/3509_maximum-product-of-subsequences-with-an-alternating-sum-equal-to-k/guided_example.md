# Guided Example: Maximum Product of Subsequences With an Alternating Sum Equal to K

We derive and execute the Array, Hash Table, Dynamic Programming recurrence on a representative problem instance.
...
The objective for **Maximum Product of Subsequences With an Alternating Sum Equal to K** is to compute the global optimal value by decomposing the problem into overlapping subproblems.

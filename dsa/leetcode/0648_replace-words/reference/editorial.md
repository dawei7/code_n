...
- Search for the corresponding shortest root using the helper function and set $\text{wordArray}[word]$ to the shortest root.
...
- Search for the corresponding shortest root using `dictTree.shortestRoot` and set $\text{wordArray}[word]$ to the shortest root.

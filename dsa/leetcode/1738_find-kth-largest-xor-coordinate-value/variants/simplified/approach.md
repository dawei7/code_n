# Simplified Approach - Find Kth Largest XOR Coordinate Value
...
## Complexity detail
- **Time Complexity**: $O(C\log k)$ — Each input element is processed in a bounded number of direct operations.

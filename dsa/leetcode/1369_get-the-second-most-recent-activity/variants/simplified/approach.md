# Simplified Approach - Get the Second Most Recent Activity
...
## Complexity detail
- **Time Complexity**: $O(A\log A)$ — Each input element is processed in a bounded number of direct operations.

## General
**Competitive Approach — Calculate Product Final Price**

The query executes a structured relational pipeline for **Calculate Product Final Price**. It uses Relational JOIN operations to correlate records across tables.
...
## Complexity detail
- **Time Complexity**: $O((P + D) log(P + D))$ — Operation count proportional to input scale.

# Simplified Approach - Calculate Product Final Price
...
## Complexity detail
- **Time Complexity**: $O((P + D) log(P + D))$ — Each input element is processed in a bounded number of direct operations.
- **Space Complexity**: $O(P + D)$ — Utilizes standard auxiliary storage proportional to the active computation state.

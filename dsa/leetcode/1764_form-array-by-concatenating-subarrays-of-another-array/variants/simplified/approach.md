# Simplified Approach - Form Array by Concatenating Subarrays of Another Array
...
## Complexity detail
- **Time Complexity**: $O(N+S)$ — Each input element is processed in a bounded number of direct operations.
- **Space Complexity**: $O(L)$ — Utilizes standard auxiliary storage proportional to the active computation state.

# Simplified Approach - Minimum Cost to Reach City With Discounts
...
## Complexity detail
- **Time Complexity**: $O(E(K+1)\log(n(K+1)))$ — Each input element is processed in a bounded number of direct operations.
- **Space Complexity**: $O((n+E)(K+1))$ — Utilizes standard auxiliary storage proportional to the active computation state.

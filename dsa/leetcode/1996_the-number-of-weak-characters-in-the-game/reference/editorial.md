...
2. Iterate over all the possible values of attack from the maximum possible attack value (`100000`) to `0`. Keep the maximum value seen so far, $\text{maxDefense}[i]$ will represent the maximum value in the suffix `[i, maxAttack]`.

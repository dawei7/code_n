# Simplified Approach - Products With Three or More Orders in Two Consecutive Years
...
## Complexity detail
- **Time Complexity**: $O(r log r)$ — Each input element is processed in a bounded number of direct operations.
- **Space Complexity**: $O(g)$ — Utilizes standard auxiliary storage proportional to the active computation state.

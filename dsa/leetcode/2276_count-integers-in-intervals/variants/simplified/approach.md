# Simplified Approach - Count Integers in Intervals
...
## Complexity detail
- **Time Complexity**: $O(Q log U)$ — Each input element is processed in a bounded number of direct operations.
- **Space Complexity**: $O(Q log U)$ — Utilizes standard auxiliary storage proportional to the active computation state.

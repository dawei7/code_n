# Guided Example: Count of Substrings Containing Every Vowel and K Consonants I
...
The objective for **Count of Substrings Containing Every Vowel and K Consonants I** is to find the optimal contiguous window without evaluating all $O(N^2)$ candidate subarrays.

# Guided Example: Maximize Fixed Points After Deletions
...
The objective for **Maximize Fixed Points After Deletions** is to pinpoint the target value or optimal threshold in logarithmic $O(\log N)$ time.

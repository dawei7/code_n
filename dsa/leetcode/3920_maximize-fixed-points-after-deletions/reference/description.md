...
Let $n=\lvert\texttt{nums}\rvert$. An element originally at index $i$ can become a fixed point only if enough earlier elements can be deleted to move it to index $\text{nums}[i]$.

...
We trace the dynamic Hash Table, String, Sliding Window, Counting sliding window on a representative input instance.
...
The objective for **Substrings of Size Three with Distinct Characters** is to find the optimal contiguous window without evaluating all $O(N^2)$ candidate subarrays.

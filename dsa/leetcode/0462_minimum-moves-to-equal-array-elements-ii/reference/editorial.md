...
$moves = \sum_{i=0}^{n-1} |median - \text{nums}[i]|$ , where $n$ is the size of the given array.

<!--![Median_Partition](images/462_Minimum_Moves_Median.gif)-->

![Slide 1](images/slideshow_462_Minimum_Moves1_462_Minimum_Moves1Slide1.JPG)

![Slide 2](images/slideshow_462_Minimum_Moves1_462_Minimum_Moves1Slide2.JPG)

![Slide 3](images/slideshow_462_Minimum_Moves1_462_Minimum_Moves1Slide3.JPG)

![Slide 4](images/slideshow_462_Minimum_Moves1_462_Minimum_Moves1Slide4.JPG)

![Slide 5](images/slideshow_462_Minimum_Moves1_462_Minimum_Moves1Slide5.JPG)

![Slide 6](images/slideshow_462_Minimum_Moves1_462_Minimum_Moves1Slide6.JPG)

![Slide 7](images/slideshow_462_Minimum_Moves1_462_Minimum_Moves1Slide7.JPG)

![Slide 8](images/slideshow_462_Minimum_Moves1_462_Minimum_Moves1Slide8.JPG)
...
$moves = \sum_{i=0}^{\left \lceil{\frac{n}{2}} \right \rceil - 1} |nums[n-i] - \text{nums}[i]|$, where $n$ is the number of elements in the array $nums$.
...
If the correct position happens to be the central position(corresponding to the median), we can return the median directly from there. Now, let's look at the implementation of quick-select.
 ...
 $j^{th}$ index($\text{list}[j]$) with the pivot element($pivot$). If $\text{list}[j]<pivot$, we swap the elements $\text{list}[i]$ and $\text{list}[j]$ and increment $i$ and $j$. Otherwise,
 only $j$ is incremented. When $j$ reaches the end of the array, we swap the $pivot$ with $\text{list}[i]$. In this way, now, all the elements lesser than $pivot$ lie to the
 ...
 <!--![Median_Partition](images/462_Minimum_Moves_Partition.gif)-->

![Slide 1](images/slideshow_462_Minimum_Moves2_462_Minimum_Moves2Slide1.JPG)

![Slide 2](images/slideshow_462_Minimum_Moves2_462_Minimum_Moves2Slide2.JPG)

![Slide 3](images/slideshow_462_Minimum_Moves2_462_Minimum_Moves2Slide3.JPG)

![Slide 4](images/slideshow_462_Minimum_Moves2_462_Minimum_Moves2Slide4.JPG)

![Slide 5](images/slideshow_462_Minimum_Moves2_462_Minimum_Moves2Slide5.JPG)

![Slide 6](images/slideshow_462_Minimum_Moves2_462_Minimum_Moves2Slide6.JPG)

![Slide 7](images/slideshow_462_Minimum_Moves2_462_Minimum_Moves2Slide7.JPG)

![Slide 8](images/slideshow_462_Minimum_Moves2_462_Minimum_Moves2Slide8.JPG)

![Slide 9](images/slideshow_462_Minimum_Moves2_462_Minimum_Moves2Slide9.JPG)

![Slide 10](images/slideshow_462_Minimum_Moves2_462_Minimum_Moves2Slide10.JPG)

![Slide 11](images/slideshow_462_Minimum_Moves2_462_Minimum_Moves2Slide11.JPG)

![Slide 12](images/slideshow_462_Minimum_Moves2_462_Minimum_Moves2Slide12.JPG)

![Slide 13](images/slideshow_462_Minimum_Moves2_462_Minimum_Moves2Slide13.JPG)

![Slide 14](images/slideshow_462_Minimum_Moves2_462_Minimum_Moves2Slide14.JPG)

![Slide 15](images/slideshow_462_Minimum_Moves2_462_Minimum_Moves2Slide15.JPG)

![Slide 16](images/slideshow_462_Minimum_Moves2_462_Minimum_Moves2Slide16.JPG)
 ...
 $moves = \sum_{i=0}^{n-1} |median - \text{list}[i]|$ , where $n$ is the size of the given array.
...
Using the above method ensures that the chosen pivot, in the worst case, has at most 70% elements which are larger/smaller than the pivot.
...
The steps 1. and 2. take $O(n)$ time as finding median of an array of size 5 takes $\mathcal{O}(1)$ time and there are $\left \lceil{\frac{n}{5}}\right\rceil$ such arrays.
...
$T(n) \leq \begin{cases} \Theta(1), \& n\leq80 \\ T\left \lceil\frac{n}{5}\right\rceil + T(\frac{7n}{10} + 6) +$\mathcal{O}(n)$, \& n>80 \end{cases}$

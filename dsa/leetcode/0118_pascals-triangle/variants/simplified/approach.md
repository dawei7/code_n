# Simplified Approach - Pascal's Triangle
...
## Complexity detail
- **Time Complexity**: $O(numRows^2)$ — Each input element is processed in a bounded number of direct operations.
- **Space Complexity**: $O(numRows^2)$ — Utilizes standard auxiliary storage proportional to the active computation state.

# Guided Example: Most Profitable Path in a Tree

We trace the hierarchical Array, Tree, Depth-First Search, Breadth-First Search, Graph Theory traversal and subtree aggregation on a representative binary tree.
...
The objective for **Most Profitable Path in a Tree** is to evaluate tree properties by visiting nodes in topological hierarchy (post-order, pre-order, or level-order).

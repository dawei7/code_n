# Guided Example: Count Substrings Without Repeating Character
...
The objective for **Count Substrings Without Repeating Character** is to find the optimal contiguous window without evaluating all $O(N^2)$ candidate subarrays.

# Guided Example: Find the Index of Permutation
...
The objective for **Find the Index of Permutation** is to pinpoint the target value or optimal threshold in logarithmic $O(\log N)$ time.

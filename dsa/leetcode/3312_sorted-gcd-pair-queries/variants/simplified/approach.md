# Simplified Approach - Sorted GCD Pair Queries
...
## Complexity detail
- **Time Complexity**: $O(n + M log M + q log M)$ — Each input element is processed in a bounded number of direct operations.

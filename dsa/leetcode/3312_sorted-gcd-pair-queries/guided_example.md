# Guided Example: Sorted GCD Pair Queries

We trace the logarithmic Array, Hash Table, Math, Binary Search, Combinatorics, Counting, Number Theory, Prefix Sum search on a representative problem instance.

- **Input:** `{"nums": [2, 3, 4], "queries": [0, 2, 2]}`
- **Required output:** `[1, 2, 2]`
...
The objective for **Sorted GCD Pair Queries** is to pinpoint the target value or optimal threshold in logarithmic $O(\log N)$ time.

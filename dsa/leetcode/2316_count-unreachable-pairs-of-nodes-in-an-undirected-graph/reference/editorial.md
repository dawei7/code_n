...
3. Create a hash map, `componentSize`, to map a node that uniquely identifies a component to the size of the component. $\text{componentSize}[x]$ returns the number of nodes in the component that contains node `x`.

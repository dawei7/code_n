# Simplified Approach - Lexicographically Smallest Generated String
...
## Complexity detail
- **Time Complexity**: $O((n + m)m)$ — Each input element is processed in a bounded number of direct operations.
- **Space Complexity**: $O((n + m)m)$ — Utilizes standard auxiliary storage proportional to the active computation state.

# Guided Example: Minimum Number of Operations to Sort a Binary Tree by Level
...
The objective for **Minimum Number of Operations to Sort a Binary Tree by Level** is to evaluate tree properties by visiting nodes in topological hierarchy (post-order, pre-order, or level-order).

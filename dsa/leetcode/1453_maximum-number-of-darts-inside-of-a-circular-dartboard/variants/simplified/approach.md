# Simplified Approach - Maximum Number of Darts Inside of a Circular Dartboard
...
## Complexity detail
- **Time Complexity**: $O(n^2\log n)$ — Each input element is processed in a bounded number of direct operations.

# Guided Example: Minimum Weighted Subgraph With the Required Paths II

We trace the hierarchical Array, Dynamic Programming, Bit Manipulation, Tree, Depth-First Search traversal and subtree aggregation on a representative binary tree.

- **Input:** `{"edges": [[0, 1, 2], [1, 2, 3], [1, 3, 5], [1, 4, 4], [2, 5, 6]], "queries": [[2, 3, 4], [0, 2, 5]]}`
- **Required output:** `[12, 11]`
...
The objective for **Minimum Weighted Subgraph With the Required Paths II** is to evaluate tree properties by visiting nodes in topological hierarchy (post-order, pre-order, or level-order).

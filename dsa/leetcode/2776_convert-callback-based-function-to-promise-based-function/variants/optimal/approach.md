...
To Write a function that accepts another function `fn` and converts the callback-based function into a promise-based function, the JavaScript solution uses clean ES6+ techniques.

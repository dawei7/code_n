# Simplified Approach - Convert Callback Based Function to Promise Based Function
...
## Complexity detail
- **Time Complexity**: $O(a)$ — Each input element is processed in a bounded number of direct operations.

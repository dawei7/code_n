...
<center>
<img src="images/transform_example.png"/>
</center>
...
<center>
<img src="images/text_editor_example.png"/>
</center>
...
<center>
<img src="images/all_illustrations.png"/>
</center>
 ...
 - The characters in their current position do not match
    ...
    Let's define the recursive function `minDistanceRecur`, which finds the edit distance for `word1` ending at index  `word1Index` and `word2` ending at `word2Index`.
      ...
      1. Replace the character at `word1Index` in `word1` with the character at `word2Index` in `word2`.
         ...
         <center>
               <img src="images/replace_illustration.png"/>
         </center>
      ...
      2. Inserting the character at `word2Index` in `word2` in `word1`.
         ...
         <center>
               <img src="images/insert_illustration.png"/>
         </center>
      ...
      3. Deleting the character at `word1Index` in `word1`.
         ...
         <center>
               <img src="images/delete_illustration.png"/>
         </center>
...
<center>
<img src="images/edit_distance_tree.png"/>
</center>
...
$word1 = abc$ and $word2 = ad$ and $word1Index = 2$ (0-indexed) and $word2Index = 1$ (0-indexed)
 ...
 To cache the result of this sub-problem, we must use a data structure that stores the result of `word1` ending at index `word1Index`, that is 2, and `word2` ending at `word2Index`, that is 1. One possible way to implement this is by using a 2-dimensional array say, `memo` where $\text{memo}[word1Index][word2Index]$ caches the result of `word1` ending at `word1Index` and `word2` ending at `word2Index`.
...
- Before computing the result of the subproblem, check if it is already present in $\text{memo}[word1Index][word2Index]$. If yes, return the stored result.
...
<center>
<img src="images/dp_base_case.png"/>
</center>
...
$\text{dp}[word1Index][word2Index]$ stores the edit distance of strings `word1` ending at `word1Index` and `word2` ending at `word2Index`.
...
<center>
<img src="images/dp_equal_characters.png"/>
</center>
...
Example, `word1` = `a` and `word2` = `aq`.
     ...
     <center>
     <img src="images/dp_character_not_equal.png"/>
     </center>
...
The edit distance will be a minimum of 3 operations,
  ...
  The result of the sub-problem `word1` = `a` and `word2` = `a` can be referred from $\text{dp}[word1Index][word2Index - 1]$.

  <center>
    <img src="images/dp_add_operation.png"/>
    </center>
   ...
   <center>
     <img src="images/dp_delete_operation.png"/>
   </center>
   ...
   <center>
     <img src="images/dp_replace_operation.png"/>
   </center>

   <center>
     <img src="images/dp_all_operations.png"/>
   </center>

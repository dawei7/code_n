# Simplified Approach - Contains Duplicate III
...
- **Space Complexity**: $O(\min(n,indexDiff))$ — Utilizes standard auxiliary storage proportional to the active computation state.

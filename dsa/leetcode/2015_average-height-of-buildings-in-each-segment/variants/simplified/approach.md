# Simplified Approach - Average Height of Buildings in Each Segment
...
## Complexity detail
- **Time Complexity**: $O(B\log B)$ — Each input element is processed in a bounded number of direct operations.
- **Space Complexity**: $O(B)$ — Utilizes standard auxiliary storage proportional to the active computation state.

# Guided Example: Construct the Longest New String

We derive and execute the Math, Dynamic Programming, Greedy, Brainteaser recurrence on a representative problem instance.
...
The objective for **Construct the Longest New String** is to compute the global optimal value by decomposing the problem into overlapping subproblems.

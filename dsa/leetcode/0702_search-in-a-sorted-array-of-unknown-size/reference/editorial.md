...
- Extend right boundary: `right *= 2`. To speed up, use right shift instead of multiplication: $right <\le 1$.
...
- Retrieve the element at this index: $num = \text{reader.get}(pivot)$.

# Guided Example: Alternating Groups II
...
The objective for **Alternating Groups II** is to find the optimal contiguous window without evaluating all $O(N^2)$ candidate subarrays.

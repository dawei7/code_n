# Guided Example: Longest Even Odd Subarray With Threshold
...
The objective for **Longest Even Odd Subarray With Threshold** is to find the optimal contiguous window without evaluating all $O(N^2)$ candidate subarrays.

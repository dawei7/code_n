...
- The sum of the grades of students in the $$i^{\text{th}}$$ group is **less than** the sum of the grades of students in the $(i + 1)^th$ group, for all groups (except the last).

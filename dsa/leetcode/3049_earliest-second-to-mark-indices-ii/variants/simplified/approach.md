# Simplified Approach - Earliest Second to Mark Indices II
...
## Complexity detail
- **Time Complexity**: $O((n + m log n) log m)$ — Each input element is processed in a bounded number of direct operations.

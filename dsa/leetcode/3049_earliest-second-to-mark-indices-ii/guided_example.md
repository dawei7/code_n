# Guided Example: Earliest Second to Mark Indices II

We trace the logarithmic Array, Binary Search, Greedy, Heap (Priority Queue) search on a representative problem instance.
...
The objective for **Earliest Second to Mark Indices II** is to pinpoint the target value or optimal threshold in logarithmic $O(\log N)$ time.

## General
**Competitive Approach — Unique Orders and Customers Per Month**

The query executes a structured relational pipeline for **Unique Orders and Customers Per Month**. It uses `GROUP BY` aggregation with PostgreSQL standard functions (`COALESCE`, `STRING_AGG`).

...
The core task in **Total Appeal of A String** is to The **appeal** of a string is the number of **distinct** characters found in the string. The algorithm processes the input using a single-pass linear iteration, maintaining state variables that update as each element is inspected to produce the result cleanly.

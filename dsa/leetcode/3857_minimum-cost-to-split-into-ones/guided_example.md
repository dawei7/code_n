# Guided Example: Minimum Cost to Split into Ones
...
The objective for **Minimum Cost to Split into Ones** is to compute the global optimal value by decomposing the problem into overlapping subproblems.

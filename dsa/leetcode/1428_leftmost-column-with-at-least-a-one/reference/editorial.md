...
![Diagram showing a linear search that has uncovered all the zeroes, along with the first 1 in each row.](images/linear_search.png)
...
![Diagram showing a single uncovered 0 at the "middle" index](images/binary_search_example_1.png)
...
![Diagram showing a single uncovered 1 at the "middle" index](images/binary_search_example_2.png)
...
![Slide 1](images/slideshow_10012_binary_search_animation_Slide1.PNG)

![Slide 2](images/slideshow_10012_binary_search_animation_Slide2.PNG)

![Slide 3](images/slideshow_10012_binary_search_animation_Slide3.PNG)

![Slide 4](images/slideshow_10012_binary_search_animation_Slide4.PNG)

![Slide 5](images/slideshow_10012_binary_search_animation_Slide5.PNG)

![Slide 6](images/slideshow_10012_binary_search_animation_Slide6.PNG)

![Slide 7](images/slideshow_10012_binary_search_animation_Slide7.PNG)

![Slide 8](images/slideshow_10012_binary_search_animation_Slide8.PNG)

![Slide 9](images/slideshow_10012_binary_search_animation_Slide9.PNG)

![Slide 10](images/slideshow_10012_binary_search_animation_Slide10.PNG)

![Slide 11](images/slideshow_10012_binary_search_animation_Slide11.PNG)

![Slide 12](images/slideshow_10012_binary_search_animation_Slide12.PNG)

![Slide 13](images/slideshow_10012_binary_search_animation_Slide13.PNG)

![Slide 14](images/slideshow_10012_binary_search_animation_Slide14.PNG)

![Slide 15](images/slideshow_10012_binary_search_animation_Slide15.PNG)

![Slide 16](images/slideshow_10012_binary_search_animation_Slide16.PNG)

![Slide 17](images/slideshow_10012_binary_search_animation_Slide17.PNG)

![Slide 18](images/slideshow_10012_binary_search_animation_Slide18.PNG)

![Slide 19](images/slideshow_10012_binary_search_animation_Slide19.PNG)

![Slide 20](images/slideshow_10012_binary_search_animation_Slide20.PNG)

![Slide 21](images/slideshow_10012_binary_search_animation_Slide21.PNG)

![Slide 22](images/slideshow_10012_binary_search_animation_Slide22.PNG)

![Slide 23](images/slideshow_10012_binary_search_animation_Slide23.PNG)

![Slide 24](images/slideshow_10012_binary_search_animation_Slide24.PNG)

![Slide 25](images/slideshow_10012_binary_search_animation_Slide25.PNG)

![Slide 26](images/slideshow_10012_binary_search_animation_Slide26.PNG)

![Slide 27](images/slideshow_10012_binary_search_animation_Slide27.PNG)

![Slide 28](images/slideshow_10012_binary_search_animation_Slide28.PNG)

![Slide 29](images/slideshow_10012_binary_search_animation_Slide29.PNG)

![Slide 30](images/slideshow_10012_binary_search_animation_Slide30.PNG)

![Slide 31](images/slideshow_10012_binary_search_animation_Slide31.PNG)

![Slide 32](images/slideshow_10012_binary_search_animation_Slide32.PNG)

![Slide 33](images/slideshow_10012_binary_search_animation_Slide33.PNG)
...
- Time complexity : $O(N \, \log \, M)$.
    ...
    There are $M$ items in each row. Therefore, each binary search will have a cost of $O(\log \, M)$. We are performing $N$ of these binary searches, giving a time complexity of $N \cdot$\mathcal{O}(\\log \, M)$= O(N \, \log \, M)$.
...
![Diagram showing redundant search in Row 3](images/redundant_search.png)
...
We can do even better than that; on each search, we can set $hi = \text{smallest}_{index} - 1$, where $\text{smallest}_{index}$ is the smallest index of a `1` we've seen so far. In most cases, this is a substantial improvement. It works because we're only interested in finding `1`s at lower indexes than we previously found. Here is an animation of the above example with this optimized algorithm. The algorithm eliminates as many cells as it can with each API call. It also starts by checking the last cell of the row before proceeding with the binary search, to eliminate needless binary searches where the row only had `0`s left in it.

![Slide 1](images/slideshow_10012_optimized_binary_search_Slide1.PNG)

![Slide 2](images/slideshow_10012_optimized_binary_search_Slide2.PNG)

![Slide 3](images/slideshow_10012_optimized_binary_search_Slide3.PNG)

![Slide 4](images/slideshow_10012_optimized_binary_search_Slide4.PNG)

![Slide 5](images/slideshow_10012_optimized_binary_search_Slide5.PNG)

![Slide 6](images/slideshow_10012_optimized_binary_search_Slide6.PNG)

![Slide 7](images/slideshow_10012_optimized_binary_search_Slide7.PNG)

![Slide 8](images/slideshow_10012_optimized_binary_search_Slide8.PNG)

![Slide 9](images/slideshow_10012_optimized_binary_search_Slide9.PNG)

![Slide 10](images/slideshow_10012_optimized_binary_search_Slide10.PNG)

![Slide 11](images/slideshow_10012_optimized_binary_search_Slide11.PNG)

![Slide 12](images/slideshow_10012_optimized_binary_search_Slide12.PNG)

![Slide 13](images/slideshow_10012_optimized_binary_search_Slide13.PNG)

![Slide 14](images/slideshow_10012_optimized_binary_search_Slide14.PNG)

![Slide 15](images/slideshow_10012_optimized_binary_search_Slide15.PNG)

![Slide 16](images/slideshow_10012_optimized_binary_search_Slide16.PNG)

![Slide 17](images/slideshow_10012_optimized_binary_search_Slide17.PNG)

Here is what the worst-case looks like. Like before, its time complexity is still $O(M \, \log \, N)$.

![The worst case for the optimized algorithm](images/optimized_binary_search_worst_case.png)
...
![Slide 1](images/slideshow_10012_2D_linear_animation_Slide1.PNG)

![Slide 2](images/slideshow_10012_2D_linear_animation_Slide2.PNG)

![Slide 3](images/slideshow_10012_2D_linear_animation_Slide3.PNG)

![Slide 4](images/slideshow_10012_2D_linear_animation_Slide4.PNG)

![Slide 5](images/slideshow_10012_2D_linear_animation_Slide5.PNG)

![Slide 6](images/slideshow_10012_2D_linear_animation_Slide6.PNG)

![Slide 7](images/slideshow_10012_2D_linear_animation_Slide7.PNG)

![Slide 8](images/slideshow_10012_2D_linear_animation_Slide8.PNG)

![Slide 9](images/slideshow_10012_2D_linear_animation_Slide9.PNG)

![Slide 10](images/slideshow_10012_2D_linear_animation_Slide10.PNG)

![Slide 11](images/slideshow_10012_2D_linear_animation_Slide11.PNG)

![Slide 12](images/slideshow_10012_2D_linear_animation_Slide12.PNG)

![Slide 13](images/slideshow_10012_2D_linear_animation_Slide13.PNG)

![Slide 14](images/slideshow_10012_2D_linear_animation_Slide14.PNG)

![Slide 15](images/slideshow_10012_2D_linear_animation_Slide15.PNG)

![Slide 16](images/slideshow_10012_2D_linear_animation_Slide16.PNG)

![Slide 17](images/slideshow_10012_2D_linear_animation_Slide17.PNG)

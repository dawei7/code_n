...
You may perform the following operation any number of times (including zero):
	...
	- For each such segment `[l, r]`, update **simultaneously**:
		...
		<li>`nums[l] = target[l], nums[l + 1] = target[l + 1], ..., nums[r] = target[r]`
...
**Input:** <span class="example-io">nums = [1,2,3], target = [2,1,3]</span>
...
<div class="example-block">
**Input:** <span class="example-io">nums = [4,1,4], target = [5,1,4]</span>
...
<div class="example-block">
**Input:** <span class="example-io">nums = [7,3,7], target = [5,5,9]</span>

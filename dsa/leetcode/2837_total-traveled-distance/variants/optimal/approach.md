## General
The optimal solution implements an idiomatic, readable, and production-ready approach for **Total Traveled Distance**.
...
## Complexity detail
- **Time Complexity**: $O((U + R) log (U + R))$ — Operational efficiency across problem constraints.

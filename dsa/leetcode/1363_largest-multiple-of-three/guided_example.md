...
We derive and execute the Array, Math, Dynamic Programming, Greedy, Sorting recurrence on a representative problem instance.
...
The objective for **Largest Multiple of Three** is to compute the global optimal value by decomposing the problem into overlapping subproblems.

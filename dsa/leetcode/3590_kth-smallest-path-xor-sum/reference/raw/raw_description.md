...
**Input:** <span class="example-io">par = [-1,0,0], vals = [1,1,1], queries = [[0,1],[0,2],[0,3]]</span>
...
<div class="example-block">
**Input:** <span class="example-io">par = [-1,0,1], vals = [5,2,7], queries = [[0,1],[1,2],[1,3],[2,1]]</span>

**Output:** <span class="example-io">[0,7,-1,0]</span>

...
![Two strings "actgattag" and "gtgtgatcg"](images/example.png)
...
![Common subsequence "tga"](images/subsequence_1.png)
![Common subsequence "ttt"](images/subsequence_2.png)
![Common subsequence "g"](images/subsequence_3.png)
![Common subsequence "tgtg"](images/subsequence_4.png)
...
![Not a subsequence](images/not_subsequence.png)
...
This, however, will require exponential time to run. The number of subsequences in a string is up to $2^L$, where $L$ is the length of the string. This is because, for each character, we have two choices; it can either be in the subsequence or not in it. Duplicate characters reduce the number of unique subsequences a bit, although in the general case, it's still exponential.
...
![Connecting 'a' in top to 'a' in bottom](images/greedy_top_1.png)

And then, the second letter.

![Connecting 'c' in top to 'c' in bottom](images/greedy_top_2.png)

And finally, the third letter.

![Connecting 'g' in top to 'g' in bottom](images/greedy_top_3.png)

This solution, however, isn't optimal. Here is a better solution.

![A better solution "tgag"](images/better_solution.png)
...
![A greedy solution with second string](images/greedy_bottom.png)
...
![Image showing all lines between same characters](images/all_lines.png)
...
![Greedy example of 'acg' solution](images/greedy_top_3.png)
...
![Image showing subproblem LCS("ctgattag", "tcg")](images/subproblem_1.png)
...
![Image showing subproblem LCS("ctgattag", "gtgtgatcg")](images/subproblem_2.png)
...
Remember, we need to make sure that the results of this method are memoized. In **Python**, we can use $\text{lru}_{cache}$. In **Java**, we need to make our own data structure. A 2D Array is the best option (see the code for the details of how this works).
...
![Graph of subproblems showing only links between ones with first character differing](images/subproblem_partial_graph_different_first_characters_only.png)
...
![Graph of subproblems showing links between all nodes](images/subproblem_partial_graph_with_all_links.png)
...
![Cell where first letter is same, showing +1 into new cell](images/bottom_up_same_letter.png)
...
![Cell where first letter is same, showing +1 into new cell](images/bottom_up_different_letter.png)

Putting this all together, we iterate over each column in reverse, starting from the last column (we could also do rows, the final result will be the same). For a cell `(row, col)`, we look at whether or not $\text{text1.charAt}(row) = \text{text2.charAt}(col)$ is true. *if it is*, then we set $\text{grid}[row][col] = 1 + grid[row + 1][col + 1]$. Otherwise, we set $\text{grid}[row][col] = max(grid[row + 1][col], \text{grid}[row][col + 1])$.
...
![Slide 1](images/slideshow_1143_longest_common_subsequence_Slide1.PNG)

![Slide 2](images/slideshow_1143_longest_common_subsequence_Slide2.PNG)

![Slide 3](images/slideshow_1143_longest_common_subsequence_Slide3.PNG)

![Slide 4](images/slideshow_1143_longest_common_subsequence_Slide4.PNG)

![Slide 5](images/slideshow_1143_longest_common_subsequence_Slide5.PNG)

![Slide 6](images/slideshow_1143_longest_common_subsequence_Slide6.PNG)

![Slide 7](images/slideshow_1143_longest_common_subsequence_Slide7.PNG)

![Slide 8](images/slideshow_1143_longest_common_subsequence_Slide8.PNG)

![Slide 9](images/slideshow_1143_longest_common_subsequence_Slide9.PNG)


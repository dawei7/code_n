# Guided Example: Maximum Sized Array

We trace the logarithmic Binary Search, Bit Manipulation search on a representative problem instance.
...
The objective for **Maximum Sized Array** is to pinpoint the target value or optimal threshold in logarithmic $O(\log N)$ time.

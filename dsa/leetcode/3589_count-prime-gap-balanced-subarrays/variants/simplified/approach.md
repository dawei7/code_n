# Simplified Approach - Count Prime-Gap Balanced Subarrays
...
## Complexity detail
- **Time Complexity**: $O(V log log V + n)$ — Each input element is processed in a bounded number of direct operations.

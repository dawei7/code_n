# Guided Example: Count K-th Roots in a Range
...
The objective for **Count K-th Roots in a Range** is to pinpoint the target value or optimal threshold in logarithmic $O(\log N)$ time.

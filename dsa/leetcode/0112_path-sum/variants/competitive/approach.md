## General
**Competitive Approach — Path Sum**

The solution implements an direct algorithm tailored for Path Sum. It utilizes Binary Tree node traversal (`val`, `left`, `right`) to maintain optimal runtime bounds.

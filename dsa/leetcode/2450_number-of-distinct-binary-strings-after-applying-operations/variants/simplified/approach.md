# Simplified Approach - Number of Distinct Binary Strings After Applying Operations
...
## Complexity detail
- **Time Complexity**: $O(log(n - k + 1))$ — Each input element is processed in a bounded number of direct operations.

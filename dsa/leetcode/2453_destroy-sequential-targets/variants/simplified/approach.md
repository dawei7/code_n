# Simplified Approach - Destroy Sequential Targets
...
- **Space Complexity**: $O(min(n, space))$ — Utilizes standard auxiliary storage proportional to the active computation state.

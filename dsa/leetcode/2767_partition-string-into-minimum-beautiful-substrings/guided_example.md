# Guided Example: Partition String Into Minimum Beautiful Substrings

We derive and execute the Hash Table, String, Dynamic Programming, Backtracking recurrence on a representative problem instance.
...
The objective for **Partition String Into Minimum Beautiful Substrings** is to compute the global optimal value by decomposing the problem into overlapping subproblems.

# Simplified Approach - Number of Balanced Integers in a Range
...
## Complexity detail
- **Time Complexity**: $O(D^2)$ — Each input element is processed in a bounded number of direct operations.
- **Space Complexity**: $O(D^2)$ — Utilizes standard auxiliary storage proportional to the active computation state.

# Guided Example: Number of Balanced Integers in a Range
...
The objective for **Number of Balanced Integers in a Range** is to compute the global optimal value by decomposing the problem into overlapping subproblems.

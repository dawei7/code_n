# Guided Example: Maximize the Distance Between Points on a Square

We trace the logarithmic Array, Math, Binary Search, Geometry, Sorting search on a representative problem instance.
...
The objective for **Maximize the Distance Between Points on a Square** is to pinpoint the target value or optimal threshold in logarithmic $O(\log N)$ time.

# Guided Example: Count K-Reducible Numbers Less Than N
...
The objective for **Count K-Reducible Numbers Less Than N** is to compute the global optimal value by decomposing the problem into overlapping subproblems.

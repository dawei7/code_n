...
- **Required output:** `[[1, 2, 10], [4, 5, 7, 8]]`
...
The objective is to compute the requested result for **Find Players With Zero or One Losses** while avoiding redundant re-evaluations.

# Guided Example: Count Zero Request Servers

We trace the dynamic Array, Hash Table, Sliding Window, Sorting sliding window on a representative input instance.
...
The objective for **Count Zero Request Servers** is to find the optimal contiguous window without evaluating all $O(N^2)$ candidate subarrays.

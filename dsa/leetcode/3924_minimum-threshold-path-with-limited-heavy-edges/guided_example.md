# Guided Example: Minimum Threshold Path With Limited Heavy Edges
...
The objective for **Minimum Threshold Path With Limited Heavy Edges** is to pinpoint the target value or optimal threshold in logarithmic $O(\log N)$ time.

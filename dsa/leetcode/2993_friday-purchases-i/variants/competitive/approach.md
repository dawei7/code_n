## General
**Competitive Approach — Friday Purchases I**

The query executes a structured relational pipeline for **Friday Purchases I**. It uses `GROUP BY` aggregation with PostgreSQL standard functions (`COALESCE`, `STRING_AGG`).

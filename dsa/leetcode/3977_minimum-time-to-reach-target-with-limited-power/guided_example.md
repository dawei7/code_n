# Guided Example: Minimum Time to Reach Target With Limited Power

We derive and execute the Array, Dynamic Programming, Graph Theory, Heap (Priority Queue), Shortest Path recurrence on a representative problem instance.
...
The objective for **Minimum Time to Reach Target With Limited Power** is to compute the global optimal value by decomposing the problem into overlapping subproblems.

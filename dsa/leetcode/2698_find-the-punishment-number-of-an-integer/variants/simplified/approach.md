# Simplified Approach - Find the Punishment Number of an Integer
...
## Complexity detail
- **Time Complexity**: $O(n d 2^d)$ — Each input element is processed in a bounded number of direct operations.

## General
**Competitive Approach — Employee Bonus**

The query executes a structured relational pipeline for **Employee Bonus**. It uses Relational JOIN operations to correlate records across tables.
...
## Complexity detail
- **Time Complexity**: $O((E + B) \log(E + B))$ — Operation count proportional to input scale.

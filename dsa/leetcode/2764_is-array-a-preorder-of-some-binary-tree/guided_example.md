# Guided Example: Is Array a Preorder of Some ‌Binary Tree
...
The objective for **Is Array a Preorder of Some ‌Binary Tree** is to evaluate tree properties by visiting nodes in topological hierarchy (post-order, pre-order, or level-order).

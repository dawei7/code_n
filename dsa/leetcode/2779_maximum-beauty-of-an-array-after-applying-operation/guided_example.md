# Guided Example: Maximum Beauty of an Array After Applying Operation

We trace the dynamic Array, Binary Search, Sliding Window, Sorting sliding window on a representative input instance.
...
The objective for **Maximum Beauty of an Array After Applying Operation** is to find the optimal contiguous window without evaluating all $O(N^2)$ candidate subarrays.

...
The objective for **Binary Tree Longest Consecutive Sequence** is to evaluate tree properties by visiting nodes in topological hierarchy (post-order, pre-order, or level-order).

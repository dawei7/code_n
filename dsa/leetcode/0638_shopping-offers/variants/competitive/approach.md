...
## Complexity Detail
- **Time Complexity**: $O(SM \cdot \prod(needs_i + 1))$ — Micro-optimized algorithmic execution time.
- **Space Complexity**: $O(M \cdot \prod(needs_i + 1))$ — Low auxiliary space allocation.

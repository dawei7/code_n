...
## Complexity detail
- **Time Complexity**: $O(SM \cdot \prod(needs_i + 1))$ — High-efficiency runtime performance.
- **Space Complexity**: $O(M \cdot \prod(needs_i + 1))$ — Minimal auxiliary memory overhead.

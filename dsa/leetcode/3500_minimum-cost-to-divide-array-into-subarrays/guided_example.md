# Guided Example: Minimum Cost to Divide Array Into Subarrays
...
The objective for **Minimum Cost to Divide Array Into Subarrays** is to compute the global optimal value by decomposing the problem into overlapping subproblems.

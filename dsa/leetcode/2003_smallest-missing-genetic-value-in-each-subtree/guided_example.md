...
We trace the hierarchical Array, Dynamic Programming, Tree, Depth-First Search, Union-Find traversal and subtree aggregation on a representative binary tree.

- **Input:** `{"parents": [-1, 0, 0, 2], "nums": [1, 2, 3, 4]}`
- **Required output:** `[5, 1, 1, 1]`
...
The objective for **Smallest Missing Genetic Value in Each Subtree** is to evaluate tree properties by visiting nodes in topological hierarchy (post-order, pre-order, or level-order).

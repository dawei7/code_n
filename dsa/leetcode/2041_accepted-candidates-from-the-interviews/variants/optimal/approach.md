## General
The optimal solution implements an idiomatic, readable, and production-ready approach for **Accepted Candidates From the Interviews**.
...
## Complexity detail
- **Time Complexity**: $O(C+R+C\log C)$ — Operational efficiency across problem constraints.

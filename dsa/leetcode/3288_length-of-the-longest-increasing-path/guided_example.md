# Guided Example: Length of the Longest Increasing Path
...
The objective for **Length of the Longest Increasing Path** is to pinpoint the target value or optimal threshold in logarithmic $O(\log N)$ time.

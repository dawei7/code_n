## General
**Competitive Approach — Copy List with Random Pointer**

The solution implements an direct algorithm tailored for Copy List with Random Pointer. It utilizes Hash Map / Dictionary for $O(1)$ average lookup and frequency tracking, Singly-linked list node operations (`val`, `next`) to maintain optimal runtime bounds.

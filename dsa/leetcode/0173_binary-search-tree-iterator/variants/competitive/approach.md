## General
**Competitive Approach — Binary Search Tree Iterator**

The solution implements an direct algorithm tailored for Binary Search Tree Iterator. It utilizes Binary Tree node traversal (`val`, `left`, `right`) to maintain optimal runtime bounds.

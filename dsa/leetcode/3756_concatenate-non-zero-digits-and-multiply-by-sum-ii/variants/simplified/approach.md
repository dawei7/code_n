# Simplified Approach - Concatenate Non-Zero Digits and Multiply by Sum II
...
## Complexity detail
- **Time Complexity**: $O(m + q)$ — Each input element is processed in a bounded number of direct operations.

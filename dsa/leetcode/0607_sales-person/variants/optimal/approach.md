## General
The optimal solution implements an idiomatic, readable, and production-ready approach for **Sales Person**.
...
## Complexity detail
- **Time Complexity**: $O((S + C + O) \log(S + C + O))$ — Operational efficiency across problem constraints.

# Simplified Approach - Find Candidates for Data Scientist Position
...
## Complexity detail
- **Time Complexity**: $O(n + c log c)$ — Each input element is processed in a bounded number of direct operations.

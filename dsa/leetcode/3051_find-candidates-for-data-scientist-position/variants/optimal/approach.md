## General
The optimal solution implements an idiomatic, readable, and production-ready approach for **Find Candidates for Data Scientist Position**.
...
## Complexity detail
- **Time Complexity**: $O(n + c log c)$ — Operational efficiency across problem constraints.

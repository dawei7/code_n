...
To a function `fn`, an array of arguments `args`, and a timeout `t` in milliseconds, return a cancel function `cancelFn`, the JavaScript solution uses clean ES6+ techniques.

# Guided Example: Minimum Increments for Target Multiples in an Array

We derive and execute the Array, Math, Dynamic Programming, Bit Manipulation, Number Theory, Bitmask recurrence on a representative problem instance.
...
The objective for **Minimum Increments for Target Multiples in an Array** is to compute the global optimal value by decomposing the problem into overlapping subproblems.

# Simplified Approach - Count Subtrees With Max Distance Between Cities
...
## Complexity detail
- **Time Complexity**: $O(2^n n)$ — Each input element is processed in a bounded number of direct operations.

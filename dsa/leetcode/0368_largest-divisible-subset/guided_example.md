...
We derive and execute the Array, Math, Dynamic Programming, Sorting recurrence on a representative problem instance.
...
The objective for **Largest Divisible Subset** is to compute the global optimal value by decomposing the problem into overlapping subproblems.

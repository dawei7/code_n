# Guided Example: Count Numbers with Non-Decreasing Digits 

We derive and execute the Math, String, Dynamic Programming recurrence on a representative problem instance.
...
The objective for **Count Numbers with Non-Decreasing Digits ** is to compute the global optimal value by decomposing the problem into overlapping subproblems.

# Simplified Approach - Count Numbers with Non-Decreasing Digits 
...
## Complexity detail
- **Time Complexity**: $O(dm + mb)$ — Each input element is processed in a bounded number of direct operations.

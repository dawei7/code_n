...
We execute the single-pass Linked List, Stack, Tree, Depth-First Search, Binary Tree pointer manipulation on a representative linked list instance.

- **Input:** `{"root": [1, 2, 5, 3, 4, null, 6]}`
- **Required output:** `[1, null, 2, null, 3, null, 4, null, 5, null, 6]`
...
The objective for **Flatten Binary Tree to Linked List** is to transform the linked structure by strictly updating `next` references in place.

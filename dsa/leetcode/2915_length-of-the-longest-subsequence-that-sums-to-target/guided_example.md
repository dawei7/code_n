# Guided Example: Length of the Longest Subsequence That Sums to Target
...
The objective for **Length of the Longest Subsequence That Sums to Target** is to compute the global optimal value by decomposing the problem into overlapping subproblems.

# Guided Example: Visit Array Positions to Maximize Score
...
The objective for **Visit Array Positions to Maximize Score** is to compute the global optimal value by decomposing the problem into overlapping subproblems.

# Simplified Approach - Countries You Can Safely Invest In
...
## Complexity detail
- **Time Complexity**: $O((P + C + E) \log E)$ — Each input element is processed in a bounded number of direct operations.
- **Space Complexity**: $O(P + C + E)$ — Utilizes standard auxiliary storage proportional to the active computation state.

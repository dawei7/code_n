# Guided Example: Minimum Size Subarray in Infinite Array
...
The objective for **Minimum Size Subarray in Infinite Array** is to find the optimal contiguous window without evaluating all $O(N^2)$ candidate subarrays.

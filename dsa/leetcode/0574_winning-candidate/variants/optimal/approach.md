## General
The optimal solution implements an idiomatic, readable, and production-ready approach for **Winning Candidate**.
...
## Complexity detail
- **Time Complexity**: $O(V + C \log C)$ — Operational efficiency across problem constraints.

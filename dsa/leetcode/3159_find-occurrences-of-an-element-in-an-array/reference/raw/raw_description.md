...
**Input:** <span class="example-io">nums = [1,3,1,7], queries = [1,3,2,4], x = 1</span>

**Output:** <span class="example-io">[0,-1,2,-1]</span>
...
<div class="example-block">
**Input:** <span class="example-io">nums = [1,2,3], queries = [10], x = 5</span>

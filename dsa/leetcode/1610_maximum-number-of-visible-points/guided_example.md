# Guided Example: Maximum Number of Visible Points

We trace the dynamic Array, Math, Geometry, Sliding Window, Sorting sliding window on a representative input instance.
...
The objective for **Maximum Number of Visible Points** is to find the optimal contiguous window without evaluating all $O(N^2)$ candidate subarrays.

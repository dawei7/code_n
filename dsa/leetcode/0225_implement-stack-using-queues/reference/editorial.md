...
![Push an element in stack](images/225_stack_using_queues_pushA.png){:width="539px"}
...
![Pop an element from stack](images/225_stack_using_queues_popA.png){:width="539px"}
...
![Push an element in stack](images/225_stack_using_queues_pushB.png){:width="539px"}
...
![Pop an element from stack](images/225_stack_using_queues_popB.png){:width="539px"}
...
![Push an element in stack](images/225_stack_using_queues_pushC.png){:width="539px"}

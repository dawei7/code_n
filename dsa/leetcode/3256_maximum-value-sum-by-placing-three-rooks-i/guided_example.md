# Guided Example: Maximum Value Sum by Placing Three Rooks I
...
The objective for **Maximum Value Sum by Placing Three Rooks I** is to compute the global optimal value by decomposing the problem into overlapping subproblems.

## General
The optimal solution implements an idiomatic, readable, and production-ready approach for **The Number of Employees Which Report to Each Employee**.
...
## Complexity detail
- **Time Complexity**: $O(E)$ — Operational efficiency across problem constraints.

# Simplified Approach - The Number of Employees Which Report to Each Employee
...
## Complexity detail
- **Time Complexity**: $O(E)$ — Each input element is processed in a bounded number of direct operations.

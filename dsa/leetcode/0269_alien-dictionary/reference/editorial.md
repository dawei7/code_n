...
![List of alien words:  wxqkj, whqg, cckgh, cdxg, cdxdt, cdht, ktgxt, ktgch, ktdw, ktdc, jqw, jmc, jmg](images/words.png)
...
![First letters of each word: w, w, c, c, c, c, k, k, k, k, j, and j](images/first_letters.png)

Removing the duplicates, we get:

![First letters of each word without duplicates: w, c, k, and j](images/first_letters_no_duplicates.png)
...
![First two sequences, w, c, k, j and x, h](images/first_two_sequences.png)
...
![Relations between words](images/words_relations_fix.png)
...
![Relations: x → h, w → c, c → d, g → d, c → k, x → c, k → j, q → m, and c → g](images/relations.png)
...
![Some combined chains: w→c→k→j, w→c→d, x→c→k→j, and q→m](images/chains.png)
...
![Graph with sources highlighted](images/graph_bfs_step_1.png)
...
![First group ordering: q w t x](images/one_group_ordering.png)
...
![Graph after first step with new sources highlighted](images/graph_bfs_step_2.png)

On this new graph, there are now three new letters that have no in-arrows. We can add these to our output list.

![Two groups ordering: q w t x, m h c](images/two_groups_ordering.png)

Again, we can remove these from the graph.

![Graph after second step with new sources highlighted](images/graph_bfs_step_3.png)

Then add the two new letters with no in-arrows.

![Three groups ordering: q w t x, m h c, g k](images/three_groups_ordering.png)

Which leaves the following graph.

![Graph after third step with new sources highlighted](images/graph_bfs_step_4.png)

With the final two letters.

![All groups ordering: q w t x, m h c, g k, j d](images/all_groups_ordering.png)
...
![Reverse adjacency list](images/reverse_adjacency_list.png)
...
![Count list](images/indegree_count_list.png)
...
![Slide 1](images/slideshow_269_bfs_animation_Slide1.PNG)

![Slide 2](images/slideshow_269_bfs_animation_Slide2.PNG)

![Slide 3](images/slideshow_269_bfs_animation_Slide3.PNG)

![Slide 4](images/slideshow_269_bfs_animation_Slide4.PNG)

![Slide 5](images/slideshow_269_bfs_animation_Slide5.PNG)

![Slide 6](images/slideshow_269_bfs_animation_Slide6.PNG)

![Slide 7](images/slideshow_269_bfs_animation_Slide7.PNG)

![Slide 8](images/slideshow_269_bfs_animation_Slide8.PNG)

![Slide 9](images/slideshow_269_bfs_animation_Slide9.PNG)

![Slide 10](images/slideshow_269_bfs_animation_Slide10.PNG)

![Slide 11](images/slideshow_269_bfs_animation_Slide11.PNG)

![Slide 12](images/slideshow_269_bfs_animation_Slide12.PNG)

![Slide 13](images/slideshow_269_bfs_animation_Slide13.PNG)

![Slide 14](images/slideshow_269_bfs_animation_Slide14.PNG)

![Slide 15](images/slideshow_269_bfs_animation_Slide15.PNG)

![Slide 16](images/slideshow_269_bfs_animation_Slide16.PNG)

![Slide 17](images/slideshow_269_bfs_animation_Slide17.PNG)

![Slide 18](images/slideshow_269_bfs_animation_Slide18.PNG)

![Slide 19](images/slideshow_269_bfs_animation_Slide19.PNG)

![Slide 20](images/slideshow_269_bfs_animation_Slide20.PNG)

![Slide 21](images/slideshow_269_bfs_animation_Slide21.PNG)

![Slide 22](images/slideshow_269_bfs_animation_Slide22.PNG)
...
*Edges:* Each edge in the graph was generated from comparing two adjacent words in the input list. There are $N - 1$ pairs of adjacent words, and only *one* edge can be generated from each pair. This might initially seem a bit surprising, so let's quickly look at an example. We'll use English words.
    ...
    $O(V + E) =$\mathcal{O}(U + \min(U^2, N - 1)$) =$\mathcal{O}(U + \min(U^2, N)$)$.
    ...
    $O(C) +$\mathcal{O}(U + \min(U^2, N)$) =$\mathcal{O}(C + U + \min(U^2, N)$)$.
    ...
    $O(C + U + \min(U^2, N))  →$\mathcal{O}(C + \min(U^2, N)$)$
...
- Space complexity : $O(1)$ or $O(U + \min(U^2, N))$.
    ...
    So for the question we're given, where $U$ is a constant fixed at a maximum of $26$, the space complexity is simply $O(1)$. This is because $U$ is fixed at $26$, and the number of relations is fixed at $26^2$, so $O(\min($26^{2}$, N)) =$\mathcal{O}(26^{2})$= O(1)$.
...
![Slide 1](images/slideshow_269_dfs_animation_Slide1.PNG)

![Slide 2](images/slideshow_269_dfs_animation_Slide2.PNG)

![Slide 3](images/slideshow_269_dfs_animation_Slide3.PNG)

![Slide 4](images/slideshow_269_dfs_animation_Slide4.PNG)

![Slide 5](images/slideshow_269_dfs_animation_Slide5.PNG)

![Slide 6](images/slideshow_269_dfs_animation_Slide6.PNG)

![Slide 7](images/slideshow_269_dfs_animation_Slide7.PNG)

![Slide 8](images/slideshow_269_dfs_animation_Slide8.PNG)

![Slide 9](images/slideshow_269_dfs_animation_Slide9.PNG)

![Slide 10](images/slideshow_269_dfs_animation_Slide10.PNG)

![Slide 11](images/slideshow_269_dfs_animation_Slide11.PNG)

![Slide 12](images/slideshow_269_dfs_animation_Slide12.PNG)

![Slide 13](images/slideshow_269_dfs_animation_Slide13.PNG)

![Slide 14](images/slideshow_269_dfs_animation_Slide14.PNG)

![Slide 15](images/slideshow_269_dfs_animation_Slide15.PNG)

![Slide 16](images/slideshow_269_dfs_animation_Slide16.PNG)

![Slide 17](images/slideshow_269_dfs_animation_Slide17.PNG)

![Slide 18](images/slideshow_269_dfs_animation_Slide18.PNG)

![Slide 19](images/slideshow_269_dfs_animation_Slide19.PNG)

![Slide 20](images/slideshow_269_dfs_animation_Slide20.PNG)

![Slide 21](images/slideshow_269_dfs_animation_Slide21.PNG)

![Slide 22](images/slideshow_269_dfs_animation_Slide22.PNG)

![Slide 23](images/slideshow_269_dfs_animation_Slide23.PNG)

![Slide 24](images/slideshow_269_dfs_animation_Slide24.PNG)

![Slide 25](images/slideshow_269_dfs_animation_Slide25.PNG)

![Slide 26](images/slideshow_269_dfs_animation_Slide26.PNG)

![Slide 27](images/slideshow_269_dfs_animation_Slide27.PNG)

![Slide 28](images/slideshow_269_dfs_animation_Slide28.PNG)

![Slide 29](images/slideshow_269_dfs_animation_Slide29.PNG)

![Slide 30](images/slideshow_269_dfs_animation_Slide30.PNG)

![Slide 31](images/slideshow_269_dfs_animation_Slide31.PNG)

![Slide 32](images/slideshow_269_dfs_animation_Slide32.PNG)

![Slide 33](images/slideshow_269_dfs_animation_Slide33.PNG)

# Simplified Approach - Alien Dictionary
...
## Complexity detail
- **Time Complexity**: $O(c + e)$ — Each input element is processed in a bounded number of direct operations.
- **Space Complexity**: $O(a + e)$ — Utilizes standard auxiliary storage proportional to the active computation state.

# Guided Example: Length of the Longest Valid Substring

We trace the dynamic Array, Hash Table, String, Sliding Window sliding window on a representative input instance.
...
The objective for **Length of the Longest Valid Substring** is to find the optimal contiguous window without evaluating all $O(N^2)$ candidate subarrays.

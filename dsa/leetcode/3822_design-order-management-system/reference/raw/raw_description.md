...
<span class="example-io">["OrderManagementSystem", "addOrder", "addOrder", "addOrder", "getOrdersAtPrice", "modifyOrder", "modifyOrder", "getOrdersAtPrice", "cancelOrder", "cancelOrder", "getOrdersAtPrice"]

[[], [1, "buy", 1], [2, "buy", 1], [3, "sell", 2], ["buy", 1], [1, 3], [2, 1], ["buy", 1], [3], [2], ["buy", 1]]</span>

**Output:**

<span class="example-io">[null, null, null, null, [2, 1], null, null, [2], null, null, []] </span>
...
**Constraints:**
	...
	- The total number of calls to `addOrder`, `modifyOrder`, `cancelOrder`, and `getOrdersAtPrice` does not exceed <font face="monospace">2000</font>.

# Simplified Approach - Count Lattice Points Inside a Circle
...
## Complexity detail
- **Time Complexity**: $O(sum r_i^2)$ — Each input element is processed in a bounded number of direct operations.

# Simplified Approach - Number of Atoms
...
## Complexity detail
- **Time Complexity**: $O(n + A \log A)$ — Each input element is processed in a bounded number of direct operations.
- **Space Complexity**: $O(A + d)$ — Utilizes standard auxiliary storage proportional to the active computation state.

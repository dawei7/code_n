# Guided Example: Find Longest Special Substring That Occurs Thrice II

We trace the dynamic Hash Table, String, Binary Search, Sliding Window, Counting sliding window on a representative input instance.
...
The objective for **Find Longest Special Substring That Occurs Thrice II** is to find the optimal contiguous window without evaluating all $O(N^2)$ candidate subarrays.

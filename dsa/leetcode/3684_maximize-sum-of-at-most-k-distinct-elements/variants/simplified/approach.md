# Simplified Approach - Maximize Sum of At Most K Distinct Elements
...
## Complexity detail
- **Time Complexity**: $O(n + U log U)$ — Each input element is processed in a bounded number of direct operations.

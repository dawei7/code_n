...
- **Required output:** `[null, null, null, 1, null, -1, null, -1, 3, 4]`
...
The objective for **LRU Cache** is to transform the linked structure by strictly updating `next` references in place.

# Simplified Approach - Paint House III
...
## Complexity detail
- **Time Complexity**: $O(mtn)$ — Each input element is processed in a bounded number of direct operations.
- **Space Complexity**: $O(tn)$ — Utilizes standard auxiliary storage proportional to the active computation state.

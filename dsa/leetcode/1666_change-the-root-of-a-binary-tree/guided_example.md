...
- **Input:** `{"root": {"tree": [3, 5, 1, 6, 2, 0, 8, null, null, 7, 4]}, "leaf": {"same_tree_as": "root", "target_index": 9}}`
...
The objective for **Change the Root of a Binary Tree** is to evaluate tree properties by visiting nodes in topological hierarchy (post-order, pre-order, or level-order).

# Simplified Approach - Maximum Rows Covered by Columns
...
## Complexity detail
- **Time Complexity**: $O(mn + (m + k) C(n,k))$ — Each input element is processed in a bounded number of direct operations.

...
![Slide 1](images/slideshow_s1_904-1_1.png)

![Slide 2](images/slideshow_s1_904-1_2.png)

![Slide 3](images/slideshow_s1_904-1_3.png)

![Slide 4](images/slideshow_s1_904-1_4.png)

![Slide 5](images/slideshow_s1_904-1_5.png)

![Slide 6](images/slideshow_s1_904-1_6.png)

![Slide 7](images/slideshow_s1_904-1_7.png)

![Slide 8](images/slideshow_s1_904-1_8.png)

![Slide 9](images/slideshow_s1_904-1_9.png)

<br>

#### Algorithm

1) Initialize $\text{max}_{picked} = 0$ to track the maximum number of fruits we can collect.
...
- If there are no more than 2 types, this subarray is valid, we take its length to update $\text{max}_{picked}$.

- Otherwise, if the current subarray is **invalid**, we move on to the next subarray.

5) Once we finish the iteration, return $\text{max}_{picked}$ as the maximum number of fruits we can collect.
...
![Slide 1](images/slideshow_s2_904-2_1.png)

![Slide 2](images/slideshow_s2_904-2_2.png)

![Slide 3](images/slideshow_s2_904-2_3.png)

![Slide 4](images/slideshow_s2_904-2_4.png)

![Slide 5](images/slideshow_s2_904-2_5.png)

![Slide 6](images/slideshow_s2_904-2_6.png)

![Slide 7](images/slideshow_s2_904-2_7.png)

![Slide 8](images/slideshow_s2_904-2_8.png)

![Slide 9](images/slideshow_s2_904-2_9.png)

![Slide 10](images/slideshow_s2_904-2_10.png)

<br>

#### Algorithm

1) Initialize $\text{max}_{picked}$ as 0.
...
- If there are no more than 2 types, this subarray is valid, we update $\text{max}_{picked}$ with the length of this subarray.
...
4) Once we finish the iteration, return $\text{max}_{picked}$ as the maximum number of fruits we can collect.
...
![Slide 1](images/slideshow_s4_904_3-sw2_1.png)

![Slide 2](images/slideshow_s4_904_3-sw2_2.png)

![Slide 3](images/slideshow_s4_904_3-sw2_3.png)

![Slide 4](images/slideshow_s4_904_3-sw2_4.png)

![Slide 5](images/slideshow_s4_904_3-sw2_5.png)

![Slide 6](images/slideshow_s4_904_3-sw2_6.png)

![Slide 7](images/slideshow_s4_904_3-sw2_7.png)

![Slide 8](images/slideshow_s4_904_3-sw2_8.png)

![Slide 9](images/slideshow_s4_904_3-sw2_9.png)

![Slide 10](images/slideshow_s4_904_3-sw2_10.png)

![Slide 11](images/slideshow_s4_904_3-sw2_11.png)

![Slide 12](images/slideshow_s4_904_3-sw2_12.png)

![Slide 13](images/slideshow_s4_904_3-sw2_13.png)

![Slide 14](images/slideshow_s4_904_3-sw2_14.png)
...
2) We iterate over `right` and add $\text{fruits}[right]$ to this window.
...
4) Once we are done iterating, the difference between `left` and `right` stands for the longest valid subarray we encountered, i.e. the maximum number of fruits we can collect.
...
This can be optimized by making sure that there are always at most 2 types of fruits in the window. After adding a new fruit from the right side `right`, if the current window has more than 2 types of fruit, we keep removing fruits from the left side `left` until the current window has only 2 types of fruit. Note that the window size may become smaller than before, thus we cannot rely on `left` and `right` to keep track of the maximum number of fruits we can collect. Instead, we can just use a variable $\text{max}_{picked}$ to keep track of the maximum window size we encountered.

![img](images/904_sc_3.png)

For the details on the implementation, let's take a look at the following slides.

![Slide 1](images/slideshow_s3_904_2-sw_1.png)

![Slide 2](images/slideshow_s3_904_2-sw_2.png)

![Slide 3](images/slideshow_s3_904_2-sw_3.png)

![Slide 4](images/slideshow_s3_904_2-sw_4.png)

![Slide 5](images/slideshow_s3_904_2-sw_5.png)

![Slide 6](images/slideshow_s3_904_2-sw_6.png)

![Slide 7](images/slideshow_s3_904_2-sw_7.png)

![Slide 8](images/slideshow_s3_904_2-sw_8.png)

![Slide 9](images/slideshow_s3_904_2-sw_9.png)

![Slide 10](images/slideshow_s3_904_2-sw_10.png)

![Slide 11](images/slideshow_s3_904_2-sw_11.png)

![Slide 12](images/slideshow_s3_904_2-sw_12.png)

![Slide 13](images/slideshow_s3_904_2-sw_13.png)

<br>

#### Algorithm

1) Initialize $\text{max}_{picked} = 0$ as the maximum fruits we can collect, and use hash map `basket` to record the types of fruits in the current window.

2) Start with an empty window having $left = 0$ and $right = 0$ as its left and right index.

3) We iterate over `right` and add $\text{fruits}[right]$ to this window.
...
- Otherwise, we need to keep removing fruits from the left side until there are only 2 types of fruits in the window.
    ...
    Then we update $\text{max}_{picked}$ as $max(\text{max}_{picked}, right - left + 1)$.

4) Once we finish iterating, return $\text{max}_{picked}$ as the maximum number of fruits we can collect.

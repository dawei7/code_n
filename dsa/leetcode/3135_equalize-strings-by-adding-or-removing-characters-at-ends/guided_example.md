# Guided Example: Equalize Strings by Adding or Removing Characters at Ends

We trace the dynamic String, Binary Search, Dynamic Programming, Sliding Window, Hash Function sliding window on a representative input instance.
...
The objective for **Equalize Strings by Adding or Removing Characters at Ends** is to find the optimal contiguous window without evaluating all $O(N^2)$ candidate subarrays.

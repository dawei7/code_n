...
**Input:** <span class="example-io">initial = "abcde", target = "cdef"</span>
...
<div class="example-block">
**Input:** <span class="example-io">initial = "axxy", target = "yabx"</span>
...
<div class="example-block">
**Input:** <span class="example-io">initial = "xyz", target = "xyz"</span>

# Simplified Approach - Divide Nodes Into the Maximum Number of Groups
...
## Complexity detail
- **Time Complexity**: $O(n(n+m))$ — Each input element is processed in a bounded number of direct operations.

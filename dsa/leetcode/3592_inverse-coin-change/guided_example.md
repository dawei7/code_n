# Guided Example: Inverse Coin Change
...
The objective for **Inverse Coin Change** is to compute the global optimal value by decomposing the problem into overlapping subproblems.

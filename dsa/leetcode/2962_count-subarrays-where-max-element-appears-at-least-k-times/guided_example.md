# Guided Example: Count Subarrays Where Max Element Appears at Least K Times
...
The objective for **Count Subarrays Where Max Element Appears at Least K Times** is to find the optimal contiguous window without evaluating all $O(N^2)$ candidate subarrays.

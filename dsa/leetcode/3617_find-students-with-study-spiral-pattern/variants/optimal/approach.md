## General
The optimal solution implements an idiomatic, readable, and production-ready approach for **Find Students with Study Spiral Pattern**.
...
## Complexity detail
- **Time Complexity**: $O(R log R + S log S)$ — Operational efficiency across problem constraints.

# Guided Example: Count Substrings That Can Be Rearranged to Contain a String I
...
The objective for **Count Substrings That Can Be Rearranged to Contain a String I** is to find the optimal contiguous window without evaluating all $O(N^2)$ candidate subarrays.

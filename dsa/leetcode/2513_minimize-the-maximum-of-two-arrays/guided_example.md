# Guided Example: Minimize the Maximum of Two Arrays

We trace the logarithmic Math, Binary Search, Number Theory search on a representative problem instance.
...
The objective for **Minimize the Maximum of Two Arrays** is to pinpoint the target value or optimal threshold in logarithmic $O(\log N)$ time.

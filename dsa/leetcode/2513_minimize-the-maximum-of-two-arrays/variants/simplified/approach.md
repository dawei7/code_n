# Simplified Approach - Minimize the Maximum of Two Arrays
...
## Complexity detail
- **Time Complexity**: $O(log D + log C)$ — Each input element is processed in a bounded number of direct operations.

...
is the sum of BST $F(i, n)$ enumerating each number `i` ($1 \le i \le n$) as a root. Hence,

$G(n) = \sum_{i=1}^{n} F(i, n) \qquad  \qquad (1)$

Particularly, for the base cases, there is only one combination to construct a BST
...
<center><img src="images/96_BST.png" width="550px" /></center>

# Guided Example: Double a Number Represented as a Linked List

We execute the single-pass Linked List, Math, Stack pointer manipulation on a representative linked list instance.

- **Input:** `{"head": [1, 8, 9]}`
- **Required output:** `[3, 7, 8]`
...
The objective for **Double a Number Represented as a Linked List** is to transform the linked structure by strictly updating `next` references in place.

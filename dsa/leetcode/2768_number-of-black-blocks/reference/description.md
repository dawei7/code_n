...
You are also given a **0-indexed** 2D integer matrix `coordinates`, where $\text{coordinates}[i] = [x, y]$ indicates that the cell with coordinates `[x, y]` is colored **black**. All cells in the grid that do not appear in `coordinates` are **white**.
...
![](images/screen-shot-2023-06-18-at-44656-am.png)
...
- **Output:** `[0,2,2,0,0]`
- **Explanation:** The grid looks like this:
![](images/screen-shot-2023-06-18-at-45018-am.png)

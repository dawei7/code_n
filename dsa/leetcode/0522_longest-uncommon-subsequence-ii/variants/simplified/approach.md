# Simplified Approach - Longest Uncommon Subsequence II
...
## Complexity detail
- **Time Complexity**: $O(k^2 \cdot L)$ — Each input element is processed in a bounded number of direct operations.

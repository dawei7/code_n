# Simplified Approach - Minimum Moves to Clean the Classroom
...
## Complexity detail
- **Time Complexity**: $O(m n 2^L E)$ — Each input element is processed in a bounded number of direct operations.
- **Space Complexity**: $O(m n 2^L E)$ — Utilizes standard auxiliary storage proportional to the active computation state.

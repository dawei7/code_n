# Guided Example: Find Products of Elements of Big Array

We trace the logarithmic Array, Binary Search, Bit Manipulation search on a representative problem instance.
...
The objective for **Find Products of Elements of Big Array** is to pinpoint the target value or optimal threshold in logarithmic $O(\log N)$ time.

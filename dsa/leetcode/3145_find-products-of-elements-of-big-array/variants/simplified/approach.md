# Simplified Approach - Find Products of Elements of Big Array
...
## Complexity detail
- **Time Complexity**: $O(q * log^2 U)$ — Each input element is processed in a bounded number of direct operations.

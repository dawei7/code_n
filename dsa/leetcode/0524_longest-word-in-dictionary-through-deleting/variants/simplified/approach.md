# Simplified Approach - Longest Word in Dictionary through Deleting
...
## Complexity detail
- **Time Complexity**: $O(|dictionary| \cdot |s|)$ — Each input element is processed in a bounded number of direct operations.

# Simplified Approach - Delete Greatest Value in Each Row
...
## Complexity detail
- **Time Complexity**: $O(m n log n)$ — Each input element is processed in a bounded number of direct operations.

# Guided Example: Count Substrings That Satisfy K-Constraint II

We trace the dynamic Array, String, Binary Search, Sliding Window, Prefix Sum sliding window on a representative input instance.
...
The objective for **Count Substrings That Satisfy K-Constraint II** is to find the optimal contiguous window without evaluating all $O(N^2)$ candidate subarrays.

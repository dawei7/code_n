...
**Input:** <span class="example-io">towers = [[1,2,5], [2,1,7], [3,1,9]], center = [1,1], radius = 2</span>
...
<div class="example-block">
**Input:** <span class="example-io">towers = [[1,3,4], [2,2,4], [4,4,7]], center = [0,0], radius = 5</span>
...
<div class="example-block">
**Input:** <span class="example-io">towers = [[5,6,8], [0,3,5]], center = [1,2], radius = 1</span>

...
We trace the hierarchical Array, Divide and Conquer, Tree, Matrix traversal and subtree aggregation on a representative binary tree.

- **Input:** `{"grid": [[0, 1], [1, 0]]}`
- **Required output:** `{"leaf": false, "children": [{"leaf": true, "value": 0}, {"leaf": true, "value": 1}, {"leaf": true, "value": 1}, {"leaf": true, "value": 0}]}`
...
The objective for **Construct Quad Tree** is to evaluate tree properties by visiting nodes in topological hierarchy (post-order, pre-order, or level-order).

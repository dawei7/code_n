...
Note that $N$ would always be in the form of $2^x$ (`x >= 0`), and hence at any point in the above process, it would be possible to divide the matrix into four equal parts.

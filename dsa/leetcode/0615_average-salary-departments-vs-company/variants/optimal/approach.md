## General
The optimal solution implements an idiomatic, readable, and production-ready approach for **Average Salary: Departments VS Company**.
...
## Complexity detail
- **Time Complexity**: $O((S + E) \log(S + E))$ — Operational efficiency across problem constraints.

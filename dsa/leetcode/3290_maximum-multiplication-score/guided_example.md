# Guided Example: Maximum Multiplication Score
...
The objective for **Maximum Multiplication Score** is to compute the global optimal value by decomposing the problem into overlapping subproblems.

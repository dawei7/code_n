# Simplified Approach - Minimum Moves to Spread Stones Over Grid
...
## Complexity detail
- **Time Complexity**: $O(k \cdot 2^k)$ — Each input element is processed in a bounded number of direct operations.

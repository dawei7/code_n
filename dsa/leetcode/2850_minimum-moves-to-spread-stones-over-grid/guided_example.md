# Guided Example: Minimum Moves to Spread Stones Over Grid

We derive and execute the Array, Dynamic Programming, Backtracking, Bit Manipulation, Matrix, Bitmask recurrence on a representative problem instance.
...
The objective for **Minimum Moves to Spread Stones Over Grid** is to compute the global optimal value by decomposing the problem into overlapping subproblems.

# Guided Example: Minimum Split Into Subarrays With GCD Greater Than One

We derive and execute the Array, Math, Dynamic Programming, Greedy, Number Theory recurrence on a representative problem instance.
...
The objective for **Minimum Split Into Subarrays With GCD Greater Than One** is to compute the global optimal value by decomposing the problem into overlapping subproblems.

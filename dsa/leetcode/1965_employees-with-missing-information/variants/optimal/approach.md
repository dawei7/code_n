## General
The optimal solution implements an idiomatic, readable, and production-ready approach for **Employees With Missing Information**.
...
## Complexity detail
- **Time Complexity**: $O(E+S)$ — Operational efficiency across problem constraints.

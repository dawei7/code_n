...
- **Input:** `{"root": [7, 3, 15, null, null, 9, 20], "operations": ["BSTIterator", "hasNext", "next", "hasPrev", "next", "hasPrev", "prev", "next", "next", "hasNext", "next", "next", "hasNext", "hasPrev", "prev", "prev"]}`
- **Required output:** `[null, true, 3, false, 7, true, 3, 7, 9, true, 15, 20, false, true, 15, 9]`
...
The objective for **Binary Search Tree Iterator II** is to evaluate tree properties by visiting nodes in topological hierarchy (post-order, pre-order, or level-order).

...
We trace the dynamic Hash Table, String, Divide and Conquer, Sliding Window sliding window on a representative input instance.
...
The objective for **Longest Substring with At Least K Repeating Characters** is to find the optimal contiguous window without evaluating all $O(N^2)$ candidate subarrays.

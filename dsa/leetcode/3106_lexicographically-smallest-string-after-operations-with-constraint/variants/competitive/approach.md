## General
**Competitive Approach — Lexicographically Smallest String After Operations With Constraint**
...
Sourced from `kamyu104/LeetCode-Solutions`. This implementation focuses on raw computational throughput in method `getSmallestString`. It minimizes object instantiation overhead, avoids redundant memory passes, and leverages compact iteration loops.

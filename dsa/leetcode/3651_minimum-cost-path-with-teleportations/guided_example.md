# Guided Example: Minimum Cost Path with Teleportations
...
The objective for **Minimum Cost Path with Teleportations** is to compute the global optimal value by decomposing the problem into overlapping subproblems.

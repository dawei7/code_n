# Guided Example: Count No-Zero Pairs That Sum to N
...
The objective for **Count No-Zero Pairs That Sum to N** is to compute the global optimal value by decomposing the problem into overlapping subproblems.

## General
**Competitive Approach — Minimum Cost for Cutting Cake II**

The solution implements an direct algorithm tailored for Minimum Cost for Cutting Cake II.
...
## Complexity detail
- **Time Complexity**: $O(m log m + n log n)$ — Operation count proportional to input scale.

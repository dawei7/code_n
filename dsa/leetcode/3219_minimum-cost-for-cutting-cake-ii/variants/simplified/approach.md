# Simplified Approach - Minimum Cost for Cutting Cake II
...
## Complexity detail
- **Time Complexity**: $O(m log m + n log n)$ — Each input element is processed in a bounded number of direct operations.

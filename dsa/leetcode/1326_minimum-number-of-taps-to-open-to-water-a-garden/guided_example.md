...
The objective for **Minimum Number of Taps to Open to Water a Garden** is to compute the global optimal value by decomposing the problem into overlapping subproblems.

# Guided Example: Length of Longest V-Shaped Diagonal Segment

We derive and execute the Array, Dynamic Programming, Memoization, Matrix recurrence on a representative problem instance.
...
The objective for **Length of Longest V-Shaped Diagonal Segment** is to compute the global optimal value by decomposing the problem into overlapping subproblems.

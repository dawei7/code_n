...
We derive and execute the Hash Table, String, Dynamic Programming recurrence on a representative problem instance.
...
The objective for **Count Unique Characters of All Substrings of a Given String** is to compute the global optimal value by decomposing the problem into overlapping subproblems.

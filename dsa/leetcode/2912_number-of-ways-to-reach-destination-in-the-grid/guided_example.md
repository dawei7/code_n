# Guided Example: Number of Ways to Reach Destination in the Grid
...
The objective for **Number of Ways to Reach Destination in the Grid** is to compute the global optimal value by decomposing the problem into overlapping subproblems.

## General
**Competitive Approach — Insert Delete GetRandom O(1) - Duplicates allowed**

The solution implements an direct algorithm tailored for Insert Delete GetRandom O(1) - Duplicates allowed. It utilizes Hash Map / Dictionary for $O(1)$ average lookup and frequency tracking to maintain optimal runtime bounds.

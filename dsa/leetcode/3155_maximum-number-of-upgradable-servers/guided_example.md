# Guided Example: Maximum Number of Upgradable Servers

We trace the logarithmic Array, Math, Binary Search search on a representative problem instance.
...
The objective for **Maximum Number of Upgradable Servers** is to pinpoint the target value or optimal threshold in logarithmic $O(\log N)$ time.

...
## Problem Description
[Open the original LeetCode problem](https://leetcode.com/problems/range-product-queries-of-powers/).
...
- Output: `[2, 4, 64]`
- Explanation: 15 is 1 + 2 + 4 + 8. Powers are [1, 2, 4, 8]. Range [0, 1] is 1*2=2. Range [2, 2] is 4. Range [0, 3] is 1*2*4*8=64.

...
We derive and execute the Array, Math, Dynamic Programming, Prefix Sum recurrence on a representative problem instance.
...
The objective for **Number of Sub-arrays With Odd Sum** is to compute the global optimal value by decomposing the problem into overlapping subproblems.

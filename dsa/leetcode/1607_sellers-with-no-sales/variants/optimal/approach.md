## General
The optimal solution implements an idiomatic, readable, and production-ready approach for **Sellers With No Sales**.
...
## Complexity detail
- **Time Complexity**: $O((s+r)\log(s+r))$ — Operational efficiency across problem constraints.

# Simplified Approach - Users That Actively Request Confirmation Messages
...
## Complexity detail
- **Time Complexity**: $O(C\log C)$ — Each input element is processed in a bounded number of direct operations.
- **Space Complexity**: $O(C)$ — Utilizes standard auxiliary storage proportional to the active computation state.

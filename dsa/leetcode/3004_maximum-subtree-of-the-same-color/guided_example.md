# Guided Example: Maximum Subtree of the Same Color
...
The objective for **Maximum Subtree of the Same Color** is to evaluate tree properties by visiting nodes in topological hierarchy (post-order, pre-order, or level-order).

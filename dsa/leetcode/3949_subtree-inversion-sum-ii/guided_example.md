# Guided Example: Subtree Inversion Sum II
...
The objective for **Subtree Inversion Sum II** is to evaluate tree properties by visiting nodes in topological hierarchy (post-order, pre-order, or level-order).

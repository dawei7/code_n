# Guided Example: Maximum Difference Between Even and Odd Frequency II

We trace the dynamic String, Sliding Window, Enumeration, Prefix Sum sliding window on a representative input instance.
...
The objective for **Maximum Difference Between Even and Odd Frequency II** is to find the optimal contiguous window without evaluating all $O(N^2)$ candidate subarrays.

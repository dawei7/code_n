...
Use a partition scheme (please check the next section) to place the pivot into its perfect position $\text{pivot}_{index}$ in the sorted array, move less frequent elements to the left of the pivot, and more frequent or of the same frequency - to the right.

* Compare $\text{pivot}_{index}$ and $N - k$.

- If $\text{pivot}_{index} = N - k$, the pivot is $N - k$*th* most frequent element, and all elements on the right are more frequent or of the same frequency. Return these top $k$ frequent elements.

- Otherwise, choose the side of the array to proceed recursively.

![diff](images/details.png)
...
- Set the pointer at the beginning of the array $\text{store}_{index} = left$.

- Iterate over the array and move all less frequent elements to the left $swap(\text{store}_{index}, i)$. Move $\text{store}_{index}$ one step to the right after each swap.

- Move the pivot to its final place, and return this index.

![Slide 1](images/slideshow_347_RES_347_fixed_1.png)

![Slide 2](images/slideshow_347_RES_347_fixed_2.png)

![Slide 3](images/slideshow_347_RES_347_fixed_3.png)

![Slide 4](images/slideshow_347_RES_347_fixed_4.png)

![Slide 5](images/slideshow_347_RES_347_fixed_5.png)

![Slide 6](images/slideshow_347_RES_347_fixed_6.png)

![Slide 7](images/slideshow_347_RES_347_fixed_7.png)

![Slide 8](images/slideshow_347_RES_347_fixed_8.png)

![Slide 9](images/slideshow_347_RES_347_fixed_9.png)

![Slide 10](images/slideshow_347_RES_347_fixed_10.png)

![Slide 11](images/slideshow_347_RES_347_fixed_11.png)

![Slide 12](images/slideshow_347_RES_347_fixed_12.png)

![Slide 13](images/slideshow_347_RES_347_fixed_13.png)

![Slide 14](images/slideshow_347_RES_347_fixed_14.png)

# Guided Example: Prime Subtraction Operation

We trace the logarithmic Array, Math, Binary Search, Greedy, Number Theory search on a representative problem instance.
...
The objective for **Prime Subtraction Operation** is to pinpoint the target value or optimal threshold in logarithmic $O(\log N)$ time.

# Guided Example: Palindromic Path Queries in a Tree

We trace the hierarchical Array, String, Divide and Conquer, Bit Manipulation, Tree, Depth-First Search, Segment Tree traversal and subtree aggregation on a representative binary tree.
...
The objective for **Palindromic Path Queries in a Tree** is to evaluate tree properties by visiting nodes in topological hierarchy (post-order, pre-order, or level-order).

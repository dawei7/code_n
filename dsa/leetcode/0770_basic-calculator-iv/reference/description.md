...
- $1 \le \text{evalvars}[i].length \le 20$

- $\text{evalvars}[i]$ consists of lowercase English letters.

- $\text{evalints.length} = \text{evalvars.length}$

- $-100 \le \text{evalints}[i] \le 100$
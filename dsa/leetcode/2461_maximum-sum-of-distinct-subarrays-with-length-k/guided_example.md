# Guided Example: Maximum Sum of Distinct Subarrays With Length K
...
The objective for **Maximum Sum of Distinct Subarrays With Length K** is to find the optimal contiguous window without evaluating all $O(N^2)$ candidate subarrays.

# Simplified Approach - Lowest Common Ancestor of a Binary Tree IV
...
- **Space Complexity**: $O(H + K)$ — Utilizes standard auxiliary storage proportional to the active computation state.

# Guided Example: Merge Operations for Minimum Travel Time
...
The objective for **Merge Operations for Minimum Travel Time** is to compute the global optimal value by decomposing the problem into overlapping subproblems.

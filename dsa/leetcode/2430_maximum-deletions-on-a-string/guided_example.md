...
We derive and execute the String, Dynamic Programming, Rolling Hash, String Matching, Hash Function recurrence on a representative problem instance.
...
The objective for **Maximum Deletions on a String** is to compute the global optimal value by decomposing the problem into overlapping subproblems.

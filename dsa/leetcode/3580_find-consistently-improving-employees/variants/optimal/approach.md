## General
The optimal solution implements an idiomatic, readable, and production-ready approach for **Find Consistently Improving Employees**.
...
## Complexity detail
- **Time Complexity**: $O(R log R + E log E)$ — Operational efficiency across problem constraints.

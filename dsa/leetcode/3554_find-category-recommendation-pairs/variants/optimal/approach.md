## General
The optimal solution implements an idiomatic, readable, and production-ready approach for **Find Category Recommendation Pairs**.
...
## Complexity detail
- **Time Complexity**: $O(P log P + J log J + I log I)$ — Operational efficiency across problem constraints.

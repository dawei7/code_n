# Guided Example: Find Elements in a Contaminated Binary Tree

We trace the hierarchical Hash Table, Tree, Depth-First Search, Breadth-First Search, Design, Binary Tree traversal and subtree aggregation on a representative binary tree.
...
The objective for **Find Elements in a Contaminated Binary Tree** is to evaluate tree properties by visiting nodes in topological hierarchy (post-order, pre-order, or level-order).

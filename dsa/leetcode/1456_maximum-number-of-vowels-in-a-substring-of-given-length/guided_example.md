...
The objective for **Maximum Number of Vowels in a Substring of Given Length** is to find the optimal contiguous window without evaluating all $O(N^2)$ candidate subarrays.

## General
The optimal solution implements an idiomatic, readable, and production-ready approach for **Find All Unique Email Domains**.
...
## Complexity detail
- **Time Complexity**: $O(S + g log g)$ — Operational efficiency across problem constraints.

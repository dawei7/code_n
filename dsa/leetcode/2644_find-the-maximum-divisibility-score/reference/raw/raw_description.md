...
**Input:** <span class="example-io">nums = [2,9,15,50], divisors = [5,3,7,2]</span>
...
<div class="example-block">
**Input:** <span class="example-io">nums = [4,7,9,3,9], divisors = [5,2,3]</span>
...
<div class="example-block">
**Input:** <span class="example-io">nums = [20,14,21,10], divisors = [10,16,20]</span>

## General
**Competitive Approach — Actors and Directors Who Cooperated At Least Three Times**

The query executes a structured relational pipeline for **Actors and Directors Who Cooperated At Least Three Times**. It uses `GROUP BY` aggregation with PostgreSQL standard functions (`COALESCE`, `STRING_AGG`).

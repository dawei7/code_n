## General
The optimal solution implements an idiomatic, readable, and production-ready approach for **Hopper Company Queries III**.
...
## Complexity detail
- **Time Complexity**: $O(r+a)$ — Operational efficiency across problem constraints.

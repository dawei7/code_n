# Guided Example: Maximum Distinct Path Sum in a Binary Tree
...
The objective for **Maximum Distinct Path Sum in a Binary Tree** is to evaluate tree properties by visiting nodes in topological hierarchy (post-order, pre-order, or level-order).

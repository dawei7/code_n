## General
**Optimal Approach — Reported Posts**

The query executes a structured relational pipeline for **Reported Posts**. It uses `GROUP BY` aggregation with PostgreSQL standard functions (`COALESCE`, `STRING_AGG`).

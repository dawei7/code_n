# Simplified Approach - Lexicographically Smallest Equivalent String
...
## Complexity detail
- **Time Complexity**: $O(P+B+A)$ — Each input element is processed in a bounded number of direct operations.

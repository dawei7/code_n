## General
The optimal solution implements an idiomatic, readable, and production-ready approach for **Customer Purchasing Behavior Analysis**.
...
## Complexity detail
- **Time Complexity**: $O(t log t)$ — Operational efficiency across problem constraints.

# Guided Example: Maximize the Minimum Powered City

We trace the dynamic Array, Binary Search, Greedy, Queue, Sliding Window, Prefix Sum sliding window on a representative input instance.
...
The objective for **Maximize the Minimum Powered City** is to find the optimal contiguous window without evaluating all $O(N^2)$ candidate subarrays.

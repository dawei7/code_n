# Guided Example: Total Waviness of Numbers in Range I

We derive and execute the Math, Dynamic Programming, Enumeration recurrence on a representative problem instance.
...
The objective for **Total Waviness of Numbers in Range I** is to compute the global optimal value by decomposing the problem into overlapping subproblems.

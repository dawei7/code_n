# Simplified Approach - Longest Palindrome After Substring Concatenation II
...
## Complexity detail
- **Time Complexity**: $O(nm + n + m)$ — Each input element is processed in a bounded number of direct operations.

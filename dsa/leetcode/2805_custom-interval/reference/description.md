...
- **Output:** `[50,120,210]`
- **Explanation:** const t = performance.now()
const result = []
const fn = () => {
...
- **Output:** `[20,60,120]`
- **Explanation:** 20 + 20 * 0 = 20 // 20ms - 1st function call
...
- **Output:** `[100,400]`
- **Explanation:** 100 + 200 * 0 = 100 // 100ms - 1st function call

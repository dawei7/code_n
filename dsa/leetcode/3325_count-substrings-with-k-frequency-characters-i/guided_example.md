# Guided Example: Count Substrings With K-Frequency Characters I
...
The objective for **Count Substrings With K-Frequency Characters I** is to find the optimal contiguous window without evaluating all $O(N^2)$ candidate subarrays.

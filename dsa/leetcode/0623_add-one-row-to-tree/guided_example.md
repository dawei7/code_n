...
- **Required output:** `[4, 1, 1, 2, null, null, 6, 3, 1, 5]`
...
The objective for **Add One Row to Tree** is to evaluate tree properties by visiting nodes in topological hierarchy (post-order, pre-order, or level-order).

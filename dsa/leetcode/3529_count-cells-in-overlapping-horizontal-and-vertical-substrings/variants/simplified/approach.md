# Simplified Approach - Count Cells in Overlapping Horizontal and Vertical Substrings
...
## Complexity detail
- **Time Complexity**: $O(N + P)$ — Each input element is processed in a bounded number of direct operations.
- **Space Complexity**: $O(N + P)$ — Utilizes standard auxiliary storage proportional to the active computation state.

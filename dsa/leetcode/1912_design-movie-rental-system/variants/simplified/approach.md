# Simplified Approach - Design Movie Rental System
...
## Complexity detail
- **Time Complexity**: $O(E \log E + Q \log(E + Q))$ — Each input element is processed in a bounded number of direct operations.
- **Space Complexity**: $O(E + Q)$ — Utilizes standard auxiliary storage proportional to the active computation state.

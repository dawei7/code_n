## General
The optimal solution implements an idiomatic, readable, and production-ready approach for **Unpopular Books**.
...
## Complexity detail
- **Time Complexity**: $O((B + O) \log (B + O))$ — Operational efficiency across problem constraints.

# Guided Example: Apply Operations to Maximize Frequency Score
...
The objective for **Apply Operations to Maximize Frequency Score** is to find the optimal contiguous window without evaluating all $O(N^2)$ candidate subarrays.

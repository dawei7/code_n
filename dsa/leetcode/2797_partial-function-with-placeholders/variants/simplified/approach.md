# Simplified Approach - Partial Function with Placeholders
...
## Complexity detail
- **Time Complexity**: $O(a + r)$ — Each input element is processed in a bounded number of direct operations.
- **Space Complexity**: $O(a + r)$ — Utilizes standard auxiliary storage proportional to the active computation state.

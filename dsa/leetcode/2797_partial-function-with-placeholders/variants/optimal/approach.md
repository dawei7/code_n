## General
The optimal solution implements an idiomatic, readable, and production-ready approach for **Partial Function with Placeholders**.
...
## Complexity detail
- **Time Complexity**: $O(a + r)$ — Operational efficiency across problem constraints.

...
![Table of sample trip times](images/trip_times.png)
...
![Table of sample check in times and stations](images/check_in_table.png)
...
![Table of sample trip times with average time column](images/trip_times_with_average_time.png)

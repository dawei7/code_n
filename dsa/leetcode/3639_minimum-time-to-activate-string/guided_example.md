# Guided Example: Minimum Time to Activate String
...
The objective for **Minimum Time to Activate String** is to pinpoint the target value or optimal threshold in logarithmic $O(\log N)$ time.

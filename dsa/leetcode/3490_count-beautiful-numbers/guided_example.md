# Guided Example: Count Beautiful Numbers
...
The objective for **Count Beautiful Numbers** is to compute the global optimal value by decomposing the problem into overlapping subproblems.

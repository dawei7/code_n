# Simplified Approach - Count Beautiful Numbers
...
## Complexity detail
- **Time Complexity**: $O(D^4)$ — Each input element is processed in a bounded number of direct operations.
- **Space Complexity**: $O(D^3)$ — Utilizes standard auxiliary storage proportional to the active computation state.

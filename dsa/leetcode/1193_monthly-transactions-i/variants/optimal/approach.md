## General
**Optimal Approach — Monthly Transactions I**

The query executes a structured relational pipeline for **Monthly Transactions I**. It uses `GROUP BY` aggregation with PostgreSQL standard functions (`COALESCE`, `STRING_AGG`).

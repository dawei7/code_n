# Guided Example: Minimum Number of Primes to Sum to Target
...
The objective for **Minimum Number of Primes to Sum to Target** is to compute the global optimal value by decomposing the problem into overlapping subproblems.

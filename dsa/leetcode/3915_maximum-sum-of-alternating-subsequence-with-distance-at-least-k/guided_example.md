# Guided Example: Maximum Sum of Alternating Subsequence With Distance at Least K

We derive and execute the Array, Dynamic Programming, Segment Tree recurrence on a representative problem instance.
...
The objective for **Maximum Sum of Alternating Subsequence With Distance at Least K** is to compute the global optimal value by decomposing the problem into overlapping subproblems.

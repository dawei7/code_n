...
- **Required output:** `[8, 12, 6, 10, 10, 10]`
...
The objective for **Sum of Distances in Tree** is to evaluate tree properties by visiting nodes in topological hierarchy (post-order, pre-order, or level-order).

# Simplified Approach - Pizza Toppings Cost Analysis
...
## Complexity detail
- **Time Complexity**: $O(n^3 log n)$ — Each input element is processed in a bounded number of direct operations.
- **Space Complexity**: $O(n^3)$ — Utilizes standard auxiliary storage proportional to the active computation state.

## General
The optimal solution implements an idiomatic, readable, and production-ready approach for **Pizza Toppings Cost Analysis**.
...
## Complexity detail
- **Time Complexity**: $O(n^3 log n)$ — Operational efficiency across problem constraints.

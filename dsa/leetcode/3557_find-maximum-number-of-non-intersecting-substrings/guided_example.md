# Guided Example: Find Maximum Number of Non Intersecting Substrings

We derive and execute the Hash Table, String, Dynamic Programming, Greedy recurrence on a representative problem instance.
...
The objective for **Find Maximum Number of Non Intersecting Substrings** is to compute the global optimal value by decomposing the problem into overlapping subproblems.

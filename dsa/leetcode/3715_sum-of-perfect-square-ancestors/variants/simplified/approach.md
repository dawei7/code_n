# Simplified Approach - Sum of Perfect Square Ancestors
...
## Complexity detail
- **Time Complexity**: $O(M log log M + n)$ — Each input element is processed in a bounded number of direct operations.

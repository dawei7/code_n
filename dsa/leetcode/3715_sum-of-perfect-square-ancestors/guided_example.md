# Guided Example: Sum of Perfect Square Ancestors

We trace the hierarchical Array, Hash Table, Math, Tree, Depth-First Search, Counting, Number Theory traversal and subtree aggregation on a representative binary tree.
...
The objective for **Sum of Perfect Square Ancestors** is to evaluate tree properties by visiting nodes in topological hierarchy (post-order, pre-order, or level-order).

...
<ul>
	<li>If `capacity` or fewer passengers are waiting for a bus, they will **all** get on the bus, or</li>
	<li>The `capacity` passengers with the **earliest** arrival times will get on the bus.</li>
</ul>

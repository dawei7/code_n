## General
The optimal solution implements an idiomatic, readable, and production-ready approach for **Apples & Oranges**.
...
## Complexity detail
- **Time Complexity**: $O(R + Dlog D)$ — Operational efficiency across problem constraints.

...
We execute the single-pass Hash Table, Linked List, Design, Doubly-Linked List pointer manipulation on a representative linked list instance.

- **Input:** `{"operations": ["AuthenticationManager", "renew", "generate", "countUnexpiredTokens", "generate", "renew", "renew", "countUnexpiredTokens"], "arguments": [[5], ["aaa", 1], ["aaa", 2], [6], ["bbb", 7], ["aaa", 8], ["bbb", 10], [15]]}`
...
The objective for **Design Authentication Manager** is to transform the linked structure by strictly updating `next` references in place.

## General
The optimal solution implements an idiomatic, readable, and production-ready approach for **Most Common Course Pairs**.
...
## Complexity detail
- **Time Complexity**: $O(R log R + P log P)$ — Operational efficiency across problem constraints.

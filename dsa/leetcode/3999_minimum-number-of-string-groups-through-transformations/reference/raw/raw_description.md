...
Define a **transformation** on a string `s` as follows:
	...
	- Let `E` be the <span data-keyword="subsequence-string">subsequence</span> of characters at even indices of `s`.
...
**Input:** <span class="example-io">words = ["ntgwz","zwntg"]</span>
...
<div class="example-block">
**Input:** <span class="example-io">words = ["abc","cab","bac","acb","bca","cba"]</span>
...
<div class="example-block">
**Input:** <span class="example-io">words = ["leet","abb","bab","deed","edde","code","bba"]</span>

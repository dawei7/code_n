## General
**Competitive Approach — Minimum Number of String Groups Through Transformations**
...
Sourced from `kamyu104/LeetCode-Solutions`. This implementation focuses on raw computational throughput in method `minimumGroups`. It minimizes object instantiation overhead, avoids redundant memory passes, and leverages compact iteration loops.

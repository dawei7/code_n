# Simplified Approach - Count Mentions Per User
...
## Complexity detail
- **Time Complexity**: $O(E log E + E log U + M + U)$ — Each input element is processed in a bounded number of direct operations.
- **Space Complexity**: $O(E + U)$ — Utilizes standard auxiliary storage proportional to the active computation state.

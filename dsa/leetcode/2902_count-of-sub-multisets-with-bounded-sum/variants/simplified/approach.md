# Simplified Approach - Count of Sub-Multisets With Bounded Sum
...
## Complexity detail
- **Time Complexity**: $O(n + Dr)$ — Each input element is processed in a bounded number of direct operations.

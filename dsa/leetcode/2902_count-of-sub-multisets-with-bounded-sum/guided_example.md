# Guided Example: Count of Sub-Multisets With Bounded Sum

We trace the dynamic Array, Hash Table, Dynamic Programming, Sliding Window sliding window on a representative input instance.
...
The objective for **Count of Sub-Multisets With Bounded Sum** is to find the optimal contiguous window without evaluating all $O(N^2)$ candidate subarrays.

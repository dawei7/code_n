# Guided Example: Longest ZigZag Path in a Binary Tree

We trace the hierarchical Dynamic Programming, Tree, Depth-First Search, Binary Tree traversal and subtree aggregation on a representative binary tree.

- **Input:** `{"root": [1, 1, null, null, 1, 1, null, null, 1]}`
- **Required output:** `4`
...
The objective for **Longest ZigZag Path in a Binary Tree** is to evaluate tree properties by visiting nodes in topological hierarchy (post-order, pre-order, or level-order).

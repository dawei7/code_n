# Simplified Approach - Get Watched Videos by Your Friends
...
## Complexity detail
- **Time Complexity**: $O(n+E+S+Vlog V)$ — Each input element is processed in a bounded number of direct operations.
- **Space Complexity**: $O(n+V)$ — Utilizes standard auxiliary storage proportional to the active computation state.

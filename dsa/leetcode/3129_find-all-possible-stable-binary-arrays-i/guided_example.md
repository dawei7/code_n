# Guided Example: Find All Possible Stable Binary Arrays I
...
The objective for **Find All Possible Stable Binary Arrays I** is to compute the global optimal value by decomposing the problem into overlapping subproblems.

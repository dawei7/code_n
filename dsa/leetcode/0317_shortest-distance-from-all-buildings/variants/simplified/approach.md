# Simplified Approach - Shortest Distance from All Buildings
...
## Complexity detail
- **Time Complexity**: $O(bmn)$ — Each input element is processed in a bounded number of direct operations.

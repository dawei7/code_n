# Guided Example: Shortest Subarray With OR at Least K I
...
The objective for **Shortest Subarray With OR at Least K I** is to find the optimal contiguous window without evaluating all $O(N^2)$ candidate subarrays.

# Guided Example: Maximum Product of Two Integers With No Common Bits

We derive and execute the Array, Dynamic Programming, Bit Manipulation recurrence on a representative problem instance.
...
The objective for **Maximum Product of Two Integers With No Common Bits** is to compute the global optimal value by decomposing the problem into overlapping subproblems.

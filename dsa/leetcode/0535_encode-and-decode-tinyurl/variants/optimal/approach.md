## General
**Optimal Approach — Encode and Decode TinyURL**

The solution implements an direct algorithm tailored for Encode and Decode TinyURL. It utilizes Hash Map / Dictionary for $O(1)$ average lookup and frequency tracking to maintain optimal runtime bounds.

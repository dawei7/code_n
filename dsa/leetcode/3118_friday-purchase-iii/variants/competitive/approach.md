...
## Complexity detail
- **Time Complexity**: $O(u + p)$ — Operation count proportional to input scale.
- **Space Complexity**: $O(u + p)$ — Auxiliary memory allocation bound.

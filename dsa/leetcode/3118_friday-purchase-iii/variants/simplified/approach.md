# Simplified Approach - Friday Purchase III 
...
## Complexity detail
- **Time Complexity**: $O(u + p)$ — Each input element is processed in a bounded number of direct operations.
- **Space Complexity**: $O(u + p)$ — Utilizes standard auxiliary storage proportional to the active computation state.

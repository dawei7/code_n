# Guided Example: Sliding Subarray Beauty
...
The objective for **Sliding Subarray Beauty** is to find the optimal contiguous window without evaluating all $O(N^2)$ candidate subarrays.

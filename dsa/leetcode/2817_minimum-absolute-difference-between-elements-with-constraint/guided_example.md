# Guided Example: Minimum Absolute Difference Between Elements With Constraint

We trace the logarithmic Array, Binary Search, Ordered Set search on a representative problem instance.
...
The objective for **Minimum Absolute Difference Between Elements With Constraint** is to pinpoint the target value or optimal threshold in logarithmic $O(\log N)$ time.

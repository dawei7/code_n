...
We trace the hierarchical Tree, Binary Search Tree, Recursion, Binary Tree traversal and subtree aggregation on a representative binary tree.

- **Input:** `{"root": [4, 2, 6, 1, 3, 5, 7], "target": 2}`
- **Required output:** `[[2, 1], [4, 3, 6, null, null, 5, 7]]`
...
The objective for **Split BST** is to evaluate tree properties by visiting nodes in topological hierarchy (post-order, pre-order, or level-order).

# Simplified Approach - Find Maximum Value in a Constrained Sequence
...
## Complexity detail
- **Time Complexity**: $O(N + R)$ — Each input element is processed in a bounded number of direct operations.

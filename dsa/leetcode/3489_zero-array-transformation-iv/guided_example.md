# Guided Example: Zero Array Transformation IV
...
The objective for **Zero Array Transformation IV** is to compute the global optimal value by decomposing the problem into overlapping subproblems.

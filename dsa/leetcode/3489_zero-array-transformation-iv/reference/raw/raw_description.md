...
Each `queries[i]` represents the following action on `nums`:
	...
	- Select a <span data-keyword="subset">subset</span> of indices in the range `[l_i, r_i]` from `nums`.
...
<div class="example-block">
**Input:** <span class="example-io">nums = [1,2,3,2,1], queries = [[0,1,1],[1,2,1],[2,3,2],[3,4,1],[4,4,1]]</span>
...
**Explanation:**
	...
	- **For query 0 (l = 0, r = 1, val = 1):**
		...
		<li>Decrement the values at indices `[0, 1]` by `<font face="monospace">1</font>`.
...
<div class="example-block">
**Input:** <span class="example-io">nums = [1,2,3,2,6], queries = [[0,1,1],[0,2,1],[1,4,2],[4,4,4],[3,4,1],[4,4,5]]</span>

# Simplified Approach - Sum of Squares of Special Elements 
...
## Complexity detail
- **Time Complexity**: $O(\sqrt{n})$ — Each input element is processed in a bounded number of direct operations.

# Guided Example: Sum of Weighted Modes in Subarrays

We trace the dynamic Array, Hash Table, Sliding Window, Counting, Ordered Set sliding window on a representative input instance.
...
The objective for **Sum of Weighted Modes in Subarrays** is to find the optimal contiguous window without evaluating all $O(N^2)$ candidate subarrays.

# Guided Example: Best Time to Buy and Sell Stock V
...
The objective for **Best Time to Buy and Sell Stock V** is to compute the global optimal value by decomposing the problem into overlapping subproblems.

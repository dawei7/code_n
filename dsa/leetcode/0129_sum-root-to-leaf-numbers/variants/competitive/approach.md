## General
**Competitive Approach — Sum Root to Leaf Numbers**

The solution implements an direct algorithm tailored for Sum Root to Leaf Numbers. It utilizes Binary Tree node traversal (`val`, `left`, `right`) to maintain optimal runtime bounds.

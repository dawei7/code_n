...
that by **circular** street, we mean if you number the houses from `1` to `n`, then the right house of $\text{house}_{i}$ is $\text{house}_{i}+1$ for `i < n`, and the right house of $\text{house}_{n}$ is $\text{house}_{1}$.

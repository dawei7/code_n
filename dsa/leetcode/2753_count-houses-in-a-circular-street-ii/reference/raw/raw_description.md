...
**Note** that by **circular** street, we mean if you number the houses from `1` to `n`, then the right house of `house_i` is `house_i+1` for `i < n`, and the right house of `house_n` is `house_1`.

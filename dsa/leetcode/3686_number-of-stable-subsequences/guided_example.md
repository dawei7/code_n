# Guided Example: Number of Stable Subsequences
...
The objective for **Number of Stable Subsequences** is to compute the global optimal value by decomposing the problem into overlapping subproblems.

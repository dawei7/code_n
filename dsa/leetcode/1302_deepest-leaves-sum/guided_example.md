# Guided Example: Deepest Leaves Sum
...
The objective for **Deepest Leaves Sum** is to evaluate tree properties by visiting nodes in topological hierarchy (post-order, pre-order, or level-order).

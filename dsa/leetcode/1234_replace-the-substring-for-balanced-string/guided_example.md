# Guided Example: Replace the Substring for Balanced String
...
The objective for **Replace the Substring for Balanced String** is to find the optimal contiguous window without evaluating all $O(N^2)$ candidate subarrays.

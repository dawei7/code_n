...
- **Required output:** `[[1, null], null, [4, 3], [7, 0]]`
...
The objective for **Clone Binary Tree With Random Pointer** is to evaluate tree properties by visiting nodes in topological hierarchy (post-order, pre-order, or level-order).

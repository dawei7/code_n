# Guided Example: Find the Longest Equal Subarray
...
The objective for **Find the Longest Equal Subarray** is to find the optimal contiguous window without evaluating all $O(N^2)$ candidate subarrays.

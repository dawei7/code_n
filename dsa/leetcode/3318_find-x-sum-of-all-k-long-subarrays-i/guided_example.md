# Guided Example: Find X-Sum of All K-Long Subarrays I
...
The objective for **Find X-Sum of All K-Long Subarrays I** is to find the optimal contiguous window without evaluating all $O(N^2)$ candidate subarrays.

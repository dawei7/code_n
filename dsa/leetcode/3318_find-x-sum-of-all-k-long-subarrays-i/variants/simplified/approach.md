# Simplified Approach - Find X-Sum of All K-Long Subarrays I
...
## Complexity detail
- **Time Complexity**: $O((n - k + 1) k log k)$ — Each input element is processed in a bounded number of direct operations.

# Simplified Approach - Find COVID Recovery Patients
...
## Complexity detail
- **Time Complexity**: $O(T log T + P log P)$ — Each input element is processed in a bounded number of direct operations.
- **Space Complexity**: $O(T + P)$ — Utilizes standard auxiliary storage proportional to the active computation state.

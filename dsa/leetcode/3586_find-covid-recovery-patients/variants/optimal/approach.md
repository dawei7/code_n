## General
The optimal solution implements an idiomatic, readable, and production-ready approach for **Find COVID Recovery Patients**.
...
## Complexity detail
- **Time Complexity**: $O(T log T + P log P)$ — Operational efficiency across problem constraints.

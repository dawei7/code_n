# Guided Example: Find the Median of the Uniqueness Array

We trace the dynamic Array, Hash Table, Binary Search, Sliding Window sliding window on a representative input instance.
...
The objective for **Find the Median of the Uniqueness Array** is to find the optimal contiguous window without evaluating all $O(N^2)$ candidate subarrays.

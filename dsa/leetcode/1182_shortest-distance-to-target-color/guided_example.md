# Guided Example: Shortest Distance to Target Color

We trace the logarithmic Array, Binary Search, Dynamic Programming search on a representative problem instance.

- **Input:** `{"colors": [1, 1, 2, 1, 3, 2, 2, 3, 3], "queries": [[1, 3], [2, 2], [6, 1]]}`
- **Required output:** `[3, 0, 3]`
...
The objective for **Shortest Distance to Target Color** is to pinpoint the target value or optimal threshold in logarithmic $O(\log N)$ time.

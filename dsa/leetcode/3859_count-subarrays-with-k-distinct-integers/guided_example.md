# Guided Example: Count Subarrays With K Distinct Integers

We trace the dynamic Array, Hash Table, Sliding Window, Counting sliding window on a representative input instance.
...
The objective for **Count Subarrays With K Distinct Integers** is to find the optimal contiguous window without evaluating all $O(N^2)$ candidate subarrays.

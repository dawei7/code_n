# Guided Example: Maximum Number of Subsequences After One Inserting

We derive and execute the String, Dynamic Programming, Greedy, Prefix Sum recurrence on a representative problem instance.
...
The objective for **Maximum Number of Subsequences After One Inserting** is to compute the global optimal value by decomposing the problem into overlapping subproblems.

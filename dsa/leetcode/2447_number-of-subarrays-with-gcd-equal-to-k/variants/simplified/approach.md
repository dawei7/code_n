# Simplified Approach - Number of Subarrays With GCD Equal to K
...
## Complexity detail
- **Time Complexity**: $O(n log^2 V)$ — Each input element is processed in a bounded number of direct operations.

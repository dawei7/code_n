...
**Input:** <span class="example-io">sx = 1, sy = 2, tx = 5, ty = 4</span>
...
<div class="example-block">
**Input:** <span class="example-io">sx = 0, sy = 1, tx = 2, ty = 3</span>
...
<div class="example-block">
**Input:** <span class="example-io">sx = 1, sy = 1, tx = 2, ty = 2</span>

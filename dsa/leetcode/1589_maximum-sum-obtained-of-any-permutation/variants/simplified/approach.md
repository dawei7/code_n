# Simplified Approach - Maximum Sum Obtained of Any Permutation
...
## Complexity detail
- **Time Complexity**: $O(N\log N+R)$ — Each input element is processed in a bounded number of direct operations.

# Simplified Approach - Remove Sub-Folders from the Filesystem
...
## Complexity detail
- **Time Complexity**: $O(nL\log n)$ — Each input element is processed in a bounded number of direct operations.

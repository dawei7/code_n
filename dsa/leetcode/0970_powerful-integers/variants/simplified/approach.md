# Simplified Approach - Powerful Integers
...
## Complexity detail
- **Time Complexity**: $O(AB)$ — Each input element is processed in a bounded number of direct operations.
- **Space Complexity**: $O(A+B+R)$ — Utilizes standard auxiliary storage proportional to the active computation state.

# Guided Example: Longest Semi-Repeating Subarray
...
The objective for **Longest Semi-Repeating Subarray** is to find the optimal contiguous window without evaluating all $O(N^2)$ candidate subarrays.

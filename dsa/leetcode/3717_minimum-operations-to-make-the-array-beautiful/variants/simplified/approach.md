# Simplified Approach - Minimum Operations to Make the Array Beautiful
...
## Complexity detail
- **Time Complexity**: $O(n V log V)$ — Each input element is processed in a bounded number of direct operations.

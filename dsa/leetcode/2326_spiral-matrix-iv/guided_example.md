...
We execute the single-pass Array, Linked List, Matrix, Simulation pointer manipulation on a representative linked list instance.

- **Input:** `{"m": 3, "n": 5, "head": [3, 0, 2, 6, 8, 1, 7, 9, 4, 2, 5, 5, 0]}`
- **Required output:** `[[3, 0, 2, 6, 8], [5, 0, -1, -1, 1], [5, 2, 4, 9, 7]]`
...
The objective for **Spiral Matrix IV** is to transform the linked structure by strictly updating `next` references in place.

...
This doesn't work if one, or both, of the `dividend` or `divisor` are negative—the dividend will head *away* from zero! Trying to generalise this code to handle all four of the possible sign combinations is problematic, because some are repeated addition instead of subtraction, and some have a $\le 0$ continuation case instead of $\ge 0$.
...
The looping condition is $while (dividend - divisor \le 0)$ because the difference is moving towards zero from the *negative* side. Therefore, we want to continue while it is still under it. Once it goes over, we know we're done.
...
![Slide 1](images/slideshow_29_animation_1_Slide1.PNG)

![Slide 2](images/slideshow_29_animation_1_Slide2.PNG)

![Slide 3](images/slideshow_29_animation_1_Slide3.PNG)

![Slide 4](images/slideshow_29_animation_1_Slide4.PNG)

![Slide 5](images/slideshow_29_animation_1_Slide5.PNG)

![Slide 6](images/slideshow_29_animation_1_Slide6.PNG)

![Slide 7](images/slideshow_29_animation_1_Slide7.PNG)

![Slide 8](images/slideshow_29_animation_1_Slide8.PNG)

![Slide 9](images/slideshow_29_animation_1_Slide9.PNG)

![Slide 10](images/slideshow_29_animation_1_Slide10.PNG)

![Slide 11](images/slideshow_29_animation_1_Slide11.PNG)

![Slide 12](images/slideshow_29_animation_1_Slide12.PNG)

![Slide 13](images/slideshow_29_animation_1_Slide13.PNG)

![Slide 14](images/slideshow_29_animation_1_Slide14.PNG)

![Slide 15](images/slideshow_29_animation_1_Slide15.PNG)

![Slide 16](images/slideshow_29_animation_1_Slide16.PNG)
...
![Slide 1](images/slideshow_29_animation_2_Slide1.PNG)

![Slide 2](images/slideshow_29_animation_2_Slide2.PNG)

![Slide 3](images/slideshow_29_animation_2_Slide3.PNG)

![Slide 4](images/slideshow_29_animation_2_Slide4.PNG)

![Slide 5](images/slideshow_29_animation_2_Slide5.PNG)

![Slide 6](images/slideshow_29_animation_2_Slide6.PNG)

![Slide 7](images/slideshow_29_animation_2_Slide7.PNG)

![Slide 8](images/slideshow_29_animation_2_Slide8.PNG)

![Slide 9](images/slideshow_29_animation_2_Slide9.PNG)

![Slide 10](images/slideshow_29_animation_2_Slide10.PNG)

![Slide 11](images/slideshow_29_animation_2_Slide11.PNG)

![Slide 12](images/slideshow_29_animation_2_Slide12.PNG)

![Slide 13](images/slideshow_29_animation_2_Slide13.PNG)

![Slide 14](images/slideshow_29_animation_2_Slide14.PNG)

![Slide 15](images/slideshow_29_animation_2_Slide15.PNG)

![Slide 16](images/slideshow_29_animation_2_Slide16.PNG)

![Slide 17](images/slideshow_29_animation_2_Slide17.PNG)

![Slide 18](images/slideshow_29_animation_2_Slide18.PNG)

![Slide 19](images/slideshow_29_animation_2_Slide19.PNG)

![Slide 20](images/slideshow_29_animation_2_Slide20.PNG)

![Slide 21](images/slideshow_29_animation_2_Slide21.PNG)

![Slide 22](images/slideshow_29_animation_2_Slide22.PNG)

![Slide 23](images/slideshow_29_animation_2_Slide23.PNG)

![Slide 24](images/slideshow_29_animation_2_Slide24.PNG)

![Slide 25](images/slideshow_29_animation_2_Slide25.PNG)

![Slide 26](images/slideshow_29_animation_2_Slide26.PNG)

![Slide 27](images/slideshow_29_animation_2_Slide27.PNG)

![Slide 28](images/slideshow_29_animation_2_Slide28.PNG)

![Slide 29](images/slideshow_29_animation_2_Slide29.PNG)

![Slide 30](images/slideshow_29_animation_2_Slide30.PNG)

![Slide 31](images/slideshow_29_animation_2_Slide31.PNG)
...
![Division of 872703948 by 379 where the first digit of result is unknown](images/long_division_base_10_first_digit_unknown.png)

Clearly `379` does not fit into `8`, so we put a `0` and continue to the next digit.

![Division of 872703948 by 379 where the second digit of result is unknown](images/long_division_base_10_second_digit_unknown.png)

Same thing again, `379` doesn't fit into `87`, so we put a `0` and continue to the next digit.

![Division of 872703948 by 379 where the third digit of result is unknown](images/long_division_base_10_third_digit_unknown.png)
...
![Division of 872703948 by 379 where the third digit of result is 2](images/long_division_base_10_third_digit_known.png)
...
![Division of 872703948 by 379 with first difference](images/long_division_base_10_first_difference.png)

Now we simply repeat the process again with the difference. Let's start with the first digit again.

![Division of 872703948 by 379 with first difference and showing trying to divide 379 into 1](images/long_division_base_10_first_difference_digit_1.png)
...
![Division of 872703948 by 379 with first difference and 4th result digit](images/long_division_base_10_first_difference_digit_4.png)

We continue to repeat this process. Eventually, we'll run out of digits and wind up with our final result.

![Complete long division of 872703948 by 379](images/long_division_base_10_complete.png)
...
![Slide 1](images/slideshow_29_animation_3_Slide1.PNG)

![Slide 2](images/slideshow_29_animation_3_Slide2.PNG)

![Slide 3](images/slideshow_29_animation_3_Slide3.PNG)

![Slide 4](images/slideshow_29_animation_3_Slide4.PNG)

![Slide 5](images/slideshow_29_animation_3_Slide5.PNG)

![Slide 6](images/slideshow_29_animation_3_Slide6.PNG)

![Slide 7](images/slideshow_29_animation_3_Slide7.PNG)

![Slide 8](images/slideshow_29_animation_3_Slide8.PNG)

![Slide 9](images/slideshow_29_animation_3_Slide9.PNG)

![Slide 10](images/slideshow_29_animation_3_Slide10.PNG)

![Slide 11](images/slideshow_29_animation_3_Slide11.PNG)

![Slide 12](images/slideshow_29_animation_3_Slide12.PNG)

![Slide 13](images/slideshow_29_animation_3_Slide13.PNG)

![Slide 14](images/slideshow_29_animation_3_Slide14.PNG)

![Slide 15](images/slideshow_29_animation_3_Slide15.PNG)

![Slide 16](images/slideshow_29_animation_3_Slide16.PNG)

![Slide 17](images/slideshow_29_animation_3_Slide17.PNG)

![Slide 18](images/slideshow_29_animation_3_Slide18.PNG)

![Slide 19](images/slideshow_29_animation_3_Slide19.PNG)

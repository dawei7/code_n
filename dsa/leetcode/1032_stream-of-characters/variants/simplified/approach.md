# Simplified Approach - Stream of Characters
...
## Complexity detail
- **Time Complexity**: $O(S+QW)$ — Each input element is processed in a bounded number of direct operations.
- **Space Complexity**: $O(S+W)$ — Utilizes standard auxiliary storage proportional to the active computation state.

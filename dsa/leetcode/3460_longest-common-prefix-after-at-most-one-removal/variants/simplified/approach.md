# Simplified Approach - Longest Common Prefix After at Most One Removal
...
## Complexity detail
- **Time Complexity**: $O(min(n, m))$ — Each input element is processed in a bounded number of direct operations.

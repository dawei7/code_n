# Simplified Approach - Largest Component Size by Common Factor
...
## Complexity detail
- **Time Complexity**: $O(N\sqrt{M}\,\alpha(N))$ — Each input element is processed in a bounded number of direct operations.

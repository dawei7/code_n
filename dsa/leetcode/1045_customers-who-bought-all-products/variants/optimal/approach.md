## General
The optimal solution implements an idiomatic, readable, and production-ready approach for **Customers Who Bought All Products**.
...
## Complexity detail
- **Time Complexity**: $O(R log R + Q)$ — Operational efficiency across problem constraints.

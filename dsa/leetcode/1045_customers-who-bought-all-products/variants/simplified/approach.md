# Simplified Approach - Customers Who Bought All Products
...
## Complexity detail
- **Time Complexity**: $O(R log R + Q)$ — Each input element is processed in a bounded number of direct operations.
- **Space Complexity**: $O(R+Q)$ — Utilizes standard auxiliary storage proportional to the active computation state.

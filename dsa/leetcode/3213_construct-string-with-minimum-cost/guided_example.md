# Guided Example: Construct String with Minimum Cost

We derive and execute the Array, String, Dynamic Programming, Suffix Array recurrence on a representative problem instance.
...
The objective for **Construct String with Minimum Cost** is to compute the global optimal value by decomposing the problem into overlapping subproblems.

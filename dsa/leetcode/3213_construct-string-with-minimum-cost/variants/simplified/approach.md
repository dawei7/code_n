# Simplified Approach - Construct String with Minimum Cost
...
## Complexity detail
- **Time Complexity**: $O(N D + S)$ — Each input element is processed in a bounded number of direct operations.

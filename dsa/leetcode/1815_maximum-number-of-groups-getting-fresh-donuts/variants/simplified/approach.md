# Simplified Approach - Maximum Number of Groups Getting Fresh Donuts
...
## Complexity detail
- **Time Complexity**: $O(bS)$ — Each input element is processed in a bounded number of direct operations.

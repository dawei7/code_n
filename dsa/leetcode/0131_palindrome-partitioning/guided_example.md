...
We derive and execute the String, Dynamic Programming, Backtracking recurrence on a representative problem instance.
...
The objective for **Palindrome Partitioning** is to compute the global optimal value by decomposing the problem into overlapping subproblems.

...
We derive and execute the String, Dynamic Programming, Recursion recurrence on a representative problem instance.
...
The objective for **Regular Expression Matching** is to compute the global optimal value by decomposing the problem into overlapping subproblems.

# Guided Example: Minimum Removals to Balance Array
...
The objective for **Minimum Removals to Balance Array** is to find the optimal contiguous window without evaluating all $O(N^2)$ candidate subarrays.

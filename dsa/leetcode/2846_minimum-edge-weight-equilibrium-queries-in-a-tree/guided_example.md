# Guided Example: Minimum Edge Weight Equilibrium Queries in a Tree
...
The objective for **Minimum Edge Weight Equilibrium Queries in a Tree** is to evaluate tree properties by visiting nodes in topological hierarchy (post-order, pre-order, or level-order).

# Guided Example: Maximum Count of Positive Integer and Negative Integer

We trace the logarithmic Array, Binary Search, Counting search on a representative problem instance.
...
The objective for **Maximum Count of Positive Integer and Negative Integer** is to pinpoint the target value or optimal threshold in logarithmic $O(\log N)$ time.

...
We derive and execute the Math, Dynamic Programming, Backtracking, Memoization, Game Theory recurrence on a representative problem instance.
...
The objective for **Flip Game II** is to compute the global optimal value by decomposing the problem into overlapping subproblems.

# Guided Example: Find X-Sum of All K-Long Subarrays II
...
The objective for **Find X-Sum of All K-Long Subarrays II** is to find the optimal contiguous window without evaluating all $O(N^2)$ candidate subarrays.

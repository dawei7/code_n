...
The core task in **Make Lexicographically Smallest Array by Swapping Elements** is to a **0-indexed** array of **positive** integers `nums` and a **positive** integer `limit`. The algorithm processes the input using a single-pass linear iteration, maintaining state variables that update as each element is inspected to produce the result cleanly.

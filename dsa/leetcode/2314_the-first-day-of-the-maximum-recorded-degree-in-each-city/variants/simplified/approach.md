# Simplified Approach - The First Day of the Maximum Recorded Degree in Each City
...
- **Space Complexity**: $O(r)$ — Utilizes standard auxiliary storage proportional to the active computation state.

# Guided Example: Find the Number of Possible Ways for an Event
...
The objective for **Find the Number of Possible Ways for an Event** is to compute the global optimal value by decomposing the problem into overlapping subproblems.

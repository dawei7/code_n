# Simplified Approach - Minimum Time to Eat All Grains
...
## Complexity detail
- **Time Complexity**: $O(n log n + m log m + (n + m) log C)$ — Each input element is processed in a bounded number of direct operations.

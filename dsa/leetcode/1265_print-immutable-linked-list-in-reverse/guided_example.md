# Guided Example: Print Immutable Linked List in Reverse
...
- **Input:** `{"head": {"immutable_values": [1, 2, 3, 4]}}`
- **Required output:** `[4, 3, 2, 1]`
...
The objective for **Print Immutable Linked List in Reverse** is to transform the linked structure by strictly updating `next` references in place.

# Guided Example: Maximum Weighted K-Edge Path

We derive and execute the Hash Table, Dynamic Programming, Graph Theory recurrence on a representative problem instance.
...
The objective for **Maximum Weighted K-Edge Path** is to compute the global optimal value by decomposing the problem into overlapping subproblems.

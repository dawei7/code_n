# Guided Example: Count Complete Substrings
...
The objective for **Count Complete Substrings** is to find the optimal contiguous window without evaluating all $O(N^2)$ candidate subarrays.

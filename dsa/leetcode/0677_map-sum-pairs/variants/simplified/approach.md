# Simplified Approach - Map Sum Pairs
...
## Complexity detail
- **Time Complexity**: $O(IK + QP)$ — Each input element is processed in a bounded number of direct operations.
- **Space Complexity**: $O(IK)$ — Utilizes standard auxiliary storage proportional to the active computation state.

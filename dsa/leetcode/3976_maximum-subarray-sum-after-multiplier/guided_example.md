# Guided Example: Maximum Subarray Sum After Multiplier
...
The objective for **Maximum Subarray Sum After Multiplier** is to compute the global optimal value by decomposing the problem into overlapping subproblems.

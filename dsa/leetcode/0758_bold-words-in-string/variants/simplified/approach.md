# Simplified Approach - Bold Words in String
...
## Complexity detail
- **Time Complexity**: $O(p + nL)$ — Each input element is processed in a bounded number of direct operations.
- **Space Complexity**: $O(p + n)$ — Utilizes standard auxiliary storage proportional to the active computation state.

# Simplified Approach - Number of Pairs After Increment
...
## Complexity detail
- **Time Complexity**: $O(n + q sqrt(n))$ — Each input element is processed in a bounded number of direct operations.

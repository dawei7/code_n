# Guided Example: Maximum Coins From K Consecutive Bags

We trace the dynamic Array, Binary Search, Greedy, Sliding Window, Sorting, Prefix Sum sliding window on a representative input instance.
...
The objective for **Maximum Coins From K Consecutive Bags** is to find the optimal contiguous window without evaluating all $O(N^2)$ candidate subarrays.

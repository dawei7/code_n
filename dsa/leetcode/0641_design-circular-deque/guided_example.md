...
We execute the single-pass Array, Linked List, Design, Queue pointer manipulation on a representative linked list instance.

- **Input:** `{"operations": ["MyCircularDeque", "insertLast", "insertLast", "insertFront", "insertFront", "getRear", "isFull", "deleteLast", "insertFront", "getFront"], "arguments": [[3], [1], [2], [3], [4], [], [], [], [4], []]}`
- **Required output:** `[null, true, true, true, false, 2, true, true, true, 4]`
...
The objective for **Design Circular Deque** is to transform the linked structure by strictly updating `next` references in place.

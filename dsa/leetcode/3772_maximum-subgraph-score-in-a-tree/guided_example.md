# Guided Example: Maximum Subgraph Score in a Tree
...
The objective for **Maximum Subgraph Score in a Tree** is to evaluate tree properties by visiting nodes in topological hierarchy (post-order, pre-order, or level-order).

## General
The optimal solution implements an idiomatic, readable, and production-ready approach for **Status of Flight Tickets**.
...
## Complexity detail
- **Time Complexity**: $O(P log P + F)$ — Operational efficiency across problem constraints.

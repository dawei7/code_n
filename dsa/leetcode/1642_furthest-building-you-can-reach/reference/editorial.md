...
![The buildings for the example described above.](images/example_1.png)

If you solved the problem correctly, this is what you will have gotten.

![The solution for the above example.](images/example_1_solution.png)
...
![Slide 1](images/slideshow_1642_approach_1_animation_Slide1.png)

![Slide 2](images/slideshow_1642_approach_1_animation_Slide2.png)

![Slide 3](images/slideshow_1642_approach_1_animation_Slide3.png)

![Slide 4](images/slideshow_1642_approach_1_animation_Slide4.png)

![Slide 5](images/slideshow_1642_approach_1_animation_Slide5.png)

![Slide 6](images/slideshow_1642_approach_1_animation_Slide6.png)

![Slide 7](images/slideshow_1642_approach_1_animation_Slide7.png)

![Slide 8](images/slideshow_1642_approach_1_animation_Slide8.png)

![Slide 9](images/slideshow_1642_approach_1_animation_Slide9.png)

![Slide 10](images/slideshow_1642_approach_1_animation_Slide10.png)

![Slide 11](images/slideshow_1642_approach_1_animation_Slide11.png)

![Slide 12](images/slideshow_1642_approach_1_animation_Slide12.png)

![Slide 13](images/slideshow_1642_approach_1_animation_Slide13.png)

![Slide 14](images/slideshow_1642_approach_1_animation_Slide14.png)
...
![An example showing building 8 highlighted](images/example_2_building_8_highlighted.png)

How about reaching building 15? (Again, with 9 bricks and 4 ladders)

![An example showing building 15 highlighted](images/example_2_building_15_highlighted.png)
...
![An example showing reachability stretches to building 12](images/example_2_reachability.png)
...
The highest possible index for the *final-reachable-building* is $\text{heights.length} - 1$ (i.e. the last building in `heights`). In the worst case, the only building we’ll be able to reach is the building at index `0` (which we can always reach). Therefore, the answer could be anywhere from `0` to $\text{heights.length} - 1$, *inclusive* of both of these endpoints. In the binary search code, this will be:
...
- Time complexity : $O(N \log² N)$.
    ...
    On an array of length $N$, binary search requires $O(\log N)$ iterations to reduce the array down to a single item. On each of these binary search iterations, we're doing a sort. On average, we'll be sorting $N/2$ items each time. In Big O notation, though, we can simply treat this as $N$. The average cost of sorting is $O(N \log N)$. Putting this together, we get $O(\log N) \cdot$\mathcal{O}(N \\log N)$= O(N \log² N)$.
...
The code above only runs **once** for each test case. $\text{sorted}_{climbs}$ will be reused by all calls to `isReachable(...)`.

While the binary search algorithm stays the same, the implementation of `isReachable(...)` needs to be changed slightly. We no longer need to build and sort a list of climbs within it. We should, instead, use $\text{sorted}_{climbs}$ and add an additional check to skip any climbs that are beyond the index we're checking the reachability of.
...
- Time complexity : $O(N \log N)$.
    ...
    For this implementation, `isReachable(...)` simply goes down the pre-generated $\text{sorted}_{climbs}$ list and performs an $O(1)$ operation on each of the up to $N$ items. Therefore, it has a cost of $O(N)$.
    ...
    Because the creation of $\text{sorted}_{climbs}$ and the binary search happen sequentially, we *add* their time complexities. $O(N \log N) +$\mathcal{O}(N \\log N)$= 2 \dot$\mathcal{O}(N \\log N)$= O(N \log N)$.
...
![Slide 1](images/slideshow_1642_binary_search_threshold_Slide1.png)

![Slide 2](images/slideshow_1642_binary_search_threshold_Slide2.png)

![Slide 3](images/slideshow_1642_binary_search_threshold_Slide3.png)

![Slide 4](images/slideshow_1642_binary_search_threshold_Slide4.png)

![Slide 5](images/slideshow_1642_binary_search_threshold_Slide5.png)

![Slide 6](images/slideshow_1642_binary_search_threshold_Slide6.png)

![Slide 7](images/slideshow_1642_binary_search_threshold_Slide7.png)

![Slide 8](images/slideshow_1642_binary_search_threshold_Slide8.png)

![Slide 9](images/slideshow_1642_binary_search_threshold_Slide9.png)

![Slide 10](images/slideshow_1642_binary_search_threshold_Slide10.png)

![Slide 11](images/slideshow_1642_binary_search_threshold_Slide11.png)

![Slide 12](images/slideshow_1642_binary_search_threshold_Slide12.png)

![Slide 13](images/slideshow_1642_binary_search_threshold_Slide13.png)

![Slide 14](images/slideshow_1642_binary_search_threshold_Slide14.png)

![Slide 15](images/slideshow_1642_binary_search_threshold_Slide15.png)

![Slide 16](images/slideshow_1642_binary_search_threshold_Slide16.png)

![Slide 17](images/slideshow_1642_binary_search_threshold_Slide17.png)

![Slide 18](images/slideshow_1642_binary_search_threshold_Slide18.png)

![Slide 19](images/slideshow_1642_binary_search_threshold_Slide19.png)

![Slide 20](images/slideshow_1642_binary_search_threshold_Slide20.png)

![Slide 21](images/slideshow_1642_binary_search_threshold_Slide21.png)

![Slide 22](images/slideshow_1642_binary_search_threshold_Slide22.png)

![Slide 23](images/slideshow_1642_binary_search_threshold_Slide23.png)

![Slide 24](images/slideshow_1642_binary_search_threshold_Slide24.png)

![Slide 25](images/slideshow_1642_binary_search_threshold_Slide25.png)

![Slide 26](images/slideshow_1642_binary_search_threshold_Slide26.png)

![Slide 27](images/slideshow_1642_binary_search_threshold_Slide27.png)

![Slide 28](images/slideshow_1642_binary_search_threshold_Slide28.png)

![Slide 29](images/slideshow_1642_binary_search_threshold_Slide29.png)

![Slide 30](images/slideshow_1642_binary_search_threshold_Slide30.png)

![Slide 31](images/slideshow_1642_binary_search_threshold_Slide31.png)

![Slide 32](images/slideshow_1642_binary_search_threshold_Slide32.png)

![Slide 33](images/slideshow_1642_binary_search_threshold_Slide33.png)

![Slide 34](images/slideshow_1642_binary_search_threshold_Slide34.png)

![Slide 35](images/slideshow_1642_binary_search_threshold_Slide35.png)

![Slide 36](images/slideshow_1642_binary_search_threshold_Slide36.png)

![Slide 37](images/slideshow_1642_binary_search_threshold_Slide37.png)

![Slide 38](images/slideshow_1642_binary_search_threshold_Slide38.png)

![Slide 39](images/slideshow_1642_binary_search_threshold_Slide39.png)

![Slide 40](images/slideshow_1642_binary_search_threshold_Slide40.png)

![Slide 41](images/slideshow_1642_binary_search_threshold_Slide41.png)

![Slide 42](images/slideshow_1642_binary_search_threshold_Slide42.png)

![Slide 43](images/slideshow_1642_binary_search_threshold_Slide43.png)

![Slide 44](images/slideshow_1642_binary_search_threshold_Slide44.png)

![Slide 45](images/slideshow_1642_binary_search_threshold_Slide45.png)

![Slide 46](images/slideshow_1642_binary_search_threshold_Slide46.png)

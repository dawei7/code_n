# Guided Example: Collect Coins in a Tree

We trace the hierarchical Array, Tree, Graph Theory, Topological Sort traversal and subtree aggregation on a representative binary tree.
...
The objective for **Collect Coins in a Tree** is to evaluate tree properties by visiting nodes in topological hierarchy (post-order, pre-order, or level-order).

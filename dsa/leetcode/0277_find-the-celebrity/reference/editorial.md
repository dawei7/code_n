...
![Introductory example 1](images/with_celebrity.png)

What about in this graph?

![Introductory example 2](images/without_celebrity_1.png)

And this one?

![Introductory example 3](images/without_celebrity_2.png)
...
![Slide 1](images/slideshow_277_find_celebrity_experiment_Slide1.PNG)

![Slide 2](images/slideshow_277_find_celebrity_experiment_Slide2.PNG)

![Slide 3](images/slideshow_277_find_celebrity_experiment_Slide3.PNG)

![Slide 4](images/slideshow_277_find_celebrity_experiment_Slide4.PNG)

![Slide 5](images/slideshow_277_find_celebrity_experiment_Slide5.PNG)

![Slide 6](images/slideshow_277_find_celebrity_experiment_Slide6.PNG)

![Slide 7](images/slideshow_277_find_celebrity_experiment_Slide7.PNG)

![Slide 8](images/slideshow_277_find_celebrity_experiment_Slide8.PNG)

During the example in the animation, we asked if `4` knows `6`. Why was this question not necessary to identify the celebrity?

![Asking whether or not 4 knows 6.](images/redundant_question.png)
...
![A green arrow from A to B.](images/a_knows_b.png)

And what about if `A knows B` returned `false`? Who couldn't be a celebrity now?

![A red arrow from A to B](images/a_doesnt_know_b.png)
...
![Slide 1](images/slideshow_277_find_celebrity_candidate_Slide1.PNG)

![Slide 2](images/slideshow_277_find_celebrity_candidate_Slide2.PNG)

![Slide 3](images/slideshow_277_find_celebrity_candidate_Slide3.PNG)

![Slide 4](images/slideshow_277_find_celebrity_candidate_Slide4.PNG)

![Slide 5](images/slideshow_277_find_celebrity_candidate_Slide5.PNG)

![Slide 6](images/slideshow_277_find_celebrity_candidate_Slide6.PNG)

![Slide 7](images/slideshow_277_find_celebrity_candidate_Slide7.PNG)

![Slide 8](images/slideshow_277_find_celebrity_candidate_Slide8.PNG)

![Slide 9](images/slideshow_277_find_celebrity_candidate_Slide9.PNG)

![Slide 10](images/slideshow_277_find_celebrity_candidate_Slide10.PNG)

![Slide 11](images/slideshow_277_find_celebrity_candidate_Slide11.PNG)

![Slide 12](images/slideshow_277_find_celebrity_candidate_Slide12.PNG)

![Slide 13](images/slideshow_277_find_celebrity_candidate_Slide13.PNG)

![Slide 14](images/slideshow_277_find_celebrity_candidate_Slide14.PNG)

![Slide 15](images/slideshow_277_find_celebrity_candidate_Slide15.PNG)

At the end of the example in the animation, this is how our graph looked. The person who we haven't ruled out is `4`.

![Final slide of the animation, where we identified 4 as the celebrity candidate.](images/final_celebrity_candidate.png)
...
![The 14 calls made to confirm the candidate.](images/celebrity_candidate_confirm.png)
...
For Java and JavaScript, we'll store our cache in a `HashMap`. For Python, we'll use $\text{lru}_{cache}$ in the `functools` library. Other than that, the code is the same as

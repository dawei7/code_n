## General
The optimal solution implements an idiomatic, readable, and production-ready approach for **Generate the Invoice**.
...
## Complexity detail
- **Time Complexity**: $O((P+R)\log(P+R))$ — Operational efficiency across problem constraints.

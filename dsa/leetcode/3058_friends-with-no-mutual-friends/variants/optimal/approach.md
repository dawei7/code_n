## General
The optimal solution implements an idiomatic, readable, and production-ready approach for **Friends With No Mutual Friends**.
...
## Complexity detail
- **Time Complexity**: $O(m d + m log m)$ — Operational efficiency across problem constraints.

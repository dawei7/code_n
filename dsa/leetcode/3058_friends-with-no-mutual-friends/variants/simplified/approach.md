# Simplified Approach - Friends With No Mutual Friends
...
## Complexity detail
- **Time Complexity**: $O(m d + m log m)$ — Each input element is processed in a bounded number of direct operations.

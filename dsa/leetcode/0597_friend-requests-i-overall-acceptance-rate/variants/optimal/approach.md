## General
The optimal solution implements an idiomatic, readable, and production-ready approach for **Friend Requests I: Overall Acceptance Rate**.
...
## Complexity detail
- **Time Complexity**: $O((R + A) \log(R + A))$ — Operational efficiency across problem constraints.

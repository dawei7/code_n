# Guided Example: Maximum Sum BST in Binary Tree

We trace the hierarchical Dynamic Programming, Tree, Depth-First Search, Binary Search Tree, Binary Tree traversal and subtree aggregation on a representative binary tree.
...
The objective for **Maximum Sum BST in Binary Tree** is to evaluate tree properties by visiting nodes in topological hierarchy (post-order, pre-order, or level-order).

## General
**Competitive Approach — Longest Unequal Adjacent Groups Subsequence II**
...
Sourced from `kamyu104/LeetCode-Solutions`. This implementation focuses on raw computational throughput in method `getWordsInLongestSubsequence`. It minimizes object instantiation overhead, avoids redundant memory passes, and leverages compact iteration loops.

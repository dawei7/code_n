# Guided Example: Longest Unequal Adjacent Groups Subsequence II

We derive and execute the Array, String, Dynamic Programming recurrence on a representative problem instance.

- **Input:** `{"words": ["bab", "dab", "cab"], "groups": [1, 2, 2]}`
- **Required output:** `["bab", "dab"]`
...
The objective for **Longest Unequal Adjacent Groups Subsequence II** is to compute the global optimal value by decomposing the problem into overlapping subproblems.

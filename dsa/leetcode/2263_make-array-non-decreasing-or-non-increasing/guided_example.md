...
We derive and execute the Array, Dynamic Programming, Greedy, Heap (Priority Queue) recurrence on a representative problem instance.
...
The objective for **Make Array Non-decreasing or Non-increasing** is to compute the global optimal value by decomposing the problem into overlapping subproblems.

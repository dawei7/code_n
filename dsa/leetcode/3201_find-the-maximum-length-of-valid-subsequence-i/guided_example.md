# Guided Example: Find the Maximum Length of Valid Subsequence I
...
The objective for **Find the Maximum Length of Valid Subsequence I** is to compute the global optimal value by decomposing the problem into overlapping subproblems.

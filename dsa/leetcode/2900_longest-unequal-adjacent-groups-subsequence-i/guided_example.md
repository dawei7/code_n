# Guided Example: Longest Unequal Adjacent Groups Subsequence I

We derive and execute the Array, String, Dynamic Programming, Greedy recurrence on a representative problem instance.
...
The objective for **Longest Unequal Adjacent Groups Subsequence I** is to compute the global optimal value by decomposing the problem into overlapping subproblems.

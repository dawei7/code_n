# Guided Example: Total Characters in String After Transformations II

We derive and execute the Hash Table, Math, String, Dynamic Programming, Counting recurrence on a representative problem instance.
...
The objective for **Total Characters in String After Transformations II** is to compute the global optimal value by decomposing the problem into overlapping subproblems.

...
We derive and execute the Dynamic Programming, Greedy, Bit Manipulation, Memoization recurrence on a representative problem instance.
...
The objective for **Integer Replacement** is to compute the global optimal value by decomposing the problem into overlapping subproblems.

...
**Input:** <span class="example-io">eventTime = 5, k = 1, startTime = [1,3], endTime = [2,5]</span>
...
<div class="example-block">
**Input:** <span class="example-io">eventTime = 10, k = 1, startTime = [0,2,9], endTime = [1,4,10]</span>

**Output:** <span class="example-io">6</span>

**Explanation:**

![](images/example1_rescheduled.png)
...
<div class="example-block">
**Input:** <span class="example-io">eventTime = 5, k = 2, startTime = [0,1,2,3,4], endTime = [1,2,3,4,5]</span>

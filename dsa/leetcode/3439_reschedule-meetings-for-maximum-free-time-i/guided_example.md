# Guided Example: Reschedule Meetings for Maximum Free Time I

We trace the dynamic Array, Greedy, Sliding Window sliding window on a representative input instance.
...
The objective for **Reschedule Meetings for Maximum Free Time I** is to find the optimal contiguous window without evaluating all $O(N^2)$ candidate subarrays.

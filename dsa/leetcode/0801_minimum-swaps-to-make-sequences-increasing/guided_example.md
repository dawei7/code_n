...
The objective for **Minimum Swaps To Make Sequences Increasing** is to compute the global optimal value by decomposing the problem into overlapping subproblems.

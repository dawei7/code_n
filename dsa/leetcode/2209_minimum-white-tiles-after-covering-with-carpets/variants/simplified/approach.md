# Simplified Approach - Minimum White Tiles After Covering With Carpets
...
## Complexity detail
- **Time Complexity**: $O(cn)$ — Each input element is processed in a bounded number of direct operations.

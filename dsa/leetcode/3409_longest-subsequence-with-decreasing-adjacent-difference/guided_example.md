# Guided Example: Longest Subsequence With Decreasing Adjacent Difference
...
The objective for **Longest Subsequence With Decreasing Adjacent Difference** is to compute the global optimal value by decomposing the problem into overlapping subproblems.

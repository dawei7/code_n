# Guided Example: Maximum Frequency of an Element After Performing Operations I
...
The objective for **Maximum Frequency of an Element After Performing Operations I** is to find the optimal contiguous window without evaluating all $O(N^2)$ candidate subarrays.

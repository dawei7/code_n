# Guided Example: Maximum Strong Pair XOR I
...
The objective for **Maximum Strong Pair XOR I** is to find the optimal contiguous window without evaluating all $O(N^2)$ candidate subarrays.

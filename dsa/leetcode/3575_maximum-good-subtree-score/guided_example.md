# Guided Example: Maximum Good Subtree Score

We trace the hierarchical Array, Dynamic Programming, Bit Manipulation, Tree, Depth-First Search, Bitmask traversal and subtree aggregation on a representative binary tree.
...
The objective for **Maximum Good Subtree Score** is to evaluate tree properties by visiting nodes in topological hierarchy (post-order, pre-order, or level-order).

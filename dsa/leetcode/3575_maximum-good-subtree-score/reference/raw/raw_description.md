...
**Input:** <span class="example-io">vals = [2,3], par = [-1,0]</span>
...
<div class="example-block">
**Input:** <span class="example-io">vals = [1,5,2], par = [-1,0,0]</span>
...
<div class="example-block">
**Input:** <span class="example-io">vals = [34,1,2], par = [-1,0,1]</span>
...
<div class="example-block">
**Input:** <span class="example-io">vals = [3,22,5], par = [-1,0,1]</span>

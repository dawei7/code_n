# Guided Example: Make Array Empty

We trace the logarithmic Array, Binary Search, Greedy, Binary Indexed Tree, Segment Tree, Sorting, Ordered Set search on a representative problem instance.
...
The objective for **Make Array Empty** is to pinpoint the target value or optimal threshold in logarithmic $O(\log N)$ time.

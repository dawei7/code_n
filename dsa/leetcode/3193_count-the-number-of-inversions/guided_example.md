# Guided Example: Count the Number of Inversions
...
The objective for **Count the Number of Inversions** is to compute the global optimal value by decomposing the problem into overlapping subproblems.

# Simplified Approach - Immutability Helper
...
## Complexity detail
- **Time Complexity**: $O(a + c)$ — Each input element is processed in a bounded number of direct operations.
- **Space Complexity**: $O(a + c)$ — Utilizes standard auxiliary storage proportional to the active computation state.

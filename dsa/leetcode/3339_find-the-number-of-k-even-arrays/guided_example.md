# Guided Example: Find the Number of K-Even Arrays
...
The objective for **Find the Number of K-Even Arrays** is to compute the global optimal value by decomposing the problem into overlapping subproblems.

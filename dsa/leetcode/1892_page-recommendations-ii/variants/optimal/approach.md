## General
The optimal solution implements an idiomatic, readable, and production-ready approach for **Page Recommendations II**.
...
## Complexity detail
- **Time Complexity**: $O((F+L+C)\log C)$ — Operational efficiency across problem constraints.

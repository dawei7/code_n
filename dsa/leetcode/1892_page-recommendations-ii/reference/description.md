...
You are implementing a page recommendation system for a social media website. Your system will **recommend** a page to $\text{user}_{id}$ if the page is **liked** by **at least one** friend of $\text{user}_{id}$ and is **not liked** by $\text{user}_{id}$.
...
- $\text{user}_{id}$: The ID of the user that your system is making the recommendation to.

- $\text{page}_{id}$: The ID of the page that will be recommended to $\text{user}_{id}$.

- $\text{friends}_{likes}$: The number of the friends of $\text{user}_{id}$ that like $\text{page}_{id}$.

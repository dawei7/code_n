# Guided Example: Minimum Fuel Cost to Report to the Capital
...
The objective for **Minimum Fuel Cost to Report to the Capital** is to evaluate tree properties by visiting nodes in topological hierarchy (post-order, pre-order, or level-order).

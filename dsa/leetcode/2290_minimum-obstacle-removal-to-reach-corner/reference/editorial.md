...
- Set the starting cell $\text{minObstacles}[0][0]$ to the value of $\text{grid}[0][0]$, since this is the initial position.
...
- Set the starting cell $\text{minObstacles}[0][0]$ to 0, as we start from this position.

# Guided Example: Adjacent Increasing Subarrays Detection II
...
The objective for **Adjacent Increasing Subarrays Detection II** is to pinpoint the target value or optimal threshold in logarithmic $O(\log N)$ time.

# Guided Example: Maximum Number of K-Divisible Components
...
The objective for **Maximum Number of K-Divisible Components** is to evaluate tree properties by visiting nodes in topological hierarchy (post-order, pre-order, or level-order).

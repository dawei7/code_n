# Simplified Approach - Count the Number of Square-Free Subsets
...
## Complexity detail
- **Time Complexity**: $O(n + U * 2^P)$ — Each input element is processed in a bounded number of direct operations.

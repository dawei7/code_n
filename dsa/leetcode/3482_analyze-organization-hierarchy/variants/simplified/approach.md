# Simplified Approach - Analyze Organization Hierarchy
...
## Complexity detail
- **Time Complexity**: $O(a + n log n)$ — Each input element is processed in a bounded number of direct operations.
- **Space Complexity**: $O(a + n)$ — Utilizes standard auxiliary storage proportional to the active computation state.

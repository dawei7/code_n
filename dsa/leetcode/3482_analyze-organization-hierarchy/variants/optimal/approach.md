## General
The optimal solution implements an idiomatic, readable, and production-ready approach for **Analyze Organization Hierarchy**.
...
## Complexity detail
- **Time Complexity**: $O(a + n log n)$ — Operational efficiency across problem constraints.

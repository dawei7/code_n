...
![A diagram showing that L(ee)(t(()co)d)e is a balanced string.](images/balance_example_1.png)

The string `"L(e)e(t)c)o)(d)e"` is invalid because the *balance goes negative*.

![A diagram showing that L(e)e(t)c)o)(d)e is an unbalanced string.](images/balance_example_2.png)

And the string `"L(e)e(t()c(o(d)e"` is invalid because the balance *is not 0 at the end*.

![A diagram showing that L(e)e(t()c(o(d)e is an unbalanced string.](images/balance_example_3.png)
...
![A diagram showing the balancing of L(e)e(t)c)o)(d)e.](images/balance_example_4.png)
...
![A diagram showing an attempt to balance L(e)))et((co)d(e](images/balance_example_5.png)
...
![A diagram showing a failed attempt to balance L(e)))et((co)d(e by removing invalid ) and then random (](images/balance_example_6.png)
...
![A diagram using color to show pairs in L(e)))et((co)d(e](images/balance_example_7.png)
...
![Slide 1](images/slideshow_1249_balance_example_Slide1.PNG)

![Slide 2](images/slideshow_1249_balance_example_Slide2.PNG)

![Slide 3](images/slideshow_1249_balance_example_Slide3.PNG)

![Slide 4](images/slideshow_1249_balance_example_Slide4.PNG)

![Slide 5](images/slideshow_1249_balance_example_Slide5.PNG)

![Slide 6](images/slideshow_1249_balance_example_Slide6.PNG)

![Slide 7](images/slideshow_1249_balance_example_Slide7.PNG)

![Slide 8](images/slideshow_1249_balance_example_Slide8.PNG)

![Slide 9](images/slideshow_1249_balance_example_Slide9.PNG)

![Slide 10](images/slideshow_1249_balance_example_Slide10.PNG)

![Slide 11](images/slideshow_1249_balance_example_Slide11.PNG)

![Slide 12](images/slideshow_1249_balance_example_Slide12.PNG)

![Slide 13](images/slideshow_1249_balance_example_Slide13.PNG)

![Slide 14](images/slideshow_1249_balance_example_Slide14.PNG)

![Slide 15](images/slideshow_1249_balance_example_Slide15.PNG)

![Slide 16](images/slideshow_1249_balance_example_Slide16.PNG)

![Slide 17](images/slideshow_1249_balance_example_Slide17.PNG)

![Slide 18](images/slideshow_1249_balance_example_Slide18.PNG)

![Slide 19](images/slideshow_1249_balance_example_Slide19.PNG)

![Slide 20](images/slideshow_1249_balance_example_Slide20.PNG)

![Slide 21](images/slideshow_1249_balance_example_Slide21.PNG)

![Slide 22](images/slideshow_1249_balance_example_Slide22.PNG)

![Slide 23](images/slideshow_1249_balance_example_Slide23.PNG)

![Slide 24](images/slideshow_1249_balance_example_Slide24.PNG)

![Slide 25](images/slideshow_1249_balance_example_Slide25.PNG)
...
![L(e)))et((co)d(e with the unbalanced ) crossed out. ](images/balance_example_8.png)
...
![The string L(e)et((co)d(e.](images/balance_example_9.png)
...
![The string L(e)et((co)d(e reversed to be e)d(oc))te(e)L and new balance calculations done](images/balance_example_10.png)
...
![The string e)d(oc))te(e)L with invalid ) removed to give ed(oc)te(e)L](images/balance_example_11.png)

![The string ed(oc)te(e)L reversed back to L(e)et(co)de and balances used to verify it.](images/balance_example_12.png)

# Guided Example: Number of Ways to Paint N × 3 Grid
...
The objective for **Number of Ways to Paint N × 3 Grid** is to compute the global optimal value by decomposing the problem into overlapping subproblems.

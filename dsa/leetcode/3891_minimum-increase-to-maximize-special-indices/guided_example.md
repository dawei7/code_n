# Guided Example: Minimum Increase to Maximize Special Indices

We derive and execute the Array, Dynamic Programming, Greedy, Prefix Sum recurrence on a representative problem instance.
...
The objective for **Minimum Increase to Maximize Special Indices** is to compute the global optimal value by decomposing the problem into overlapping subproblems.

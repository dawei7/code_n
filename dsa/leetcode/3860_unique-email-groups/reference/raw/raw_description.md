...
**Input:** <span class="example-io">emails = ["test.email+alex@leetcode.com", "test.e.mail+bob.cathy@leetcode.com", "testemail+david@lee.tcode.com"]</span>
...
<div class="example-block">
**Input:** <span class="example-io">emails = ["A@B.com", "a@b.com", "ab+xy@b.com", "a.b@b.com"]</span>
...
<div class="example-block">
**Input:** <span class="example-io">emails = ["a.b+c.d+e@DoMain.com", "ab+xyz@domain.com", "ab@domain.com"]</span>

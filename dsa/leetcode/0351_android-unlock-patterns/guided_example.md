...
We derive and execute the Dynamic Programming, Backtracking, Bit Manipulation, Bitmask recurrence on a representative problem instance.
...
The objective for **Android Unlock Patterns** is to compute the global optimal value by decomposing the problem into overlapping subproblems.

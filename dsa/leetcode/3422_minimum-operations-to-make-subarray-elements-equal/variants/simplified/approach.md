# Simplified Approach - Minimum Operations to Make Subarray Elements Equal
...
## Complexity detail
- **Time Complexity**: $O(n log k)$ — Each input element is processed in a bounded number of direct operations.

# Guided Example: Minimum Cost to Convert String II

We derive and execute the Array, String, Dynamic Programming, Graph Theory, Trie, Shortest Path recurrence on a representative problem instance.
...
The objective for **Minimum Cost to Convert String II** is to compute the global optimal value by decomposing the problem into overlapping subproblems.

# Guided Example: Number of Ways to Assign Edge Weights II

We trace the hierarchical Array, Math, Dynamic Programming, Bit Manipulation, Tree, Depth-First Search traversal and subtree aggregation on a representative binary tree.
...
The objective for **Number of Ways to Assign Edge Weights II** is to evaluate tree properties by visiting nodes in topological hierarchy (post-order, pre-order, or level-order).

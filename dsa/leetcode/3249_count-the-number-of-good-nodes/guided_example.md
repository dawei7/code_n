# Guided Example: Count the Number of Good Nodes
...
The objective for **Count the Number of Good Nodes** is to evaluate tree properties by visiting nodes in topological hierarchy (post-order, pre-order, or level-order).

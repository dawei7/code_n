...
We can make use of a 1-D $dp$ with number of elements equal to $n$. $\text{dp}[i]$ is used to store the number of arithmetic slices possible in the range $(k,i)$ and not in any range $(k,j)$ such that $j<i$. Again, $k$ refers to the minimum index possible such that $(k,j)$ constitutes a valid Arithmetic Slice.
...
![Slide 1](images/slideshow_413_Arithmetic_Slices_413_Arithmetic_SlicesSlide1.PNG)

![Slide 2](images/slideshow_413_Arithmetic_Slices_413_Arithmetic_SlicesSlide2.PNG)

![Slide 3](images/slideshow_413_Arithmetic_Slices_413_Arithmetic_SlicesSlide3.PNG)

![Slide 4](images/slideshow_413_Arithmetic_Slices_413_Arithmetic_SlicesSlide4.PNG)

![Slide 5](images/slideshow_413_Arithmetic_Slices_413_Arithmetic_SlicesSlide5.PNG)

![Slide 6](images/slideshow_413_Arithmetic_Slices_413_Arithmetic_SlicesSlide6.PNG)

![Slide 7](images/slideshow_413_Arithmetic_Slices_413_Arithmetic_SlicesSlide7.PNG)

![Slide 8](images/slideshow_413_Arithmetic_Slices_413_Arithmetic_SlicesSlide8.PNG)

![Slide 9](images/slideshow_413_Arithmetic_Slices_413_Arithmetic_SlicesSlide9.PNG)
...
In the last approach, we can observe that we only require the element $dp[i-1]$ to determine the value to be entered at $\text{dp}[i]$. Thus, instead of making use of a 1-D array to store the required data, we can simply keep a track of just the last element.

# Simplified Approach - Maximum Total Reward Using Operations II
...
## Complexity detail
- **Time Complexity**: $O(n log n + nV / w)$ — Each input element is processed in a bounded number of direct operations.
- **Space Complexity**: $O(n + V / w)$ — Utilizes standard auxiliary storage proportional to the active computation state.

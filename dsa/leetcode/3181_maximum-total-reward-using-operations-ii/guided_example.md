# Guided Example: Maximum Total Reward Using Operations II

We derive and execute the Array, Dynamic Programming, Bit Manipulation, Sorting recurrence on a representative problem instance.
...
The objective for **Maximum Total Reward Using Operations II** is to compute the global optimal value by decomposing the problem into overlapping subproblems.

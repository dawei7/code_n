...
We derive and execute the Array, Math, Dynamic Programming, Probability and Statistics recurrence on a representative problem instance.
...
The objective for **Toss Strange Coins** is to compute the global optimal value by decomposing the problem into overlapping subproblems.

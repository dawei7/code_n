# Simplified Approach - Substring with Concatenation of All Words
...
## Complexity detail
- **Time Complexity**: $O(n \cdot L)$ — Each input element is processed in a bounded number of direct operations.

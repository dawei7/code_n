# Guided Example: Sorting Three Groups
...
The objective for **Sorting Three Groups** is to pinpoint the target value or optimal threshold in logarithmic $O(\log N)$ time.

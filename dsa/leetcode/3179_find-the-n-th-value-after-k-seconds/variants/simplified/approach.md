# Simplified Approach - Find the N-th Value After K Seconds
...
## Complexity detail
- **Time Complexity**: $O(min(n, k) + log M)$ — Each input element is processed in a bounded number of direct operations.

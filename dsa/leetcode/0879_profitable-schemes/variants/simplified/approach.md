# Simplified Approach - Profitable Schemes
...
## Complexity detail
- **Time Complexity**: $O(mn(P+1))$ — Each input element is processed in a bounded number of direct operations.
- **Space Complexity**: $O(n(P+1))$ — Utilizes standard auxiliary storage proportional to the active computation state.

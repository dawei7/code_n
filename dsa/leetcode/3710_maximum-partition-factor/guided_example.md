# Guided Example: Maximum Partition Factor

We trace the logarithmic Array, Binary Search, Depth-First Search, Breadth-First Search, Union-Find, Graph Theory search on a representative problem instance.
...
The objective for **Maximum Partition Factor** is to pinpoint the target value or optimal threshold in logarithmic $O(\log N)$ time.

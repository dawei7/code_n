...
We derive and execute the Array, String, Dynamic Programming, Bit Manipulation, Bitmask recurrence on a representative problem instance.

- **Input:** `{"words": ["alex", "loves", "leetcode"]}`
- **Required output:** `"alexlovesleetcode"`
...
The objective for **Find the Shortest Superstring** is to compute the global optimal value by decomposing the problem into overlapping subproblems.

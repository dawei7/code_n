...
- If `p` is not at the end of the string, move the pointer $p_{end}$ along the string to find the end of the chunk.

- Return the chunk $\text{version.substring}(p, p_{end})$.

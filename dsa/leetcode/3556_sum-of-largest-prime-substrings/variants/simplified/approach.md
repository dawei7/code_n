# Simplified Approach - Sum of Largest Prime Substrings
...
## Complexity detail
- **Time Complexity**: $O(n^2 sqrt(M))$ — Each input element is processed in a bounded number of direct operations.

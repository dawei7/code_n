...
To Write a function `expect` that helps developers test their code. It should take in any value `val` and return an object with the following two functions, the JavaScript solution uses clean ES6+ techniques.

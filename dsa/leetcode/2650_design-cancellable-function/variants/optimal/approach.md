## General
The optimal solution implements an idiomatic, readable, and production-ready approach for **Design Cancellable Function**.
...
## Complexity detail
- **Time Complexity**: $O(y)$ — Operational efficiency across problem constraints.

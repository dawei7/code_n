...
![lexico_tree](images/lexico_tree.png)
...
- Generate numbers from 1 to `n`:
  ...
  - If multiplying `currentNumber` by 10 is less than or equal to `n` (i.e., $currentNumber * 10 \le n$), multiply `currentNumber` by 10 to move to the next lexicographical number (i.e., go deeper into the tree of numbers).

...
| LeetCode | [Maximum Value of an Ordered Triplet I](https://leetcode.com/problems/maximum-value-of-an-ordered-triplet-i/) |
...
Let $n = \lvert\texttt{nums}\rvert$. The constraints are $3 \le n \le 100$ and $1 \le \texttt{nums[i]} \le 10^6$.

# Guided Example: Find the Last Marked Nodes in Tree

We trace the hierarchical Tree, Depth-First Search traversal and subtree aggregation on a representative binary tree.

- **Input:** `{"edges": [[0, 1], [0, 2]]}`
- **Required output:** `[2, 2, 1]`
...
The objective for **Find the Last Marked Nodes in Tree** is to evaluate tree properties by visiting nodes in topological hierarchy (post-order, pre-order, or level-order).

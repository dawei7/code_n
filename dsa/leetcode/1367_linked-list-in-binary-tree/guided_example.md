# Guided Example: Linked List in Binary Tree

We execute the single-pass Linked List, Tree, Depth-First Search, Binary Tree pointer manipulation on a representative linked list instance.
...
The objective for **Linked List in Binary Tree** is to transform the linked structure by strictly updating `next` references in place.

# Guided Example: Maximum Number of Jumps to Reach the Last Index
...
The objective for **Maximum Number of Jumps to Reach the Last Index** is to compute the global optimal value by decomposing the problem into overlapping subproblems.

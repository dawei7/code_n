## General
**Competitive Approach — Search in a Binary Search Tree**

The solution implements an direct algorithm tailored for Search in a Binary Search Tree. It utilizes Binary Tree node traversal (`val`, `left`, `right`) to maintain optimal runtime bounds.

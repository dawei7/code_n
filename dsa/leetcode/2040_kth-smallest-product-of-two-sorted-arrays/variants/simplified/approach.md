# Simplified Approach - Kth Smallest Product of Two Sorted Arrays
...
## Complexity detail
- **Time Complexity**: $O(A\log B\log R)$ — Each input element is processed in a bounded number of direct operations.

# Guided Example: Convert Doubly Linked List to Array I
...
The objective for **Convert Doubly Linked List to Array I** is to transform the linked structure by strictly updating `next` references in place.

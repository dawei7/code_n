# Simplified Approach - Maximize the Topmost Element After K Moves
...
## Complexity detail
- **Time Complexity**: $O(min(n, k))$ — Each input element is processed in a bounded number of direct operations.

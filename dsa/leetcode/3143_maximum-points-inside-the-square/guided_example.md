# Guided Example: Maximum Points Inside the Square

We trace the logarithmic Array, Hash Table, String, Binary Search, Sorting search on a representative problem instance.
...
The objective for **Maximum Points Inside the Square** is to pinpoint the target value or optimal threshold in logarithmic $O(\log N)$ time.

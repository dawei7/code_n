...
We derive and execute the Math, Dynamic Programming, Brainteaser, Probability and Statistics recurrence on a representative problem instance.
...
The objective for **Airplane Seat Assignment Probability** is to compute the global optimal value by decomposing the problem into overlapping subproblems.

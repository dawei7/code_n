## General
**Optimal Approach — Traffic Light Controlled Intersection**

The solution implements an direct algorithm tailored for Traffic Light Controlled Intersection. It utilizes Hash Map / Dictionary for $O(1)$ average lookup and frequency tracking to maintain optimal runtime bounds.

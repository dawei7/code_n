## General
**Competitive Approach — Traffic Light Controlled Intersection**

The solution implements an direct algorithm tailored for Traffic Light Controlled Intersection.

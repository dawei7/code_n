...
The objective for **Number of Unique Flavors After Sharing K Candies** is to find the optimal contiguous window without evaluating all $O(N^2)$ candidate subarrays.

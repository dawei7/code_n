# Simplified Approach - Find Building Where Alice and Bob Can Meet
...
## Complexity detail
- **Time Complexity**: $O(N + Q log Q)$ — Each input element is processed in a bounded number of direct operations.

# Simplified Approach - Number of Subarrays With LCM Equal to K
...
## Complexity detail
- **Time Complexity**: $O(n D log k)$ — Each input element is processed in a bounded number of direct operations.

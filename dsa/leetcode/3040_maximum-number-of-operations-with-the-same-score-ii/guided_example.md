# Guided Example: Maximum Number of Operations With the Same Score II

We derive and execute the Array, Dynamic Programming, Memoization recurrence on a representative problem instance.
...
The objective for **Maximum Number of Operations With the Same Score II** is to compute the global optimal value by decomposing the problem into overlapping subproblems.

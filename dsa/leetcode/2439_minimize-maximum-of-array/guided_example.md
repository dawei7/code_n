# Guided Example: Minimize Maximum of Array

We trace the logarithmic Array, Binary Search, Dynamic Programming, Greedy, Prefix Sum search on a representative problem instance.
...
The objective for **Minimize Maximum of Array** is to pinpoint the target value or optimal threshold in logarithmic $O(\log N)$ time.

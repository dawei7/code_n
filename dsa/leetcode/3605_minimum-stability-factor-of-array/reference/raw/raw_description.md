...
**Input:** <span class="example-io">nums = [3,5,10], maxC = 1</span>
...
<div class="example-block">
**Input:** <span class="example-io">nums = [2,6,8], maxC = 2</span>
...
<div class="example-block">
**Input:** <span class="example-io">nums = [2,4,9,6], maxC = 1</span>

## General
The optimal solution implements an idiomatic, readable, and production-ready approach for **Market Analysis III**.
...
## Complexity detail
- **Time Complexity**: $O(U + I + O + W log(W))$ — Operational efficiency across problem constraints.

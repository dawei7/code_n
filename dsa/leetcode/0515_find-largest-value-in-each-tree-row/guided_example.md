...
The objective for **Find Largest Value in Each Tree Row** is to evaluate tree properties by visiting nodes in topological hierarchy (post-order, pre-order, or level-order).

...
We trace the dynamic String, Binary Search, Sliding Window, Rolling Hash, Suffix Array, Hash Function sliding window on a representative input instance.
...
The objective for **Longest Duplicate Substring** is to find the optimal contiguous window without evaluating all $O(N^2)$ candidate subarrays.

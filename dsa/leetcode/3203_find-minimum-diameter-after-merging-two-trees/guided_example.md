# Guided Example: Find Minimum Diameter After Merging Two Trees
...
The objective for **Find Minimum Diameter After Merging Two Trees** is to evaluate tree properties by visiting nodes in topological hierarchy (post-order, pre-order, or level-order).

# Simplified Approach - Process Restricted Friend Requests
...
## Complexity detail
- **Time Complexity**: $O(S^2\alpha(S))$ — Each input element is processed in a bounded number of direct operations.

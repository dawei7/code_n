# Guided Example: Maximum Weight in Two Bags
...
The objective for **Maximum Weight in Two Bags** is to compute the global optimal value by decomposing the problem into overlapping subproblems.

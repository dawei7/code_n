...
We derive and execute the Math, Dynamic Programming, Brainteaser, Game Theory recurrence on a representative problem instance.
...
The objective for **Divisor Game** is to compute the global optimal value by decomposing the problem into overlapping subproblems.

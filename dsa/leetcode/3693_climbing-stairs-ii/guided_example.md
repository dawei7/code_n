# Guided Example: Climbing Stairs II
...
The objective for **Climbing Stairs II** is to compute the global optimal value by decomposing the problem into overlapping subproblems.

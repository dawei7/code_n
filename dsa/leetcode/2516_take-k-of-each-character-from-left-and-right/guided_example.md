# Guided Example: Take K of Each Character From Left and Right
...
The objective for **Take K of Each Character From Left and Right** is to find the optimal contiguous window without evaluating all $O(N^2)$ candidate subarrays.

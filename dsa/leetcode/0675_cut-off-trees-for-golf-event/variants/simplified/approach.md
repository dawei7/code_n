# Simplified Approach - Cut Off Trees for Golf Event
...
## Complexity detail
- **Time Complexity**: $O(T \log T + TRC)$ — Each input element is processed in a bounded number of direct operations.

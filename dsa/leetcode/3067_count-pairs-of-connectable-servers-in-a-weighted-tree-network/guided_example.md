# Guided Example: Count Pairs of Connectable Servers in a Weighted Tree Network

We trace the hierarchical Array, Tree, Depth-First Search traversal and subtree aggregation on a representative binary tree.

- **Input:** `{"edges": [[0, 1, 1], [1, 2, 5], [2, 3, 13], [3, 4, 9], [4, 5, 2]], "signalSpeed": 1}`
- **Required output:** `[0, 4, 6, 6, 4, 0]`
...
The objective for **Count Pairs of Connectable Servers in a Weighted Tree Network** is to evaluate tree properties by visiting nodes in topological hierarchy (post-order, pre-order, or level-order).

...
The objective for **Longest Substring with At Most K Distinct Characters** is to find the optimal contiguous window without evaluating all $O(N^2)$ candidate subarrays.

# Guided Example: Difference Between Maximum and Minimum Price Sum
...
The objective for **Difference Between Maximum and Minimum Price Sum** is to evaluate tree properties by visiting nodes in topological hierarchy (post-order, pre-order, or level-order).

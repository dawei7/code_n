# Guided Example: Find the Original Typed String II

We derive and execute the String, Dynamic Programming, Prefix Sum recurrence on a representative problem instance.
...
The objective for **Find the Original Typed String II** is to compute the global optimal value by decomposing the problem into overlapping subproblems.

# Guided Example: Check If Two Expression Trees are Equivalent

We trace the hierarchical Hash Table, Tree, Depth-First Search, Binary Tree, Counting traversal and subtree aggregation on a representative binary tree.
...
The objective for **Check If Two Expression Trees are Equivalent** is to evaluate tree properties by visiting nodes in topological hierarchy (post-order, pre-order, or level-order).

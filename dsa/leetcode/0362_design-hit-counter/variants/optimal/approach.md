## General
**Optimal Approach — Design Hit Counter**

The solution implements an direct algorithm tailored for Design Hit Counter. It utilizes Hash Map / Dictionary for $O(1)$ average lookup and frequency tracking to maintain optimal runtime bounds.

...
- **Output:** `[3,4]`
- **Explanation:** The only integers present in each of nums[0] = [<u>**3**</u>,1,2,<u>**4**</u>,5], nums[1] = [1,2,<u>**3**</u>,<u>**4**</u>], and nums[2] = [<u>**3**</u>,<u>**4**</u>,5,6] are 3 and 4, so we return [3,4].

## General
**Optimal Approach — Design A Leaderboard**

The solution implements an direct algorithm tailored for Design A Leaderboard. It utilizes Hash Map / Dictionary for $O(1)$ average lookup and frequency tracking to maintain optimal runtime bounds.
...
## Complexity detail
- **Time Complexity**: $O(p\log K)$ — Operation count proportional to input scale.

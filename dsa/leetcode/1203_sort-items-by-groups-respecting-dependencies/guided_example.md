...
- **Required output:** `[6, 3, 4, 5, 2, 0, 7, 1]`
...
The objective is to compute the requested result for **Sort Items by Groups Respecting Dependencies** while avoiding redundant re-evaluations.

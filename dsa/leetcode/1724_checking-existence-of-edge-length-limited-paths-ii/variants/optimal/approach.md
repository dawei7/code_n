## General
**Optimal Approach — Checking Existence of Edge Length Limited Paths II**
...
## Complexity detail
- **Time Complexity**: $O(m\log m+n\log n+q\log n)$ — Operation count proportional to input scale.

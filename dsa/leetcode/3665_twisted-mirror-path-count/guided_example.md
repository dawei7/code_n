# Guided Example: Twisted Mirror Path Count
...
The objective for **Twisted Mirror Path Count** is to compute the global optimal value by decomposing the problem into overlapping subproblems.

# Guided Example: Minimum Relative Loss After Buying Chocolates
...
The objective for **Minimum Relative Loss After Buying Chocolates** is to pinpoint the target value or optimal threshold in logarithmic $O(\log N)$ time.

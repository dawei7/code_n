# Guided Example: Count The Number of Winning Sequences
...
The objective for **Count The Number of Winning Sequences** is to compute the global optimal value by decomposing the problem into overlapping subproblems.

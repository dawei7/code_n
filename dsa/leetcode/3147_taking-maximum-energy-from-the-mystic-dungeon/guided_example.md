# Guided Example: Taking Maximum Energy From the Mystic Dungeon
...
The objective for **Taking Maximum Energy From the Mystic Dungeon** is to compute the global optimal value by decomposing the problem into overlapping subproblems.

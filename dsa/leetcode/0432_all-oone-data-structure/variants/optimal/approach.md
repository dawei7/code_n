## General
**Optimal Approach — All O`one Data Structure**

The solution implements an direct algorithm tailored for All O`one Data Structure. It utilizes Hash Map / Dictionary for $O(1)$ average lookup and frequency tracking to maintain optimal runtime bounds.

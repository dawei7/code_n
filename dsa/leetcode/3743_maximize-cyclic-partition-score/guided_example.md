# Guided Example: Maximize Cyclic Partition Score
...
The objective for **Maximize Cyclic Partition Score** is to compute the global optimal value by decomposing the problem into overlapping subproblems.

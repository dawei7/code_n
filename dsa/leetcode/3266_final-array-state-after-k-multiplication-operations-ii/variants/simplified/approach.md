# Simplified Approach - Final Array State After K Multiplication Operations II
...
## Complexity detail
- **Time Complexity**: $O(n log M log n + n log k)$ — Each input element is processed in a bounded number of direct operations.

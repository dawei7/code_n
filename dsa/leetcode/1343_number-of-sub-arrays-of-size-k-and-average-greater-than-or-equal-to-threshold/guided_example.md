# Guided Example: Number of Sub-arrays of Size K and Average Greater than or Equal to Threshold

We trace the dynamic Array, Sliding Window sliding window on a representative input instance.
...
The objective for **Number of Sub-arrays of Size K and Average Greater than or Equal to Threshold** is to find the optimal contiguous window without evaluating all $O(N^2)$ candidate subarrays.

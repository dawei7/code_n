# Guided Example: Minimum Pair Removal to Sort Array II

We execute the single-pass Array, Hash Table, Linked List, Heap (Priority Queue), Simulation, Doubly-Linked List, Ordered Set pointer manipulation on a representative linked list instance.
...
The objective for **Minimum Pair Removal to Sort Array II** is to transform the linked structure by strictly updating `next` references in place.

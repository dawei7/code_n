## General
**Optimal Approach — Data Stream as Disjoint Intervals**

The solution implements an direct algorithm tailored for Data Stream as Disjoint Intervals.
...
## Complexity detail
- **Time Complexity**: $O(1) / O(k \log k)$ — Operation count proportional to input scale.

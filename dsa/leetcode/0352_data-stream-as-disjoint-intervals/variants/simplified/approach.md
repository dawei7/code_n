# Simplified Approach - Data Stream as Disjoint Intervals
...
## Complexity detail
- **Time Complexity**: $O(1) / O(k \log k)$ — Each input element is processed in a bounded number of direct operations.

# Simplified Approach - Intersection of Two Arrays II
...
- **Space Complexity**: $O(\min(n, m))$ — Utilizes standard auxiliary storage proportional to the active computation state.

# Guided Example: Tree Diameter

We trace the hierarchical Tree, Depth-First Search, Breadth-First Search, Graph Theory, Topological Sort traversal and subtree aggregation on a representative binary tree.
...
The objective for **Tree Diameter** is to evaluate tree properties by visiting nodes in topological hierarchy (post-order, pre-order, or level-order).

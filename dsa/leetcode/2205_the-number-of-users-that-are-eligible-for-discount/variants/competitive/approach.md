## General
**Competitive Approach — The Number of Users That Are Eligible for Discount**

The query executes a structured relational pipeline for **The Number of Users That Are Eligible for Discount**. It uses SQL projections and filtering predicates.
...
## Complexity detail
- **Time Complexity**: $O(r log u)$ — Operation count proportional to input scale.

## General
The optimal solution implements an idiomatic, readable, and production-ready approach for **The Number of Users That Are Eligible for Discount**.
...
## Complexity detail
- **Time Complexity**: $O(r log u)$ — Operational efficiency across problem constraints.

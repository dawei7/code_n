# Simplified Approach - The Number of Users That Are Eligible for Discount
...
## Complexity detail
- **Time Complexity**: $O(r log u)$ — Each input element is processed in a bounded number of direct operations.
- **Space Complexity**: $O(u)$ — Utilizes standard auxiliary storage proportional to the active computation state.

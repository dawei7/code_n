# Guided Example: Minimum Time to Repair Cars
...
The objective for **Minimum Time to Repair Cars** is to pinpoint the target value or optimal threshold in logarithmic $O(\log N)$ time.

...
**Input:** <span class="example-io">s = "abca", k = 3</span>
...
<div class="example-block">
**Input:** <span class="example-io">s = "aabca", k = 2</span>

**Output:** <span class="example-io">"abca"</span>
...
<div class="example-block">
**Input:** <span class="example-io">s = "yybyzybz", k = 2</span>

**Output:** <span class="example-io">"ybzybz"</span>

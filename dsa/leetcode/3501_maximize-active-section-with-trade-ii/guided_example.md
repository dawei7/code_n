# Guided Example: Maximize Active Section with Trade II

We trace the logarithmic Array, String, Binary Search, Segment Tree search on a representative problem instance.
...
The objective for **Maximize Active Section with Trade II** is to pinpoint the target value or optimal threshold in logarithmic $O(\log N)$ time.

# Guided Example: Maximum Profit from Trading Stocks with Discounts

We trace the hierarchical Array, Dynamic Programming, Tree, Depth-First Search traversal and subtree aggregation on a representative binary tree.
...
The objective for **Maximum Profit from Trading Stocks with Discounts** is to evaluate tree properties by visiting nodes in topological hierarchy (post-order, pre-order, or level-order).

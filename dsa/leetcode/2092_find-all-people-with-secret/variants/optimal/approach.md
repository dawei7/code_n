## General
**Optimal Approach — Find All People With Secret**
...
Sourced from `doocs/leetcode` (or refined to expert standard) in method `findAllPeople`. This implementation is chosen for its exceptional readability, idiomatic Python 3 constructs, and clear structural separation of concerns suitable for technical software engineering interviews.

## Complexity detail
- **Time Complexity**: $O(M \log M + n)$ — Operation count proportional to input scale.

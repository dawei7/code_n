# Simplified Approach - Number of Ways to Rearrange Sticks With K Sticks Visible
...
## Complexity detail
- **Time Complexity**: $O(nk)$ — Each input element is processed in a bounded number of direct operations.

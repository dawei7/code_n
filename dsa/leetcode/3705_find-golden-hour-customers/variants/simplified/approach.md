# Simplified Approach - Find Golden Hour Customers
...
## Complexity detail
- **Time Complexity**: $O(R log R + C log C)$ — Each input element is processed in a bounded number of direct operations.
- **Space Complexity**: $O(R + C)$ — Utilizes standard auxiliary storage proportional to the active computation state.

## General
The optimal solution implements an idiomatic, readable, and production-ready approach for **Find Golden Hour Customers**.
...
## Complexity detail
- **Time Complexity**: $O(R log R + C log C)$ — Operational efficiency across problem constraints.

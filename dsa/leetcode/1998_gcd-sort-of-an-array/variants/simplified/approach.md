# Simplified Approach - GCD Sort of an Array
...
## Complexity detail
- **Time Complexity**: $O(M\log\log M+N\log M+N\log N)$ — Each input element is processed in a bounded number of direct operations.

...
- **Required output:** `[-1, -1, -1, 5, 4, 4, -1, -1, -1]`
...
The objective for **K Radius Subarray Averages** is to find the optimal contiguous window without evaluating all $O(N^2)$ candidate subarrays.

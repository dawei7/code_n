# Simplified Approach - Maximum Points in an Archery Competition
...
## Complexity detail
- **Time Complexity**: $O(2^s s)$ — Each input element is processed in a bounded number of direct operations.

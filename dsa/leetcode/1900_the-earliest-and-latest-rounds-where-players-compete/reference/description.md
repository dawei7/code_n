...
<ul>
	<li>For example, if the row consists of players `1, 2, 4, 6, 7`

	<ul>
		<li>Player `1` competes against player `7`.</li>
		<li>Player `2` competes against player `6`.</li>
		<li>Player `4` automatically advances to the next round.</li>
	</ul>
	</li>
</ul>

# Guided Example: Sum of Mutated Array Closest to Target
...
The objective for **Sum of Mutated Array Closest to Target** is to pinpoint the target value or optimal threshold in logarithmic $O(\log N)$ time.

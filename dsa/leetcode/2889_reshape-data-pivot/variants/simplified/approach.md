# Simplified Approach - Reshape Data: Pivot
...
## Complexity detail
- **Time Complexity**: $O(r log r + cm)$ — Each input element is processed in a bounded number of direct operations.
- **Space Complexity**: $O(cm)$ — Utilizes standard auxiliary storage proportional to the active computation state.

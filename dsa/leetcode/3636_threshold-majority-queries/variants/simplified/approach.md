# Simplified Approach - Threshold Majority Queries
...
## Complexity detail
- **Time Complexity**: $O(n sqrt(n) + q sqrt(n) log n)$ — Each input element is processed in a bounded number of direct operations.

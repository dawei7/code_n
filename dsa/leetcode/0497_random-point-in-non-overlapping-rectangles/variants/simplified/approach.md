# Simplified Approach - Random Point in Non-overlapping Rectangles
...
## Complexity detail
- **Time Complexity**: $O(r + d \log r)$ — Each input element is processed in a bounded number of direct operations.
- **Space Complexity**: $O(r + d)$ — Utilizes standard auxiliary storage proportional to the active computation state.

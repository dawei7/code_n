...
<span class="example-io">["Matrix3D", "setCell", "largestMatrix", "setCell", "largestMatrix", "setCell", "largestMatrix"]

[[3], [0, 0, 0], [], [1, 1, 2], [], [0, 0, 1], []]</span>

**Output:**

<span class="example-io">[null, null, 0, null, 1, null, 0] </span>
...
matrix3D.largestMatrix(); // Returns 0. `matrix[0]` has the most number of 1's.</div>
...
<span class="example-io">["Matrix3D", "setCell", "largestMatrix", "unsetCell", "largestMatrix"]

[[4], [2, 1, 1], [], [2, 1, 1], []]</span>

**Output:**

<span class="example-io">[null, null, 2, null, 3] </span>

# Simplified Approach - Minimize Deviation in Array
...
## Complexity detail
- **Time Complexity**: $O(n\log M\log n)$ — Each input element is processed in a bounded number of direct operations.

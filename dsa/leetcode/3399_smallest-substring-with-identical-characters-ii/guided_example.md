# Guided Example: Smallest Substring With Identical Characters II

We trace the logarithmic String, Binary Search search on a representative problem instance.
...
The objective for **Smallest Substring With Identical Characters II** is to pinpoint the target value or optimal threshold in logarithmic $O(\log N)$ time.

# Guided Example: Maximum Difference Score in a Grid
...
The objective for **Maximum Difference Score in a Grid** is to compute the global optimal value by decomposing the problem into overlapping subproblems.

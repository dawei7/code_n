# Simplified Approach - Bricks Falling When Hit
...
## Complexity detail
- **Time Complexity**: $O((r \cdot c + h) \cdot \alpha(r \cdot c))$ — Each input element is processed in a bounded number of direct operations.
- **Space Complexity**: $O(r \cdot c)$ — Utilizes standard auxiliary storage proportional to the active computation state.

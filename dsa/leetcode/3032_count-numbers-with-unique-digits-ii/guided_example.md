# Guided Example: Count Numbers With Unique Digits II

We derive and execute the Hash Table, Math, Dynamic Programming recurrence on a representative problem instance.
...
The objective for **Count Numbers With Unique Digits II** is to compute the global optimal value by decomposing the problem into overlapping subproblems.

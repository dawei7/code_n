# Guided Example: Constructing Two Increasing Arrays
...
The objective for **Constructing Two Increasing Arrays** is to compute the global optimal value by decomposing the problem into overlapping subproblems.

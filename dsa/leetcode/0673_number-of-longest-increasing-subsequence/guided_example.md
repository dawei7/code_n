...
We derive and execute the Array, Dynamic Programming, Binary Indexed Tree, Segment Tree recurrence on a representative problem instance.
...
The objective for **Number of Longest Increasing Subsequence** is to compute the global optimal value by decomposing the problem into overlapping subproblems.

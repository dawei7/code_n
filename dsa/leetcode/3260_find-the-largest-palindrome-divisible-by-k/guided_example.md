# Guided Example: Find the Largest Palindrome Divisible by K

We derive and execute the Math, String, Dynamic Programming, Greedy, Number Theory recurrence on a representative problem instance.
...
The objective for **Find the Largest Palindrome Divisible by K** is to compute the global optimal value by decomposing the problem into overlapping subproblems.

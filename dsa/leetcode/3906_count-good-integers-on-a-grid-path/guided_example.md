# Guided Example: Count Good Integers on a Grid Path
...
The objective for **Count Good Integers on a Grid Path** is to compute the global optimal value by decomposing the problem into overlapping subproblems.

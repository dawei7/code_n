# Guided Example: Decremental String Concatenation
...
The objective for **Decremental String Concatenation** is to compute the global optimal value by decomposing the problem into overlapping subproblems.

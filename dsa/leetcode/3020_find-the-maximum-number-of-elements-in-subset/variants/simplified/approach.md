# Simplified Approach - Find the Maximum Number of Elements in Subset
...
## Complexity detail
- **Time Complexity**: $O(N log log M)$ — Each input element is processed in a bounded number of direct operations.

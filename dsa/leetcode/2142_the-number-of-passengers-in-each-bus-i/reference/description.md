...
Buses and passengers arrive at the LeetCode station. If a bus arrives at the station at time $t_{bus}$ and a passenger arrived at time $t_{passenger}$ where $t_{passenger} \le t_{bus}$ and the passenger did not catch any bus, the passenger will use that bus.

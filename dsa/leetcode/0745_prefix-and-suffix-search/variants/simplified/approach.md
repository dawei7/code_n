# Simplified Approach - Prefix and Suffix Search
...
## Complexity detail
- **Time Complexity**: $O(wL^2+q)$ — Each input element is processed in a bounded number of direct operations.
- **Space Complexity**: $O(wL^2)$ — Utilizes standard auxiliary storage proportional to the active computation state.

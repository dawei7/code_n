# Simplified Approach - Find the Number of Subsequences With Equal GCD
...
## Complexity detail
- **Time Complexity**: $O(nV^2)$ — Each input element is processed in a bounded number of direct operations.

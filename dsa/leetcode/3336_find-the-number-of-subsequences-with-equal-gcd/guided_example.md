# Guided Example: Find the Number of Subsequences With Equal GCD

We derive and execute the Array, Math, Dynamic Programming, Number Theory recurrence on a representative problem instance.
...
The objective for **Find the Number of Subsequences With Equal GCD** is to compute the global optimal value by decomposing the problem into overlapping subproblems.

# Guided Example: Number of Nodes With Value One
...
The objective for **Number of Nodes With Value One** is to evaluate tree properties by visiting nodes in topological hierarchy (post-order, pre-order, or level-order).

# Simplified Approach - Find the Minimum Amount of Time to Brew Potions
...
## Complexity detail
- **Time Complexity**: $O(nm)$ — Each input element is processed in a bounded number of direct operations.

# Guided Example: Minimize Connected Groups by Inserting Interval
...
The objective for **Minimize Connected Groups by Inserting Interval** is to find the optimal contiguous window without evaluating all $O(N^2)$ candidate subarrays.

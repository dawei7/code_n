# Guided Example: Maximum Path Intersection Sum in a Grid
...
The objective for **Maximum Path Intersection Sum in a Grid** is to compute the global optimal value by decomposing the problem into overlapping subproblems.

## General
The optimal solution implements an idiomatic, readable, and production-ready approach for **Find Invalid IP Addresses**.
...
## Complexity detail
- **Time Complexity**: $O(S + k log k)$ — Operational efficiency across problem constraints.

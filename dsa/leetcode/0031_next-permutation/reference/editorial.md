...
<div>
    <div class="video-container">
        <iframe src="https://player.vimeo.com/video/788112386" width="640" height="360" frameborder="0" allow="autoplay; fullscreen" allowfullscreen></iframe>
    </div>
</div>
...
![ Next Permutation ](images/31_nums_graph.png)
...
- Time complexity: $O(n)$
   ...
   The second `while` loop also runs at most $n$ iterations, decrementing the variable `j` as it searches for the smallest element larger than $\text{nums}[i]$. Similarly, it can take $O(n)$ time.

# Simplified Approach - Number of Strings That Appear as Substrings in Word
...
## Complexity detail
- **Time Complexity**: $O(T+PM)$ — Each input element is processed in a bounded number of direct operations.

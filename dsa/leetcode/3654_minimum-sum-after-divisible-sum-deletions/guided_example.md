# Guided Example: Minimum Sum After Divisible Sum Deletions

We derive and execute the Array, Hash Table, Dynamic Programming, Prefix Sum recurrence on a representative problem instance.
...
The objective for **Minimum Sum After Divisible Sum Deletions** is to compute the global optimal value by decomposing the problem into overlapping subproblems.

## General
**Competitive Approach — Shortest Path with Alternating Colors**
...
Sourced from `kamyu104/LeetCode-Solutions`. This implementation focuses on raw computational throughput in method `shortestAlternatingPaths`. It minimizes object instantiation overhead, avoids redundant memory passes, and leverages compact iteration loops.

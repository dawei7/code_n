...
To a deeply nested object or array `obj`, return the object `obj` with any `undefined` values replaced by `null`, the JavaScript solution uses clean ES6+ techniques.

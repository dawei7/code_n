# Simplified Approach - Unique Binary Search Trees II
...
## Complexity detail
- **Time Complexity**: $O(n C_n)$ — Each input element is processed in a bounded number of direct operations.
- **Space Complexity**: $O(n C_n)$ — Utilizes standard auxiliary storage proportional to the active computation state.

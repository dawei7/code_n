# Guided Example: Find the Sum of the Power of All Subsequences
...
The objective for **Find the Sum of the Power of All Subsequences** is to compute the global optimal value by decomposing the problem into overlapping subproblems.

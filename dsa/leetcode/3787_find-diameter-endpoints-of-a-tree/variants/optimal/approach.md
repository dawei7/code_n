## General
**Optimal Approach — Find Diameter Endpoints of a Tree**
...
Sourced from `doocs/leetcode` (or refined to expert standard) in method `findSpecialNodes`. This implementation is chosen for its exceptional readability, idiomatic Python 3 constructs, and clear structural separation of concerns suitable for technical software engineering interviews.

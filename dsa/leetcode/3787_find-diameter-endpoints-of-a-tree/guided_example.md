# Guided Example: Find Diameter Endpoints of a Tree

We trace the hierarchical Tree, Breadth-First Search, Graph Theory traversal and subtree aggregation on a representative binary tree.
...
The objective for **Find Diameter Endpoints of a Tree** is to evaluate tree properties by visiting nodes in topological hierarchy (post-order, pre-order, or level-order).

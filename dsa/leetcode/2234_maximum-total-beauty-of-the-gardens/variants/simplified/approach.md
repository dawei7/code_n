# Simplified Approach - Maximum Total Beauty of the Gardens
...
## Complexity detail
- **Time Complexity**: $O(n log n + n log target)$ — Each input element is processed in a bounded number of direct operations.

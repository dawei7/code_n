# Guided Example: Find Pattern in Infinite Stream I
...
The objective for **Find Pattern in Infinite Stream I** is to find the optimal contiguous window without evaluating all $O(N^2)$ candidate subarrays.

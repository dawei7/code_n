## General
**Competitive Approach — Biggest Window Between Visits**

The query executes a structured relational pipeline for **Biggest Window Between Visits**. It uses PostgreSQL window functions for analytical ranking and offset calculations, `GROUP BY` aggregation with PostgreSQL standard functions (`COALESCE`, `STRING_AGG`).

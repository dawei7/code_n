...
We derive and execute the String, Dynamic Programming, Backtracking, Bit Manipulation, Bitmask recurrence on a representative problem instance.
...
The objective for **Maximum Product of the Length of Two Palindromic Subsequences** is to compute the global optimal value by decomposing the problem into overlapping subproblems.

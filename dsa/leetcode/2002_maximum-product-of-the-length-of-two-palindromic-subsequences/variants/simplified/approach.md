# Simplified Approach - Maximum Product of the Length of Two Palindromic Subsequences
...
## Complexity detail
- **Time Complexity**: $O(N2^N)$ — Each input element is processed in a bounded number of direct operations.

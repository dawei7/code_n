# Simplified Approach - Double Modular Exponentiation
...
## Complexity detail
- **Time Complexity**: $O(V(log B + log C))$ — Each input element is processed in a bounded number of direct operations.

# Guided Example: Minimum Cost Path with Alternating Directions II
...
The objective for **Minimum Cost Path with Alternating Directions II** is to compute the global optimal value by decomposing the problem into overlapping subproblems.

# Simplified Approach - Minimum Cost Path with Alternating Directions II
...
- **Space Complexity**: $O(min(m, n))$ — Utilizes standard auxiliary storage proportional to the active computation state.

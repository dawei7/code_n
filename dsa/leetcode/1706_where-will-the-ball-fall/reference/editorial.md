...
![Problem Visualisation](images/problem_visualization.png)
...
- The ball reaches the last row of the grid and drops out from some lane. In this case, we have to return the lane number(in other words, column number) from which the ball drops out of the grid.
  ...
  ![Ball Drops Out At The End Example](images/Ball_drops_out_example.png)

- The ball reaches a certain point where it is stuck and cannot move ahead. In this case, we have to return -1.

  ![Ball Stuck In Grid Example](images/ball_is_stuck_example.png)
...
![Six examples Illustration](images/6_example_scenarios.png)
...
![Ball Falls In Right Diagonal](images/ball_first_position_right_diagonal.png)
...
![Ball Next Movement In 2 Scenarios](images/ball_movement_2_scenarios.png)
...
![Adjacent Cells Example](images/adjacent_cells_example.png)
...
![Dp Solution Example](images/dp_solution_example.png)

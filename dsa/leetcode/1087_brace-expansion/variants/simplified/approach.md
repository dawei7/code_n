# Simplified Approach - Brace Expansion
...
## Complexity detail
- **Time Complexity**: $O(n+RL)$ — Each input element is processed in a bounded number of direct operations.
- **Space Complexity**: $O(n+RL)$ — Utilizes standard auxiliary storage proportional to the active computation state.

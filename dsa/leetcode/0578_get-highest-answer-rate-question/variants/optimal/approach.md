## General
The optimal solution implements an idiomatic, readable, and production-ready approach for **Get Highest Answer Rate Question**.
...
## Complexity detail
- **Time Complexity**: $O(R \log Q)$ — Operational efficiency across problem constraints.

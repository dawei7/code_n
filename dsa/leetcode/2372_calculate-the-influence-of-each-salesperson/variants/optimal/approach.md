## General
The optimal solution implements an idiomatic, readable, and production-ready approach for **Calculate the Influence of Each Salesperson**.
...
## Complexity detail
- **Time Complexity**: $O((S+C+R) log(S+C+R))$ — Operational efficiency across problem constraints.

# Guided Example: Maximum Coin Collection 
...
The objective for **Maximum Coin Collection ** is to compute the global optimal value by decomposing the problem into overlapping subproblems.

...
We derive and execute the Array, Math, Dynamic Programming, Matrix recurrence on a representative problem instance.
...
The objective for **Number Of Corner Rectangles** is to compute the global optimal value by decomposing the problem into overlapping subproblems.

# Guided Example: Count Complete Subarrays in an Array
...
The objective for **Count Complete Subarrays in an Array** is to find the optimal contiguous window without evaluating all $O(N^2)$ candidate subarrays.

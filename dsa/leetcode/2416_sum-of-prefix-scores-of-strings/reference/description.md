...
We define the **score** of a string `term` as the **number** of strings $\text{words}[i]$ such that `term` is a **prefix** of $\text{words}[i]$.
...
- **Input:** $words = ["abcd"]$
- **Output:** `[4]`
- **Explanation:** "abcd" has 4 prefixes: "a", "ab", "abc", and "abcd".

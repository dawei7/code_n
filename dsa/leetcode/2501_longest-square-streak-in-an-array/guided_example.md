# Guided Example: Longest Square Streak in an Array
...
The objective for **Longest Square Streak in an Array** is to pinpoint the target value or optimal threshold in logarithmic $O(\log N)$ time.

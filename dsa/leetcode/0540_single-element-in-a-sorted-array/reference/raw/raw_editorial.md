...
![An array with the elements 1, 1, 4, 4, 5, 5, 6, 6, 8, 9, 9](images/example1.png)

Here is what happens when we remove a *pair* from the center. We are left with a left subarray and a right subarray.

![An array with the elements 1, 1, 4, 4, 5, 5, 6, 6, 8, 9, 9. The 5's are crossed out.](images/example2.png)

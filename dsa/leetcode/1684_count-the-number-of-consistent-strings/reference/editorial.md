...
- Time complexity: $O(m + n \cdot k)$
    ...
    Thus, the time complexity of the algorithm is $O(m) +$\mathcal{O}(n \cdot k)$= O(m + n \cdot k)$.
...
* Time complexity: $O(m + n \cdot k)$
    ...
    Thus, the overall time complexity of the algorithm is $O(m) +$\mathcal{O}(n \cdot k)$= O(m + n \cdot k)$.

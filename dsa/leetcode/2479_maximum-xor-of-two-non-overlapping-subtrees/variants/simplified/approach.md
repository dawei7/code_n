# Simplified Approach - Maximum XOR of Two Non-Overlapping Subtrees
...
## Complexity detail
- **Time Complexity**: $O(n log S)$ — Each input element is processed in a bounded number of direct operations.
- **Space Complexity**: $O(n log S)$ — Utilizes standard auxiliary storage proportional to the active computation state.

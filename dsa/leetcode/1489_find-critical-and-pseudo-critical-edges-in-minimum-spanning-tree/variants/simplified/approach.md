# Simplified Approach - Find Critical and Pseudo-Critical Edges in Minimum Spanning Tree
...
## Complexity detail
- **Time Complexity**: $O(E \log E)$ — Each input element is processed in a bounded number of direct operations.
- **Space Complexity**: $O(V + E)$ — Utilizes standard auxiliary storage proportional to the active computation state.

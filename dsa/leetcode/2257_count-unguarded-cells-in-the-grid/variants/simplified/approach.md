# Simplified Approach - Count Unguarded Cells in the Grid
...
## Complexity detail
- **Time Complexity**: $O(m n + G + W)$ — Each input element is processed in a bounded number of direct operations.

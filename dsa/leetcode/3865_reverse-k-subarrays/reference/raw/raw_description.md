...
**Input:** <span class="example-io">nums = [1,2,4,3,5,6], k = 3</span>

**Output:** <span class="example-io">[2,1,3,4,6,5]</span>
...
<div class="example-block">
**Input:** <span class="example-io">nums = [5,4,4,2], k = 1</span>

**Output:** <span class="example-io">[2,4,4,5]</span>

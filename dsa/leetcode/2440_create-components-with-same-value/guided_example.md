# Guided Example: Create Components With Same Value

We trace the hierarchical Array, Math, Tree, Depth-First Search, Enumeration traversal and subtree aggregation on a representative binary tree.
...
The objective for **Create Components With Same Value** is to evaluate tree properties by visiting nodes in topological hierarchy (post-order, pre-order, or level-order).

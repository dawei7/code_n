# Guided Example: Number of Substrings Containing All Three Characters
...
The objective for **Number of Substrings Containing All Three Characters** is to find the optimal contiguous window without evaluating all $O(N^2)$ candidate subarrays.

# Guided Example: Length of Longest Subarray With at Most K Frequency
...
The objective for **Length of Longest Subarray With at Most K Frequency** is to find the optimal contiguous window without evaluating all $O(N^2)$ candidate subarrays.

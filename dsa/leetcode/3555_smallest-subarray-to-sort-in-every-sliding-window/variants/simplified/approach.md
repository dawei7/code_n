# Simplified Approach - Smallest Subarray to Sort in Every Sliding Window
...
## Complexity detail
- **Time Complexity**: $O((n-k+1)k)$ — Each input element is processed in a bounded number of direct operations.

...
<ul>
	<li>There are at least `time` days before and after the `i^th` day,</li>
	<li>The number of guards at the bank for the `time` days **before** `i` are **non-increasing**, and</li>
	<li>The number of guards at the bank for the `time` days **after** `i` are **non-decreasing**.</li>
</ul>

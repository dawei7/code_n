# Guided Example: Count Ways to Choose Coprime Integers from Rows

We derive and execute the Array, Math, Dynamic Programming, Matrix, Combinatorics, Number Theory recurrence on a representative problem instance.
...
The objective for **Count Ways to Choose Coprime Integers from Rows** is to compute the global optimal value by decomposing the problem into overlapping subproblems.

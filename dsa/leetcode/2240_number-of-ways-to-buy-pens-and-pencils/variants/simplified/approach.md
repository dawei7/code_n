# Simplified Approach - Number of Ways to Buy Pens and Pencils
...
## Complexity detail
- **Time Complexity**: $O(T / max(c1, c2))$ — Each input element is processed in a bounded number of direct operations.

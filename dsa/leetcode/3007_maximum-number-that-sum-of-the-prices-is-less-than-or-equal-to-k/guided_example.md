# Guided Example: Maximum Number That Sum of the Prices Is Less Than or Equal to K

We trace the logarithmic Math, Binary Search, Dynamic Programming, Bit Manipulation search on a representative problem instance.
...
The objective for **Maximum Number That Sum of the Prices Is Less Than or Equal to K** is to pinpoint the target value or optimal threshold in logarithmic $O(\log N)$ time.

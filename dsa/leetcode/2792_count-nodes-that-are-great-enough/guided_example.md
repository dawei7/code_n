# Guided Example: Count Nodes That Are Great Enough

We trace the hierarchical Divide and Conquer, Tree, Depth-First Search, Binary Tree traversal and subtree aggregation on a representative binary tree.
...
The objective for **Count Nodes That Are Great Enough** is to evaluate tree properties by visiting nodes in topological hierarchy (post-order, pre-order, or level-order).

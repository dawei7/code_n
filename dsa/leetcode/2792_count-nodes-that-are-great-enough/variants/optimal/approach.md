## General
**Optimal Approach — Count Nodes That Are Great Enough**

The solution employs Two-Pointer technique iterating from opposing ends or maintaining a sliding window bound. It utilizes Priority Queue / Min-Heap (`heapq`) for dynamic minimum/maximum extraction, Binary Tree node traversal (`val`, `left`, `right`) to maintain optimal runtime bounds.

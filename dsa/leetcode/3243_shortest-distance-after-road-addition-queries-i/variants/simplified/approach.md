# Simplified Approach - Shortest Distance After Road Addition Queries I
...
## Complexity detail
- **Time Complexity**: $O(q(n+q))$ — Each input element is processed in a bounded number of direct operations.

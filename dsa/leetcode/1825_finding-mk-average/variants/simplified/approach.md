# Simplified Approach - Finding MK Average
...
## Complexity detail
- **Time Complexity**: $O(U + q\log U)$ — Each input element is processed in a bounded number of direct operations.
- **Space Complexity**: $O(m+U)$ — Utilizes standard auxiliary storage proportional to the active computation state.

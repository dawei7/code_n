## General
The optimal solution implements an idiomatic, readable, and production-ready approach for **Calculate Salaries**.
...
## Complexity detail
- **Time Complexity**: $O(E+C)$ — Operational efficiency across problem constraints.

# Guided Example: Number of Pairs Satisfying Inequality

We trace the logarithmic Array, Binary Search, Divide and Conquer, Binary Indexed Tree, Segment Tree, Merge Sort, Ordered Set search on a representative problem instance.
...
The objective for **Number of Pairs Satisfying Inequality** is to pinpoint the target value or optimal threshold in logarithmic $O(\log N)$ time.

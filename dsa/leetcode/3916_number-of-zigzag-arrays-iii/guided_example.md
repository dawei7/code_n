# Guided Example: Number of ZigZag Arrays III

We derive and execute the Math, Dynamic Programming, Prefix Sum recurrence on a representative problem instance.
...
The objective for **Number of ZigZag Arrays III** is to compute the global optimal value by decomposing the problem into overlapping subproblems.

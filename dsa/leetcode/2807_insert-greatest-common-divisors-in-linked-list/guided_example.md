# Guided Example: Insert Greatest Common Divisors in Linked List

We execute the single-pass Linked List, Math, Number Theory pointer manipulation on a representative linked list instance.

- **Input:** `{"head": [18, 6, 10, 3]}`
- **Required output:** `[18, 6, 6, 2, 10, 1, 3]`
...
The objective for **Insert Greatest Common Divisors in Linked List** is to transform the linked structure by strictly updating `next` references in place.

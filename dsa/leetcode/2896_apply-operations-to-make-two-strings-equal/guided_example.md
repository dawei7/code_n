# Guided Example: Apply Operations to Make Two Strings Equal
...
The objective for **Apply Operations to Make Two Strings Equal** is to compute the global optimal value by decomposing the problem into overlapping subproblems.

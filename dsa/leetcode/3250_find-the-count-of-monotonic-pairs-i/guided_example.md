# Guided Example: Find the Count of Monotonic Pairs I
...
The objective for **Find the Count of Monotonic Pairs I** is to compute the global optimal value by decomposing the problem into overlapping subproblems.

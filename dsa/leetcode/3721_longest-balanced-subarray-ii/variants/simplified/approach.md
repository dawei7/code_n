# Simplified Approach - Longest Balanced Subarray II
...
- **Space Complexity**: $O(n + U)$ — Utilizes standard auxiliary storage proportional to the active computation state.

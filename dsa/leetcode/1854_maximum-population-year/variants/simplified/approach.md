# Simplified Approach - Maximum Population Year
...
## Complexity detail
- **Time Complexity**: $O(n+Y)$ — Each input element is processed in a bounded number of direct operations.
- **Space Complexity**: $O(Y)$ — Utilizes standard auxiliary storage proportional to the active computation state.

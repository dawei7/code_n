...
- **Input:** `{"operations": ["MyCircularQueue", "enQueue", "enQueue", "enQueue", "enQueue", "Rear", "isFull", "deQueue", "enQueue", "Rear"], "arguments": [[3], [1], [2], [3], [4], [], [], [], [4], []]}`
- **Required output:** `[null, true, true, true, false, 3, true, true, true, 4]`
...
The objective for **Design Circular Queue** is to transform the linked structure by strictly updating `next` references in place.

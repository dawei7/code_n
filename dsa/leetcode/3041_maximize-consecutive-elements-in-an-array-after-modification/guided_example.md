# Guided Example: Maximize Consecutive Elements in an Array After Modification

We derive and execute the Array, Dynamic Programming, Sorting recurrence on a representative problem instance.
...
The objective for **Maximize Consecutive Elements in an Array After Modification** is to compute the global optimal value by decomposing the problem into overlapping subproblems.

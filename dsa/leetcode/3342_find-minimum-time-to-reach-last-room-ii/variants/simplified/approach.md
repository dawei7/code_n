# Simplified Approach - Find Minimum Time to Reach Last Room II
...
## Complexity detail
- **Time Complexity**: $O(nm log(nm))$ — Each input element is processed in a bounded number of direct operations.

# Simplified Approach - Minimum Jumps to Reach End via Prime Teleportation
...
- **Space Complexity**: $O(n + M)$ — Utilizes standard auxiliary storage proportional to the active computation state.

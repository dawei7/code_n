...
We trace the logarithmic Array, Binary Search, Interactive search on a representative problem instance.

- **Input:** `{"reader": {"array": [7, 7, 7, 7, 10, 7, 7, 7], "max_queries": 20}}`
- **Required output:** `4`
...
The objective for **Find the Index of the Large Integer** is to pinpoint the target value or optimal threshold in logarithmic $O(\log N)$ time.

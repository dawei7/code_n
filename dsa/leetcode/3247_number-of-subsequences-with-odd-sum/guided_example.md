# Guided Example: Number of Subsequences with Odd Sum

We derive and execute the Array, Math, Dynamic Programming, Combinatorics recurrence on a representative problem instance.
...
The objective for **Number of Subsequences with Odd Sum** is to compute the global optimal value by decomposing the problem into overlapping subproblems.

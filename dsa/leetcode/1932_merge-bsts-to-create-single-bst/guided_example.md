...
We trace the hierarchical Array, Hash Table, Tree, Depth-First Search, Binary Search Tree, Binary Tree traversal and subtree aggregation on a representative binary tree.

- **Input:** `{"trees": [[2, 1], [3, 2, 5], [5, 4]]}`
- **Required output:** `[3, 2, 5, 1, null, 4]`
...
The objective for **Merge BSTs to Create Single BST** is to evaluate tree properties by visiting nodes in topological hierarchy (post-order, pre-order, or level-order).

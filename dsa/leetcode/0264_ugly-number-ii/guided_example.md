...
We derive and execute the Hash Table, Math, Dynamic Programming, Heap (Priority Queue) recurrence on a representative problem instance.
...
The objective for **Ugly Number II** is to compute the global optimal value by decomposing the problem into overlapping subproblems.

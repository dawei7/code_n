# Guided Example: Sum of Compatible Numbers in Range I

We derive and execute the Dynamic Programming, Bit Manipulation, Enumeration recurrence on a representative problem instance.
...
The objective for **Sum of Compatible Numbers in Range I** is to compute the global optimal value by decomposing the problem into overlapping subproblems.

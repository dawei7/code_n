# Simplified Approach - Minimum Adjacent Swaps to Reach the Kth Smallest Number
...
## Complexity detail
- **Time Complexity**: $O(kn+n\log n)$ — Each input element is processed in a bounded number of direct operations.

# Guided Example: Total Characters in String After Transformations I
...
The objective for **Total Characters in String After Transformations I** is to compute the global optimal value by decomposing the problem into overlapping subproblems.

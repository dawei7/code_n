# Guided Example: Find Longest Special Substring That Occurs Thrice I
...
The objective for **Find Longest Special Substring That Occurs Thrice I** is to find the optimal contiguous window without evaluating all $O(N^2)$ candidate subarrays.

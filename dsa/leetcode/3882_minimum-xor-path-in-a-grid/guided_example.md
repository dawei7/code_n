# Guided Example: Minimum XOR Path in a Grid
...
The objective for **Minimum XOR Path in a Grid** is to compute the global optimal value by decomposing the problem into overlapping subproblems.

## General
**Competitive Approach — Print in Order**

The solution implements an direct algorithm tailored for Print in Order. It utilizes Hash Map / Dictionary for $O(1)$ average lookup and frequency tracking to maintain optimal runtime bounds.

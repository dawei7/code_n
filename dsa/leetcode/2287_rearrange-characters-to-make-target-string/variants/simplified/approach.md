# Simplified Approach - Rearrange Characters to Make Target String
...
## Complexity detail
- **Time Complexity**: $O(S + T)$ — Each input element is processed in a bounded number of direct operations.

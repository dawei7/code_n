# Simplified Approach - Count Submatrices with Top-Left Element and Sum Less Than k
...
## Complexity detail
- **Time Complexity**: $O(m n)$ — Each input element is processed in a bounded number of direct operations.

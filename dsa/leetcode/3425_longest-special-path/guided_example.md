# Guided Example: Longest Special Path
...
The objective for **Longest Special Path** is to evaluate tree properties by visiting nodes in topological hierarchy (post-order, pre-order, or level-order).

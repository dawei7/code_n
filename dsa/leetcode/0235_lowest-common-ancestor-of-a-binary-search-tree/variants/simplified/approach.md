# Simplified Approach - Lowest Common Ancestor of a Binary Search Tree
...
## Complexity detail
- **Time Complexity**: $O(h)$ — Each input element is processed in a bounded number of direct operations.

...
We derive and execute the Array, Hash Table, Dynamic Programming, Sorting recurrence on a representative problem instance.
...
The objective for **Binary Trees With Factors** is to compute the global optimal value by decomposing the problem into overlapping subproblems.

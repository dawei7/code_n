# Simplified Approach - Number of Ways to Wear Different Hats to Each Other
...
## Complexity detail
- **Time Complexity**: $O(40p2^p)$ — Each input element is processed in a bounded number of direct operations.
- **Space Complexity**: $O(2^p)$ — Utilizes standard auxiliary storage proportional to the active computation state.

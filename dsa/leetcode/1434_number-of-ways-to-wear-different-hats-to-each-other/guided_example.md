...
The objective for **Number of Ways to Wear Different Hats to Each Other** is to compute the global optimal value by decomposing the problem into overlapping subproblems.

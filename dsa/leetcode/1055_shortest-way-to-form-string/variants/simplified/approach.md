# Simplified Approach - Shortest Way to Form String
...
## Complexity detail
- **Time Complexity**: $O(AS+T)$ — Each input element is processed in a bounded number of direct operations.
- **Space Complexity**: $O(AS)$ — Utilizes standard auxiliary storage proportional to the active computation state.

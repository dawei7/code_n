# Guided Example: Kth Largest Sum in a Binary Tree

We trace the hierarchical Tree, Breadth-First Search, Sorting, Binary Tree traversal and subtree aggregation on a representative binary tree.
...
The objective for **Kth Largest Sum in a Binary Tree** is to evaluate tree properties by visiting nodes in topological hierarchy (post-order, pre-order, or level-order).

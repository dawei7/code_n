# Guided Example: Minimum Pair Removal to Sort Array I
...
The objective for **Minimum Pair Removal to Sort Array I** is to transform the linked structure by strictly updating `next` references in place.

# Guided Example: Find the Minimum Cost Array Permutation

We derive and execute the Array, Dynamic Programming, Bit Manipulation, Bitmask recurrence on a representative problem instance.
...
The objective for **Find the Minimum Cost Array Permutation** is to compute the global optimal value by decomposing the problem into overlapping subproblems.

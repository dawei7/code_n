# Guided Example: Longest Non-decreasing Subarray From Two Arrays
...
The objective for **Longest Non-decreasing Subarray From Two Arrays** is to compute the global optimal value by decomposing the problem into overlapping subproblems.

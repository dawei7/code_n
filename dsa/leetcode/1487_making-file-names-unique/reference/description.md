...
Return *an array of strings of length *`n` where $\text{ans}[i]$ is the actual name the system will assign to the $$i^{\text{th}}$$ folder when you create it.
...
- $\text{names}[i]$ consists of lowercase English letters, digits, and/or round brackets.

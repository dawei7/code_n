...
We trace the logarithmic Array, String, Binary Search, Prefix Sum search on a representative problem instance.
...
The objective for **Plates Between Candles** is to pinpoint the target value or optimal threshold in logarithmic $O(\log N)$ time.

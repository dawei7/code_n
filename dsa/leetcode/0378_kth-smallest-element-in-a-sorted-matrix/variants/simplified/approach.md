# Simplified Approach - Kth Smallest Element in a Sorted Matrix
...
## Complexity detail
- **Time Complexity**: $O(n \log R)$ — Each input element is processed in a bounded number of direct operations.

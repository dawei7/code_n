...
We derive and execute the Array, Dynamic Programming, Memoization, Matrix, Prefix Sum recurrence on a representative problem instance.
...
The objective for **Number of Ways of Cutting a Pizza** is to compute the global optimal value by decomposing the problem into overlapping subproblems.

# Simplified Approach - Closest Prime Numbers in Range
...
## Complexity detail
- **Time Complexity**: $O(R log log R)$ — Each input element is processed in a bounded number of direct operations.

# Simplified Approach - Number of Sets of K Non-Overlapping Line Segments
...
## Complexity detail
- **Time Complexity**: $O(k+\log M)$ — Each input element is processed in a bounded number of direct operations.

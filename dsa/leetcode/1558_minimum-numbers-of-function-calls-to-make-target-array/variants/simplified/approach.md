# Simplified Approach - Minimum Numbers of Function Calls to Make Target Array
...
## Complexity detail
- **Time Complexity**: $O(NB)$ — Each input element is processed in a bounded number of direct operations.

## General
The optimal solution implements an idiomatic, readable, and production-ready approach for **Bank Account Summary II**.
...
## Complexity detail
- **Time Complexity**: $O((U+T)\log(U+T))$ — Operational efficiency across problem constraints.

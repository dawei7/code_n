# Guided Example: Ways to Express an Integer as Sum of Powers
...
The objective for **Ways to Express an Integer as Sum of Powers** is to compute the global optimal value by decomposing the problem into overlapping subproblems.

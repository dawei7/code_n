# Simplified Approach - Minimum Sum of Values by Dividing Array
...
## Complexity detail
- **Time Complexity**: $O(n m log V)$ — Each input element is processed in a bounded number of direct operations.
- **Space Complexity**: $O(m log V)$ — Utilizes standard auxiliary storage proportional to the active computation state.

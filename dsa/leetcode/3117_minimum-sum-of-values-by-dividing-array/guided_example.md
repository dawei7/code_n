# Guided Example: Minimum Sum of Values by Dividing Array

We trace the logarithmic Array, Binary Search, Dynamic Programming, Bit Manipulation, Segment Tree, Queue search on a representative problem instance.
...
The objective for **Minimum Sum of Values by Dividing Array** is to pinpoint the target value or optimal threshold in logarithmic $O(\log N)$ time.

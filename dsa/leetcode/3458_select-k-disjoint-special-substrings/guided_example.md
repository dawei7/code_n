# Guided Example: Select K Disjoint Special Substrings

We derive and execute the Hash Table, String, Dynamic Programming, Greedy, Sorting recurrence on a representative problem instance.
...
The objective for **Select K Disjoint Special Substrings** is to compute the global optimal value by decomposing the problem into overlapping subproblems.

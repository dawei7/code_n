## General
**Competitive Approach — Minimum Depth of Binary Tree**

The solution implements an direct algorithm tailored for Minimum Depth of Binary Tree. It utilizes Binary Tree node traversal (`val`, `left`, `right`) to maintain optimal runtime bounds.

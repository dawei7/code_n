# Guided Example: Minimum Number of Increasing Subsequence to Be Removed
...
The objective for **Minimum Number of Increasing Subsequence to Be Removed** is to pinpoint the target value or optimal threshold in logarithmic $O(\log N)$ time.

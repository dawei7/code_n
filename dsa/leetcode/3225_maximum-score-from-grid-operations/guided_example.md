# Guided Example: Maximum Score From Grid Operations
...
The objective for **Maximum Score From Grid Operations** is to compute the global optimal value by decomposing the problem into overlapping subproblems.

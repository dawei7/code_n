...
- if you have been in room `i` an **odd** number of times (**including** the current visit), on the **next** day you will visit a room with a **lower or equal room number** specified by $\text{nextVisit}[i]$ where $0 \le \text{nextVisit}[i] \le i$;

# Simplified Approach - Minimum Interval to Include Each Query
...
## Complexity detail
- **Time Complexity**: $O((n+q)\log(n+q))$ — Each input element is processed in a bounded number of direct operations.

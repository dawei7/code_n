# Guided Example: K Inverse Pairs Array
...
The objective for **K Inverse Pairs Array** is to compute the global optimal value by decomposing the problem into overlapping subproblems.

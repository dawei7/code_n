...
The most naive solution is to generate every permutation of the array consisting of numbers from $1$ to $n$. Then, we can find out the number of inverse pairs in every array to determine if it is equal to $k$. We can find out the count of permutations with the required number of inverse pairs. But, this solution is very terrible in terms of time complexity. Thus, we move on to the better approaches directly.
...
![Inversions](images/629_kinverse.PNG)
...
* Space complexity : $O(nk)$. $memo$ array of constant size $n \cdot k$ is used. The depth of recursion tree can go upto $n$.
<br />
<br />
...
From this, we deduce that we can make use of Dynamic Programming to solve the given problem. To solve the given problem, we make use of a 2-D $dp$, where $\text{dp}[i][j]$ is used to store the number of arrangements with $i$ elements and exactly $j$ inverse pairs. Based on the discussions above, the $dp$ updation equations become:

1. If $n=0$, no inverse pairs exist. Thus, $\text{dp}[0][k]=0$.

2. If $k=0$, only one arrangement is possible, which is all numbers sorted in ascending order. Thus, $\text{dp}[n][0]=1$.
...
We start filling the $dp$ in a row-wise order starting from the first row. At the end, the value of $\text{dp}[n][k]$ gives the required result.

The following animation shows how the $dp$ is filled for n=4 and k=5:

![Slide 1](images/slideshow_629_dp4_629_dp4Slide1.PNG)

![Slide 2](images/slideshow_629_dp4_629_dp4Slide2.PNG)

![Slide 3](images/slideshow_629_dp4_629_dp4Slide3.PNG)

![Slide 4](images/slideshow_629_dp4_629_dp4Slide4.PNG)

![Slide 5](images/slideshow_629_dp4_629_dp4Slide5.PNG)

![Slide 6](images/slideshow_629_dp4_629_dp4Slide6.PNG)

![Slide 7](images/slideshow_629_dp4_629_dp4Slide7.PNG)

![Slide 8](images/slideshow_629_dp4_629_dp4Slide8.PNG)

![Slide 9](images/slideshow_629_dp4_629_dp4Slide9.PNG)

![Slide 10](images/slideshow_629_dp4_629_dp4Slide10.PNG)

![Slide 11](images/slideshow_629_dp4_629_dp4Slide11.PNG)

![Slide 12](images/slideshow_629_dp4_629_dp4Slide12.PNG)

![Slide 13](images/slideshow_629_dp4_629_dp4Slide13.PNG)

![Slide 14](images/slideshow_629_dp4_629_dp4Slide14.PNG)

![Slide 15](images/slideshow_629_dp4_629_dp4Slide15.PNG)

![Slide 16](images/slideshow_629_dp4_629_dp4Slide16.PNG)

![Slide 17](images/slideshow_629_dp4_629_dp4Slide17.PNG)

![Slide 18](images/slideshow_629_dp4_629_dp4Slide18.PNG)

![Slide 19](images/slideshow_629_dp4_629_dp4Slide19.PNG)

![Slide 20](images/slideshow_629_dp4_629_dp4Slide20.PNG)

![Slide 21](images/slideshow_629_dp4_629_dp4Slide21.PNG)

![Slide 22](images/slideshow_629_dp4_629_dp4Slide22.PNG)

![Slide 23](images/slideshow_629_dp4_629_dp4Slide23.PNG)

![Slide 24](images/slideshow_629_dp4_629_dp4Slide24.PNG)

![Slide 25](images/slideshow_629_dp4_629_dp4Slide25.PNG)
...
* Time complexity : $O(nk\min(n, k))$. The `dp` table of size $n \cdot k$ is filled once. Filling each entry takes $O(\min(n, k))$ time.

* Space complexity : $O(n*k)$. $dp$ array of size $n \cdot k$ is used.
<br />
<br />
...
Thus, now, $\text{dp}[i][j]=count(i,j)+\sum_{k=0}^{j-1} \text{dp}[i][k]$. Here, $count(i,j)$ refers to the number of arrangements with $i$ elements and exactly $j$ inverse pairs. Thus, each entry contains the sum of all the previous elements in the same row along with its own result.

Now, we need to determine the value of $count(i,j)$ to be added to the sum of previous elements in a row, in order to update the $\text{dp}[i][j]$ entry. But, we need not traverse back in the previous row , since it contains entries representing the cumulative sums now.
...
At the end, while returning the result, we need to return $\text{dp}[n][k]-\text{dp}[n][k-1]$ to obtain the required result from the cumulative sums.

The following animation illustrates the process of filling the $dp$ array.

![Slide 1](images/slideshow_629_dp5_629_dp5Slide1.PNG)

![Slide 2](images/slideshow_629_dp5_629_dp5Slide2.PNG)

![Slide 3](images/slideshow_629_dp5_629_dp5Slide3.PNG)

![Slide 4](images/slideshow_629_dp5_629_dp5Slide4.PNG)

![Slide 5](images/slideshow_629_dp5_629_dp5Slide5.PNG)

![Slide 6](images/slideshow_629_dp5_629_dp5Slide6.PNG)

![Slide 7](images/slideshow_629_dp5_629_dp5Slide7.PNG)

![Slide 8](images/slideshow_629_dp5_629_dp5Slide8.PNG)

![Slide 9](images/slideshow_629_dp5_629_dp5Slide9.PNG)

![Slide 10](images/slideshow_629_dp5_629_dp5Slide10.PNG)

![Slide 11](images/slideshow_629_dp5_629_dp5Slide11.PNG)

![Slide 12](images/slideshow_629_dp5_629_dp5Slide12.PNG)

![Slide 13](images/slideshow_629_dp5_629_dp5Slide13.PNG)

![Slide 14](images/slideshow_629_dp5_629_dp5Slide14.PNG)

![Slide 15](images/slideshow_629_dp5_629_dp5Slide15.PNG)

![Slide 16](images/slideshow_629_dp5_629_dp5Slide16.PNG)

![Slide 17](images/slideshow_629_dp5_629_dp5Slide17.PNG)

![Slide 18](images/slideshow_629_dp5_629_dp5Slide18.PNG)

![Slide 19](images/slideshow_629_dp5_629_dp5Slide19.PNG)

![Slide 20](images/slideshow_629_dp5_629_dp5Slide20.PNG)

![Slide 21](images/slideshow_629_dp5_629_dp5Slide21.PNG)

![Slide 22](images/slideshow_629_dp5_629_dp5Slide22.PNG)

![Slide 23](images/slideshow_629_dp5_629_dp5Slide23.PNG)

![Slide 24](images/slideshow_629_dp5_629_dp5Slide24.PNG)

![Slide 25](images/slideshow_629_dp5_629_dp5Slide25.PNG)

![Slide 26](images/slideshow_629_dp5_629_dp5Slide26.PNG)
...
* Time complexity : $O(nk)$. $dp$ array of size $n \cdot k$ is filled once.

* Space complexity : $O(nk)$. $dp$ array of size $n \cdot k$ is used.
<br />
<br />
---
...
Another way to use the Dynamic Programming Approach could be if we can somehow directly store the required $count(i,j)$ in $\text{dp}[i][j]$ entry, but still we should not need to traverse back in the previous row to find the sum of the required elements.
...
Now, when we go for filling in $\text{dp}[i][j+1]$ after filling $\text{dp}[i][j]$, we know $\text{dp}[i][j]$ already corresponds to the sum of the elements from $dp[i-1][j-i+1]$ to $dp[i-1][j]$. But, for filling $\text{dp}[i][j+1]$, we require the sum of the elements from $dp[i-1][(j-i+1)+1]$ to $dp[i-1][j+1]$.

We can observe that this sum only excludes $dp[i-1][j-i+1]$ from the previous sum($\text{dp}[i][j]$) and requires addition of only one new element($dp[i-1][j+1]$) to the to this sum. If the value $j-i+1<0$, we need not remove any value.

Thus, we can directly obtain $\text{dp}[i][j]$ value as $\text{dp}[i][j] = \text{dp}[i][j-1] - dp[i-1][j-i] + dp[i-1][j]$, if $j-i ≥ 0$. Otherwise, we can use:  $\text{dp}[i][j] = \text{dp}[i][j-1] + dp[i-1][j]$.
...
![Slide 1](images/slideshow_629_dp6_629_dp6Slide1.PNG)

![Slide 2](images/slideshow_629_dp6_629_dp6Slide2.PNG)

![Slide 3](images/slideshow_629_dp6_629_dp6Slide3.PNG)

![Slide 4](images/slideshow_629_dp6_629_dp6Slide4.PNG)

![Slide 5](images/slideshow_629_dp6_629_dp6Slide5.PNG)

![Slide 6](images/slideshow_629_dp6_629_dp6Slide6.PNG)

![Slide 7](images/slideshow_629_dp6_629_dp6Slide7.PNG)

![Slide 8](images/slideshow_629_dp6_629_dp6Slide8.PNG)

![Slide 9](images/slideshow_629_dp6_629_dp6Slide9.PNG)

![Slide 10](images/slideshow_629_dp6_629_dp6Slide10.PNG)

![Slide 11](images/slideshow_629_dp6_629_dp6Slide11.PNG)

![Slide 12](images/slideshow_629_dp6_629_dp6Slide12.PNG)

![Slide 13](images/slideshow_629_dp6_629_dp6Slide13.PNG)

![Slide 14](images/slideshow_629_dp6_629_dp6Slide14.PNG)

![Slide 15](images/slideshow_629_dp6_629_dp6Slide15.PNG)

![Slide 16](images/slideshow_629_dp6_629_dp6Slide16.PNG)

![Slide 17](images/slideshow_629_dp6_629_dp6Slide17.PNG)

![Slide 18](images/slideshow_629_dp6_629_dp6Slide18.PNG)

![Slide 19](images/slideshow_629_dp6_629_dp6Slide19.PNG)

![Slide 20](images/slideshow_629_dp6_629_dp6Slide20.PNG)

![Slide 21](images/slideshow_629_dp6_629_dp6Slide21.PNG)
...
* Time complexity : $O(nk)$. $dp$ array of size $(n+1) \cdot (k+1)$ is filled once.

* Space complexity : $O(nk)$. $dp$ array of size $(n+1)  \cdot (k+1)$ is used.
<br />
<br />
...
* Time complexity : $O(nk)$. $n$x$k$ entries in the $memo$ array are filled once.

* Space complexity : $O(nk)$. $memo$ array of  size $n \cdot k$ is used.
<br />
<br />
---

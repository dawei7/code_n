## General
The optimal solution implements an idiomatic, readable, and production-ready approach for **Ads Performance**.
...
## Complexity detail
- **Time Complexity**: $O(r+a\log a)$ — Operational efficiency across problem constraints.

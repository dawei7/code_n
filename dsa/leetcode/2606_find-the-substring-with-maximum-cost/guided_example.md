...
We derive and execute the Array, Hash Table, String, Dynamic Programming recurrence on a representative problem instance.
...
The objective for **Find the Substring With Maximum Cost** is to compute the global optimal value by decomposing the problem into overlapping subproblems.

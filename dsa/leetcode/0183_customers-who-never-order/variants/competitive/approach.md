## General
**Competitive Approach — Customers Who Never Order**

The query executes a structured relational pipeline for **Customers Who Never Order**. It uses Relational JOIN operations to correlate records across tables.
...
## Complexity detail
- **Time Complexity**: $O(c + o)$ — Operation count proportional to input scale.

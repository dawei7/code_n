# Simplified Approach - Customers Who Never Order
...
## Complexity detail
- **Time Complexity**: $O(c + o)$ — Each input element is processed in a bounded number of direct operations.
- **Space Complexity**: $O(c + o)$ — Utilizes standard auxiliary storage proportional to the active computation state.

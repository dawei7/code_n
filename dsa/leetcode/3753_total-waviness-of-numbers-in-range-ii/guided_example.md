# Guided Example: Total Waviness of Numbers in Range II
...
The objective for **Total Waviness of Numbers in Range II** is to compute the global optimal value by decomposing the problem into overlapping subproblems.

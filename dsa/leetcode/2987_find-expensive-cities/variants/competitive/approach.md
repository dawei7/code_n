## General
**Competitive Approach — Find Expensive Cities**

The query executes a structured relational pipeline for **Find Expensive Cities**. It uses `GROUP BY` aggregation with PostgreSQL standard functions (`COALESCE`, `STRING_AGG`).

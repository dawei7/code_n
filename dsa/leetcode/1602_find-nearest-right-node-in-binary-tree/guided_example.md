# Guided Example: Find Nearest Right Node in Binary Tree
...
- **Input:** `{"root": [1, 2, 3, null, 4, 5, 6], "u": {"path_from_root": "LR"}}`
- **Required output:** `[5]`
...
The objective for **Find Nearest Right Node in Binary Tree** is to evaluate tree properties by visiting nodes in topological hierarchy (post-order, pre-order, or level-order).

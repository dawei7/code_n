# Simplified Approach - Maximize Total Tastiness of Purchased Fruits
...
## Complexity detail
- **Time Complexity**: $O(nkB)$ — Each input element is processed in a bounded number of direct operations.
- **Space Complexity**: $O(kB)$ — Utilizes standard auxiliary storage proportional to the active computation state.

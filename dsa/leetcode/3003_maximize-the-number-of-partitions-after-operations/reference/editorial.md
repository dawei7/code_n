...
* $\text{left}[i]$ and $\text{right}[i]$ represent the split information for position `i`,
* $\text{left}[i][0]$ and $\text{right}[i][0]$ represent the number of splits in the **prefix** and **suffix** splits,
* $\text{left}[i][1]$ and $\text{right}[i][1]$ represent the character masks of the **left split** and **right split**, and
* $\text{left}[i][2]$ and $\text{right}[i][2]$ represent the number of distinct characters in the **left split** and **right split**, respectively.

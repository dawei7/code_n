## General
**Competitive Approach — Number of Unique Subjects Taught by Each Teacher**

The query executes a structured relational pipeline for **Number of Unique Subjects Taught by Each Teacher**. It uses `GROUP BY` aggregation with PostgreSQL standard functions (`COALESCE`, `STRING_AGG`).

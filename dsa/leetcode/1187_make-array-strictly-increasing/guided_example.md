# Guided Example: Make Array Strictly Increasing
...
The objective for **Make Array Strictly Increasing** is to pinpoint the target value or optimal threshold in logarithmic $O(\log N)$ time.

...
- $\text{numberOfBoxes}_{i}$ is the number of boxes of type `i`.

- $\text{numberOfUnitsPerBox}_{i}$_ is the number of units in each box of the type `i`.
...
- $1 \le \text{numberOfBoxes}_{i}, \text{numberOfUnitsPerBox}_{i} \le 1000$

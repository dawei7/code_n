# Simplified Approach - Customers Who Bought Products A and B but Not C
...
## Complexity detail
- **Time Complexity**: $O(C + O + R)$ — Each input element is processed in a bounded number of direct operations.

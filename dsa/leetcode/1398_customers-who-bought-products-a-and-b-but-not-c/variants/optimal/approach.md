## General
The optimal solution implements an idiomatic, readable, and production-ready approach for **Customers Who Bought Products A and B but Not C**.
...
## Complexity detail
- **Time Complexity**: $O(C + O + R)$ — Operational efficiency across problem constraints.

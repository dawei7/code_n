## General
**Optimal Approach — LFU Cache**

The solution implements an direct algorithm tailored for LFU Cache. It utilizes Hash Map / Dictionary for $O(1)$ average lookup and frequency tracking to maintain optimal runtime bounds.

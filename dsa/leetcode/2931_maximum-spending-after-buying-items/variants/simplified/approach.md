# Simplified Approach - Maximum Spending After Buying Items
...
## Complexity detail
- **Time Complexity**: $O(m n log(m))$ — Each input element is processed in a bounded number of direct operations.

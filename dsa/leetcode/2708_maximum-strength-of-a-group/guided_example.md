# Guided Example: Maximum Strength of a Group

We derive and execute the Array, Dynamic Programming, Backtracking, Greedy, Bit Manipulation, Sorting, Enumeration recurrence on a representative problem instance.

- **Input:** `{"nums": [3, -1, -5, 2, 5, -9]}`
- **Required output:** `1350`
...
The objective for **Maximum Strength of a Group** is to compute the global optimal value by decomposing the problem into overlapping subproblems.

# Simplified Approach - Count Almost Equal Pairs II
...
## Complexity detail
- **Time Complexity**: $O(n log n + n d^5)$ — Each input element is processed in a bounded number of direct operations.
- **Space Complexity**: $O(n + d^4)$ — Utilizes standard auxiliary storage proportional to the active computation state.

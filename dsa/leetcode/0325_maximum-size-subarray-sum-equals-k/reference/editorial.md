...
2. Iterate through `nums`. At each index `i`, add $\text{nums}[i]$ to `prefixSum`. Then, make the following checks:
...
- If the current `prefixSum` does not yet exist in `indices`, then set $\text{indices}[prefixSum] = i$. Only do this if it does not already exist because we only want the earliest instance of this presum.

3. Return `longestSubarray`.

![Slide 1](images/slideshow_325_2_325_6.png)

![Slide 2](images/slideshow_325_2_325_7.png)

![Slide 3](images/slideshow_325_2_325_8.png)

![Slide 4](images/slideshow_325_2_325_9.png)

![Slide 5](images/slideshow_325_2_325_10.png)

![Slide 6](images/slideshow_325_2_325_11.png)

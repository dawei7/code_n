## General
**Optimal Approach — Students and Examinations**

The query executes a structured relational pipeline for **Students and Examinations**. It uses Relational JOIN operations to correlate records across tables, `GROUP BY` aggregation with PostgreSQL standard functions (`COALESCE`, `STRING_AGG`).
...
## Complexity detail
- **Time Complexity**: $O(R+E)$ — Operation count proportional to input scale.

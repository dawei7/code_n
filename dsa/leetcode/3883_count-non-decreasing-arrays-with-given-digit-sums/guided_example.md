# Guided Example: Count Non Decreasing Arrays With Given Digit Sums

We derive and execute the Array, Dynamic Programming, Prefix Sum recurrence on a representative problem instance.
...
The objective for **Count Non Decreasing Arrays With Given Digit Sums** is to compute the global optimal value by decomposing the problem into overlapping subproblems.

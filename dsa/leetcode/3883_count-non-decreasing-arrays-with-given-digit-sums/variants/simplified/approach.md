# Simplified Approach - Count Non Decreasing Arrays With Given Digit Sums
...
## Complexity detail
- **Time Complexity**: $O(nU)$ — Each input element is processed in a bounded number of direct operations.

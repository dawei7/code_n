# Guided Example: K-th Largest Perfect Subtree Size in Binary Tree

We trace the hierarchical Tree, Depth-First Search, Sorting, Binary Tree traversal and subtree aggregation on a representative binary tree.
...
The objective for **K-th Largest Perfect Subtree Size in Binary Tree** is to evaluate tree properties by visiting nodes in topological hierarchy (post-order, pre-order, or level-order).

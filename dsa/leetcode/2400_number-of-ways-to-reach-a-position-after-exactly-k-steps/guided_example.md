...
The objective for **Number of Ways to Reach a Position After Exactly k Steps** is to compute the global optimal value by decomposing the problem into overlapping subproblems.

...
- `Users`: Table with columns $\text{user}_{id}$ (int), $\text{user}_{name}$ (varchar), `credit` (int).
- `Transactions`: Table with columns $\text{trans}_{id}$ (int), $\text{paid}_{by}$ (int), $\text{paid}_{to}$ (int), `amount` (int), $\text{transacted}_{on}$ (date).
...
| 4          | Luis       | 800        | No                    |
+------------+------------+------------+-----------------------+
- **Explanation:** Moustafa paid $400 on "2020-08-01" and received $200 on "2020-08-03", credit (100 -400 +200) = -$100

# Guided Example: Search Suggestions System

We trace the logarithmic Array, String, Binary Search, Trie, Sorting, Heap (Priority Queue) search on a representative problem instance.

- **Input:** `{"products": ["mobile", "mouse", "moneypot", "monitor", "mousepad"], "searchWord": "mouse"}`
- **Required output:** `[["mobile", "moneypot", "monitor"], ["mobile", "moneypot", "monitor"], ["mouse", "mousepad"], ["mouse", "mousepad"], ["mouse", "mousepad"]]`
...
The objective for **Search Suggestions System** is to pinpoint the target value or optimal threshold in logarithmic $O(\log N)$ time.

# Guided Example: Maximize Value of Function in a Ball Passing Game
...
The objective for **Maximize Value of Function in a Ball Passing Game** is to compute the global optimal value by decomposing the problem into overlapping subproblems.

# Guided Example: Implement Router

We trace the logarithmic Array, Hash Table, Binary Search, Design, Queue, Ordered Set search on a representative problem instance.
...
- **Required output:** `[null, true, true, false, true, true, [2, 5, 90], true, 1]`
...
The objective for **Implement Router** is to pinpoint the target value or optimal threshold in logarithmic $O(\log N)$ time.

...
- It is guaranteed that the solutions of $f(x, y) = z$ will be in the range $1 \le x, y \le 1000$.

- It is also guaranteed that `f(x, y)` will fit in 32 bit signed integer if $1 \le x, y \le 1000$.
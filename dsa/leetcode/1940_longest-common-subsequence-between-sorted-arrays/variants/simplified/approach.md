# Simplified Approach - Longest Common Subsequence Between Sorted Arrays
...
## Complexity detail
- **Time Complexity**: $O(T+V)$ — Each input element is processed in a bounded number of direct operations.

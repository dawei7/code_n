...
**Input:** <span class="example-io">customers = [1,0,1,2,1,1,7,5], grumpy = [0,1,0,1,0,1,0,1], minutes = 3</span>
...
<div class="example-block">
**Input:** <span class="example-io">customers = [1], grumpy = [0], minutes = 1</span>

...
- If the current element equals $val ^ 1$, increment the corresponding entry in `rightSuffixSum`.
  - Initialize `totalSwapsNeeded` as $\text{rightSuffixSum}[0]$ and `currentSwapCount` to 0.
...
![Slide 1](images/slideshow_approach2_slidingwindowslide1.png)

![Slide 2](images/slideshow_approach2_slidingwindowslide2.png)

![Slide 3](images/slideshow_approach2_slidingwindowslide3.png)

![Slide 4](images/slideshow_approach2_slidingwindowslide4.png)

![Slide 5](images/slideshow_approach2_slidingwindowslide5.png)

![Slide 6](images/slideshow_approach2_slidingwindowslide6.png)

![Slide 7](images/slideshow_approach2_slidingwindowslide7.png)

![Slide 8](images/slideshow_approach2_slidingwindowslide8.png)

![Slide 9](images/slideshow_approach2_slidingwindowslide9.png)

![Slide 10](images/slideshow_approach2_slidingwindowslide10.png)

![Slide 11](images/slideshow_approach2_slidingwindowslide11.png)
...
- Initialize `minimumSwaps` to a large value ($\text{INT}_{MAX}$).

## General
**Optimal Approach — Customers With Strictly Increasing Purchases**

The query executes a structured relational pipeline for **Customers With Strictly Increasing Purchases**. It uses PostgreSQL window functions for analytical ranking and offset calculations, `GROUP BY` aggregation with PostgreSQL standard functions (`COALESCE`, `STRING_AGG`).

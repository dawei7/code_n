...
- There is **exactly one** match per day; the schedule is a list of **consecutive** days and $\text{schedule}[i]$ is the match on day `i`.
...
- **Explanation:** Since each team plays every other team exactly twice, a total of 20 matches need to be played.

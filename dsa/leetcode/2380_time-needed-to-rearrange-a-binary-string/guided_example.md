...
We derive and execute the String, Dynamic Programming, Simulation recurrence on a representative problem instance.
...
The objective for **Time Needed to Rearrange a Binary String** is to compute the global optimal value by decomposing the problem into overlapping subproblems.

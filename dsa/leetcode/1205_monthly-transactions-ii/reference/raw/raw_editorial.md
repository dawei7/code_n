...
Similarly, we can calculate the aggregated totals for chargebacks. In this step, we also rename the transaction month for chargebacks (`month_chargeback`) to `month` for later use. 

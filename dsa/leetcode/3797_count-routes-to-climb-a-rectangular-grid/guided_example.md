# Guided Example: Count Routes to Climb a Rectangular Grid

We derive and execute the Array, Dynamic Programming, Matrix, Prefix Sum recurrence on a representative problem instance.
...
The objective for **Count Routes to Climb a Rectangular Grid** is to compute the global optimal value by decomposing the problem into overlapping subproblems.

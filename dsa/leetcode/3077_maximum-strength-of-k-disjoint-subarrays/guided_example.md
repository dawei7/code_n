# Guided Example: Maximum Strength of K Disjoint Subarrays
...
The objective for **Maximum Strength of K Disjoint Subarrays** is to compute the global optimal value by decomposing the problem into overlapping subproblems.

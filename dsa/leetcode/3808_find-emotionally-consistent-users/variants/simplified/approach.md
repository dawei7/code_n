# Simplified Approach - Find Emotionally Consistent Users
...
## Complexity detail
- **Time Complexity**: $O(R log R + U log U)$ — Each input element is processed in a bounded number of direct operations.
- **Space Complexity**: $O(R + U)$ — Utilizes standard auxiliary storage proportional to the active computation state.

## General
The optimal solution implements an idiomatic, readable, and production-ready approach for **Find Emotionally Consistent Users**.
...
## Complexity detail
- **Time Complexity**: $O(R log R + U log U)$ — Operational efficiency across problem constraints.

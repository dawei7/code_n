## General
The optimal solution implements an idiomatic, readable, and production-ready approach for **Find Cutoff Score for Each School**.
...
## Complexity detail
- **Time Complexity**: $O(SE)$ — Operational efficiency across problem constraints.

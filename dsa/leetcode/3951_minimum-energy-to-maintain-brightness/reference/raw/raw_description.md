...
**Input:** <span class="example-io">n = 5, brightness = 5, intervals = [[6,12]]</span>
...
<div class="example-block">
**Input:** <span class="example-io">n = 2, brightness = 1, intervals = [[0,0],[2,2]]</span>
...
<div class="example-block">
**Input:** <span class="example-io">n = 4, brightness = 2, intervals = [[1,3],[2,4]]</span>

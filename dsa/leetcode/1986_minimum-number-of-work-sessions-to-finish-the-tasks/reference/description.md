...
<ul>
	<li>If you start a task in a work session, you must complete it in the **same** work session.</li>
	<li>You can start a new task **immediately** after finishing the previous one.</li>

...
For each `queries[i]`:
	...
	- Select a <span data-keyword="subset">subset</span> of indices within the range `[l_i, r_i]` in `nums`.
...
**Input:** <span class="example-io">nums = [1,0,1], queries = [[0,2]]</span>
...
<div class="example-block">
**Input:** <span class="example-io">nums = [4,3,2,1], queries = [[1,3],[0,2]]</span>

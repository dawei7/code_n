## General
The optimal solution implements an idiomatic, readable, and production-ready approach for **Product Sales Analysis IV**.
...
## Complexity detail
- **Time Complexity**: $O((s + p) log s)$ — Operational efficiency across problem constraints.

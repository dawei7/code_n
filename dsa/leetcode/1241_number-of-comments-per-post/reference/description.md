...
| 12      | 0                  |
+---------+--------------------+
- **Explanation:** The post with id 1 has three comments in the table with id 3, 4, and 9. The comment with id 3 is repeated in the table, we counted it **only once**.

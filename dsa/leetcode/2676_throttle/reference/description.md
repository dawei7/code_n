...
- **Explanation:** The 1st is called a function with arguments (1) without delay.
...
- $1 \le \text{calls.length} \le 10$

- $0 \le \text{calls}[i].t \le 1000$

- $0 \le \text{calls}[i].\text{inputs}[j], \text{calls}[i].\text{inputs.length} \le 10$

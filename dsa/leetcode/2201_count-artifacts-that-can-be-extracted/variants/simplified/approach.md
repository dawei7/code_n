# Simplified Approach - Count Artifacts That Can Be Extracted
...
## Complexity detail
- **Time Complexity**: $O(a + d)$ — Each input element is processed in a bounded number of direct operations.

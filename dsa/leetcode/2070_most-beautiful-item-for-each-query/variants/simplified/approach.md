# Simplified Approach - Most Beautiful Item for Each Query
...
## Complexity detail
- **Time Complexity**: $O(n\log n+q\log n)$ — Each input element is processed in a bounded number of direct operations.

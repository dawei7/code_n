...
- Add `node` as the immediate parent of `neighbor` to the set $\text{ancestorsSetList}[neighbor]$.
- Add all other ancestors of `node` to the set $\text{ancestorsSetList}[neighbor]$.

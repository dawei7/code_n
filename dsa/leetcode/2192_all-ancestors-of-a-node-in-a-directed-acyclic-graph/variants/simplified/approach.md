# Simplified Approach - All Ancestors of a Node in a Directed Acyclic Graph
...
## Complexity detail
- **Time Complexity**: $O(n^2 + nm)$ — Each input element is processed in a bounded number of direct operations.
- **Space Complexity**: $O(n^2 + m)$ — Utilizes standard auxiliary storage proportional to the active computation state.

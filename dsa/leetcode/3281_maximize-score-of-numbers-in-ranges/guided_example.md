# Guided Example: Maximize Score of Numbers in Ranges
...
The objective for **Maximize Score of Numbers in Ranges** is to pinpoint the target value or optimal threshold in logarithmic $O(\log N)$ time.

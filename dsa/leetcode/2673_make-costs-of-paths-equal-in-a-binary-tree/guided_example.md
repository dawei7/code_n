# Guided Example: Make Costs of Paths Equal in a Binary Tree

We trace the hierarchical Array, Dynamic Programming, Greedy, Tree, Binary Tree traversal and subtree aggregation on a representative binary tree.
...
The objective for **Make Costs of Paths Equal in a Binary Tree** is to evaluate tree properties by visiting nodes in topological hierarchy (post-order, pre-order, or level-order).

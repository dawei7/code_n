# Guided Example: Count Substrings Divisible By Last Digit
...
The objective for **Count Substrings Divisible By Last Digit** is to compute the global optimal value by decomposing the problem into overlapping subproblems.

...
![pic](images/708_two_pointers.png)
...
_The condition is to find the place that meets the constraint of ${\text{prev.val} \le insertVal \le \text{curr.val}}$._
...
![pic](images/708_case_2_1.png)

![pic](images/708_case_2_2.png)
...
The Case 2.1 corresponds to the condition where the value to be inserted is _greater than or equal to_ the one of tail node, _i.e._ ${insertVal \ge \text{prev.val}}$.

The Case 2.2 corresponds to the condition where the value to be inserted is _less than or equal to_ the head node, _i.e._ ${insertVal \le \text{curr.val}}$.

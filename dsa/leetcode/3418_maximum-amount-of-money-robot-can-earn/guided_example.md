# Guided Example: Maximum Amount of Money Robot Can Earn
...
The objective for **Maximum Amount of Money Robot Can Earn** is to compute the global optimal value by decomposing the problem into overlapping subproblems.

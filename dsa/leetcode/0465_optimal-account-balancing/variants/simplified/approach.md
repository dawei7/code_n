# Simplified Approach - Optimal Account Balancing
...
- **Space Complexity**: $O(p + k^2)$ — Utilizes standard auxiliary storage proportional to the active computation state.

# Guided Example: Distinct Points Reachable After Substring Removal

We trace the dynamic Hash Table, String, Sliding Window, Prefix Sum sliding window on a representative input instance.
...
The objective for **Distinct Points Reachable After Substring Removal** is to find the optimal contiguous window without evaluating all $O(N^2)$ candidate subarrays.

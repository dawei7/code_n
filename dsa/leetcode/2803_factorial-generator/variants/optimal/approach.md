...
To Write a generator function that takes an integer `n` as an argument and returns a generator object which yields the **factorial sequence**, the JavaScript solution uses clean ES6+ techniques.

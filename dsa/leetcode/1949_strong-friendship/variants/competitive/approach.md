...
## Complexity detail
- **Time Complexity**: $O(E+W\log W)$ — Operation count proportional to input scale.
- **Space Complexity**: $O(E+W)$ — Auxiliary memory allocation bound.

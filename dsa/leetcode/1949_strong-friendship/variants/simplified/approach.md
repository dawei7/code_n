# Simplified Approach - Strong Friendship
...
## Complexity detail
- **Time Complexity**: $O(E+W\log W)$ — Each input element is processed in a bounded number of direct operations.
- **Space Complexity**: $O(E+W)$ — Utilizes standard auxiliary storage proportional to the active computation state.

...
**Input:** <span class="example-io">chunks = ["hello wor","ld hello"], queries = ["hello","world","wor"]</span>

**Output:** <span class="example-io">[2,1,0]</span>
...
<div class="example-block">
**Input:** <span class="example-io">chunks = ["a-b a--b ","a-","b"], queries = ["a-b","a","b"]</span>

**Output:** <span class="example-io">[2,1,1]</span>
...
<div class="example-block">
**Input:** <span class="example-io">chunks = ["-cat dog- mouse"], queries = ["cat","dog","mouse","cat-dog"]</span>

**Output:** <span class="example-io">[1,1,1,0]</span>

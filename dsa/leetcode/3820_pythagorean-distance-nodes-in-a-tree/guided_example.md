# Guided Example: Pythagorean Distance Nodes in a Tree

We trace the hierarchical Tree, Breadth-First Search traversal and subtree aggregation on a representative binary tree.
...
The objective for **Pythagorean Distance Nodes in a Tree** is to evaluate tree properties by visiting nodes in topological hierarchy (post-order, pre-order, or level-order).

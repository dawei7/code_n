## General
**Competitive Approach — Restaurant Growth**

The query executes a structured relational pipeline for **Restaurant Growth**. It uses Common Table Expressions (CTEs) to isolate intermediate data transformations into modular steps, Relational JOIN operations to correlate records across tables.
...
## Complexity detail
- **Time Complexity**: $O(r+d\log d)$ — Operation count proportional to input scale.

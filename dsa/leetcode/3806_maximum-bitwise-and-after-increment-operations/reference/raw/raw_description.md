...
**Input:** <span class="example-io">nums = [3,1,2], k = 8, m = 2</span>
...
<div class="example-block">
**Input:** <span class="example-io">nums = [1,2,8,4], k = 7, m = 3</span>
...
<div class="example-block">
**Input:** <span class="example-io">nums = [1,1], k = 3, m = 2</span>

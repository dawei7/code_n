# Guided Example: Ways to Split Array Into Good Subarrays

We derive and execute the Array, Math, Dynamic Programming recurrence on a representative problem instance.
...
The objective for **Ways to Split Array Into Good Subarrays** is to compute the global optimal value by decomposing the problem into overlapping subproblems.

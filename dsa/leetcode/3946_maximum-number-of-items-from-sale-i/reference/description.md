...
<ul>
	<li>For each item `i` that you bought **at least one copy** of, you receive **one free copy** of every item `j` such that `j != i` and `factor_i` divides `factor_j`.</li>
	<li>Buying multiple copies of the same item `i` does **not** give additional free copies through item `i`.</li>

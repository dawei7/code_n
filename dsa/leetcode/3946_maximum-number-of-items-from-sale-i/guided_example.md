# Guided Example: Maximum Number of Items From Sale I
...
The objective for **Maximum Number of Items From Sale I** is to compute the global optimal value by decomposing the problem into overlapping subproblems.

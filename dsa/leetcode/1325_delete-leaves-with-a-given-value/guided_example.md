# Guided Example: Delete Leaves With a Given Value
...
- **Required output:** `[1, null, 3, null, 4]`
...
The objective for **Delete Leaves With a Given Value** is to evaluate tree properties by visiting nodes in topological hierarchy (post-order, pre-order, or level-order).

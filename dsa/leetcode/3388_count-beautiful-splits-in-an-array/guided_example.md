# Guided Example: Count Beautiful Splits in an Array
...
The objective for **Count Beautiful Splits in an Array** is to compute the global optimal value by decomposing the problem into overlapping subproblems.

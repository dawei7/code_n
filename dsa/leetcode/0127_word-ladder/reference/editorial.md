...
<center>
<img src="images/Word_Ladder_1.png" width="400"/>
</center>
...
<center>
<img src="images/Word_Ladder_2.png" width="400"/>
</center>
...
4. While the queue has elements, get the front element of the queue. Let's call this word as $\text{current}_{word}$.
5. Find all the generic transformations of the $\text{current}_{word}$ and find out if any of these transformations is also a transformation of other words in the word list. This is achieved by checking the `all_combo_dict`.
6. The list of words we get from `all_combo_dict` are all the words which have a common intermediate state with the $\text{current}_{word}$. These new set of words will be the adjacent nodes/words to $\text{current}_{word}$ and hence added to the queue.
6. Hence, for each word in this list of intermediate words, append $(word, level + 1)$ into the queue where `level` is the level for the $\text{current}_{word}$.
...
<center>
<img src="images/Word_Ladder_3.png" width="600"/>
</center>
...
<center>
<img src="images/Word_Ladder_4_edited.png" width="600"/>
</center>

# Guided Example: Maximum Number of Moves in a Grid
...
The objective for **Maximum Number of Moves in a Grid** is to compute the global optimal value by decomposing the problem into overlapping subproblems.

# Guided Example: Alternating Groups I
...
The objective for **Alternating Groups I** is to find the optimal contiguous window without evaluating all $O(N^2)$ candidate subarrays.

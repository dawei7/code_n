## General
**Competitive Approach — Design Exam Scores Tracker**

The solution implements an direct algorithm tailored for Design Exam Scores Tracker.
...
## Complexity detail
- **Time Complexity**: $O(q log r)$ — Operation count proportional to input scale.

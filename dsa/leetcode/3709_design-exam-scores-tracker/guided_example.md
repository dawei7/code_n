# Guided Example: Design Exam Scores Tracker

We trace the logarithmic Array, Binary Search, Design, Prefix Sum search on a representative problem instance.
...
- **Required output:** `[null, null, 98, null, 98, 197, 0, 99]`
...
The objective for **Design Exam Scores Tracker** is to pinpoint the target value or optimal threshold in logarithmic $O(\log N)$ time.

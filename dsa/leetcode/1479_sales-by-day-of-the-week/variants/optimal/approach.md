## General
The optimal solution implements an idiomatic, readable, and production-ready approach for **Sales by Day of the Week**.
...
## Complexity detail
- **Time Complexity**: $O(I+O+C\log C)$ — Operational efficiency across problem constraints.

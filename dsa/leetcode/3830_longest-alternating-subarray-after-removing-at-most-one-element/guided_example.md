# Guided Example: Longest Alternating Subarray After Removing At Most One Element

We derive and execute the Array, Dynamic Programming, Enumeration recurrence on a representative problem instance.
...
The objective for **Longest Alternating Subarray After Removing At Most One Element** is to compute the global optimal value by decomposing the problem into overlapping subproblems.

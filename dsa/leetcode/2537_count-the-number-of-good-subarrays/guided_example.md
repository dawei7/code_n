# Guided Example: Count the Number of Good Subarrays
...
The objective for **Count the Number of Good Subarrays** is to find the optimal contiguous window without evaluating all $O(N^2)$ candidate subarrays.

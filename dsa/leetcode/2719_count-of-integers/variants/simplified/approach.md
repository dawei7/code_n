# Simplified Approach - Count of Integers
...
## Complexity detail
- **Time Complexity**: $O(L*S)$ — Each input element is processed in a bounded number of direct operations.
- **Space Complexity**: $O(L*S)$ — Utilizes standard auxiliary storage proportional to the active computation state.

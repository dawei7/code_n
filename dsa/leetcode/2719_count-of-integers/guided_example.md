# Guided Example: Count of Integers
...
The objective for **Count of Integers** is to compute the global optimal value by decomposing the problem into overlapping subproblems.

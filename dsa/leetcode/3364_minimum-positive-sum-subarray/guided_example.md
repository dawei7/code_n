# Guided Example: Minimum Positive Sum Subarray 
...
The objective for **Minimum Positive Sum Subarray ** is to find the optimal contiguous window without evaluating all $O(N^2)$ candidate subarrays.

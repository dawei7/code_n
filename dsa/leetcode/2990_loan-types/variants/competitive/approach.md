## General
**Competitive Approach — Loan Types**

The query executes a structured relational pipeline for **Loan Types**. It uses `GROUP BY` aggregation with PostgreSQL standard functions (`COALESCE`, `STRING_AGG`).

# Simplified Approach - The Category of Each Member in the Store
...
## Complexity detail
- **Time Complexity**: $O(M+V+P)$ — Each input element is processed in a bounded number of direct operations.
- **Space Complexity**: $O(M+V+P)$ — Utilizes standard auxiliary storage proportional to the active computation state.

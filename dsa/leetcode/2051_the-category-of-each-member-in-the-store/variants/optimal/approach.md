## General
The optimal solution implements an idiomatic, readable, and production-ready approach for **The Category of Each Member in the Store**.
...
## Complexity detail
- **Time Complexity**: $O(M+V+P)$ — Operational efficiency across problem constraints.

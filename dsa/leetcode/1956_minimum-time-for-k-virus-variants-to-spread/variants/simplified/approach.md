# Simplified Approach - Minimum Time For K Virus Variants to Spread
...
## Complexity detail
- **Time Complexity**: $O(XYN\log N)$ — Each input element is processed in a bounded number of direct operations.

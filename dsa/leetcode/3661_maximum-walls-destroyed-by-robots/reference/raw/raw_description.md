...
**Input:** <span class="example-io">robots = [4], distance = [3], walls = [1,10]</span>
...
<div class="example-block">
**Input:** <span class="example-io">robots = [10,2], distance = [5,1], walls = [5,2,7]</span>
...
<div class="example-block">
**Input:** <span class="example-io">robots = [1,2], distance = [100,1], walls = [10]</span>

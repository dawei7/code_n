# Simplified Approach - Count Number of Rectangles Containing Each Point
...
## Complexity detail
- **Time Complexity**: $O(R log R + P H log R)$ — Each input element is processed in a bounded number of direct operations.
- **Space Complexity**: $O(R + H)$ — Utilizes standard auxiliary storage proportional to the active computation state.

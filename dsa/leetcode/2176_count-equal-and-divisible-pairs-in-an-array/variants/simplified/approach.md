# Simplified Approach - Count Equal and Divisible Pairs in an Array
...
## Complexity detail
- **Time Complexity**: $O(n \sqrt{k})$ — Each input element is processed in a bounded number of direct operations.

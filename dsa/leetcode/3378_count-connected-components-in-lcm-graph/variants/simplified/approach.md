# Simplified Approach - Count Connected Components in LCM Graph
...
## Complexity detail
- **Time Complexity**: $O(n + T log T)$ — Each input element is processed in a bounded number of direct operations.

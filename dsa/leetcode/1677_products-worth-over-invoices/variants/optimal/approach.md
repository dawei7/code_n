## General
The optimal solution implements an idiomatic, readable, and production-ready approach for **Product's Worth Over Invoices**.
...
## Complexity detail
- **Time Complexity**: $O(I + P \log P)$ — Operational efficiency across problem constraints.

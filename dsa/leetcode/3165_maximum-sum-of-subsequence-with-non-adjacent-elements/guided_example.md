# Guided Example: Maximum Sum of Subsequence With Non-adjacent Elements

We derive and execute the Array, Divide and Conquer, Dynamic Programming, Segment Tree recurrence on a representative problem instance.
...
The objective for **Maximum Sum of Subsequence With Non-adjacent Elements** is to compute the global optimal value by decomposing the problem into overlapping subproblems.

# Simplified Approach - Kth Smallest Number in Multiplication Table
...
## Complexity detail
- **Time Complexity**: $O(\min(M, N) \log(MN))$ — Each input element is processed in a bounded number of direct operations.

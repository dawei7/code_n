# Guided Example: Find a Corresponding Node of a Binary Tree in a Clone of That Tree
...
- **Input:** `{"original": {"tree": [7, 4, 3, null, null, 6, 19], "target_index": 2}, "cloned": {"clone_of": "original"}, "target": {"target_of": "original"}}`
- **Required output:** `[3, 6, 19]`
...
The objective for **Find a Corresponding Node of a Binary Tree in a Clone of That Tree** is to evaluate tree properties by visiting nodes in topological hierarchy (post-order, pre-order, or level-order).

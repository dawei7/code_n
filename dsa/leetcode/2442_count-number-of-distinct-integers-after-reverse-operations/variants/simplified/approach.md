# Simplified Approach - Count Number of Distinct Integers After Reverse Operations
...
## Complexity detail
- **Time Complexity**: $O(n D)$ — Each input element is processed in a bounded number of direct operations.

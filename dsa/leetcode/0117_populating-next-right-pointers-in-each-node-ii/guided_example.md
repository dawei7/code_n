...
- **Required output:** `[1, 2, 3, 4, 5, null, 7]`
...
The objective for **Populating Next Right Pointers in Each Node II** is to transform the linked structure by strictly updating `next` references in place.

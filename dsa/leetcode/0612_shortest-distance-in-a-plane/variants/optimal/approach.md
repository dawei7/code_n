## General
The optimal solution implements an idiomatic, readable, and production-ready approach for **Shortest Distance in a Plane**.
...
## Complexity detail
- **Time Complexity**: $O(P^2)$ — Operational efficiency across problem constraints.

## General
**Competitive Approach — Shortest Distance in a Plane**

The query executes a structured relational pipeline for **Shortest Distance in a Plane**. It uses Relational JOIN operations to correlate records across tables.
...
## Complexity detail
- **Time Complexity**: $O(P^2)$ — Operation count proportional to input scale.

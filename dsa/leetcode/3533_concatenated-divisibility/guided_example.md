# Guided Example: Concatenated Divisibility
...
The objective for **Concatenated Divisibility** is to compute the global optimal value by decomposing the problem into overlapping subproblems.

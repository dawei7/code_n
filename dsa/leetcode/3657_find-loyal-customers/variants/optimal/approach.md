## General
The optimal solution implements an idiomatic, readable, and production-ready approach for **Find Loyal Customers**.
...
## Complexity detail
- **Time Complexity**: $O(N log N + C log C)$ — Operational efficiency across problem constraints.

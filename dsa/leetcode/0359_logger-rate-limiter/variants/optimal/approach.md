## General
**Optimal Approach — Logger Rate Limiter**

The solution implements an direct algorithm tailored for Logger Rate Limiter. It utilizes Hash Map / Dictionary for $O(1)$ average lookup and frequency tracking to maintain optimal runtime bounds.

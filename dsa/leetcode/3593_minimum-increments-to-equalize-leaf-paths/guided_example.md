# Guided Example: Minimum Increments to Equalize Leaf Paths
...
The objective for **Minimum Increments to Equalize Leaf Paths** is to evaluate tree properties by visiting nodes in topological hierarchy (post-order, pre-order, or level-order).

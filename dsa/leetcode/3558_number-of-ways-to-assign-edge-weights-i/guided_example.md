# Guided Example: Number of Ways to Assign Edge Weights I

We trace the hierarchical Math, Tree, Depth-First Search traversal and subtree aggregation on a representative binary tree.
...
The objective for **Number of Ways to Assign Edge Weights I** is to evaluate tree properties by visiting nodes in topological hierarchy (post-order, pre-order, or level-order).

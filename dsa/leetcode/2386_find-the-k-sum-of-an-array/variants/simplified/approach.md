# Simplified Approach - Find the K-Sum of an Array
...
## Complexity detail
- **Time Complexity**: $O(n log n + k log k)$ — Each input element is processed in a bounded number of direct operations.

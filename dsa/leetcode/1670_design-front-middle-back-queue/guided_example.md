...
We execute the single-pass Array, Linked List, Design, Queue, Doubly-Linked List, Data Stream pointer manipulation on a representative linked list instance.
...
- **Required output:** `[null, null, null, null, null, 1, 3, 4, 2, -1]`
...
The objective for **Design Front Middle Back Queue** is to transform the linked structure by strictly updating `next` references in place.

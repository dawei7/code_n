# Simplified Approach - Count Number of Possible Root Nodes
...
## Complexity detail
- **Time Complexity**: $O(n + g)$ — Each input element is processed in a bounded number of direct operations.
- **Space Complexity**: $O(n + g)$ — Utilizes standard auxiliary storage proportional to the active computation state.

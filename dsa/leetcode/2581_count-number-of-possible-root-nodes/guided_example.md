# Guided Example: Count Number of Possible Root Nodes

We trace the hierarchical Array, Hash Table, Dynamic Programming, Tree, Depth-First Search traversal and subtree aggregation on a representative binary tree.
...
The objective for **Count Number of Possible Root Nodes** is to evaluate tree properties by visiting nodes in topological hierarchy (post-order, pre-order, or level-order).

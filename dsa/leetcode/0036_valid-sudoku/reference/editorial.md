...
For instance, in example 1 from the problem description, for $\text{board}[2][1] = 9$, we need to check the following conditions.

![example_1](images/Example_1.jpg)

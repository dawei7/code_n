# Simplified Approach - Number of Beautiful Integers in the Range
...
## Complexity detail
- **Time Complexity**: $O(D^2 k)$ — Each input element is processed in a bounded number of direct operations.
- **Space Complexity**: $O(D^2 k)$ — Utilizes standard auxiliary storage proportional to the active computation state.

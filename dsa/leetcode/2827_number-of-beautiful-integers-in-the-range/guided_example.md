# Guided Example: Number of Beautiful Integers in the Range
...
The objective for **Number of Beautiful Integers in the Range** is to compute the global optimal value by decomposing the problem into overlapping subproblems.

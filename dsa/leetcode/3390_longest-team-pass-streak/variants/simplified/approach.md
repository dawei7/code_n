# Simplified Approach - Longest Team Pass Streak
...
## Complexity detail
- **Time Complexity**: $O(p log p + p log t)$ — Each input element is processed in a bounded number of direct operations.

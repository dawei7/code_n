## General
The optimal solution implements an idiomatic, readable, and production-ready approach for **Longest Team Pass Streak**.
...
## Complexity detail
- **Time Complexity**: $O(p log p + p log t)$ — Operational efficiency across problem constraints.

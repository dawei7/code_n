# Simplified Approach - Subsequence Sum After Capping Elements
...
## Complexity detail
- **Time Complexity**: $O(nk + k log n)$ — Each input element is processed in a bounded number of direct operations.

...
For each integer `x` from 1 to `n`, determine whether it is possible to choose a **<span data-keyword="subsequence-array-nonempty">subsequence</span>** from the array capped by `x` such that the sum of the chosen elements is **exactly** `k`.
...
**Input:** <span class="example-io">nums = [4,3,2,4], k = 5</span>

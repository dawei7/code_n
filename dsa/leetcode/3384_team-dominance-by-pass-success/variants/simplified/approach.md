# Simplified Approach - Team Dominance by Pass Success
...
## Complexity detail
- **Time Complexity**: $O(p log t + g log g)$ — Each input element is processed in a bounded number of direct operations.

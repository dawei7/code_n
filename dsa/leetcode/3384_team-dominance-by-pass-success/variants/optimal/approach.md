## General
The optimal solution implements an idiomatic, readable, and production-ready approach for **Team Dominance by Pass Success**.
...
## Complexity detail
- **Time Complexity**: $O(p log t + g log g)$ — Operational efficiency across problem constraints.

# Guided Example: Maximum Energy Boost From Two Drinks
...
The objective for **Maximum Energy Boost From Two Drinks** is to compute the global optimal value by decomposing the problem into overlapping subproblems.

...
<center>
<img src="images/86_Partition_List_1.png" width="700"/>
</center>
...
where you don't initialize with a dummy node and see it yourself!
    ...
    <center>
    <img src="images/86_Partition_List_2.png" width="400"/>
    </center>
...
be part of the `before` list. So we move it to `before` list.
    ...
    <center>
    <img src="images/86_Partition_List_3.png" width="700"/>
    </center>

4. Else, the node should be part of `after` list. So we move it to `after` list.

    <center>
    <img src="images/86_Partition_List_4.png" width="700"/>
    </center>
...
`before` list or `after` list, depending on its value.
    ...
    <center>
    <img src="images/86_Partition_List_5.png" width="700"/>
    </center>
...
6. Now, these two lists `before` and `after` can be combined to form the reformed list.
    ...
    <center>
    <img src="images/86_Partition_List_6.png" width="700"/>
    </center>

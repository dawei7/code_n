# Simplified Approach - Count Ways to Make Array With Product
...
## Complexity detail
- **Time Complexity**: $O(Q\sqrt{K})$ — Each input element is processed in a bounded number of direct operations.

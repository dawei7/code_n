# Guided Example: Maximum Total Value

We trace the logarithmic Array, Math, Binary Search, Greedy search on a representative problem instance.
...
The objective for **Maximum Total Value** is to pinpoint the target value or optimal threshold in logarithmic $O(\log N)$ time.

...
**Input:** <span class="example-io">target = 12, position = [10,8,0,5,3], speed = [2,4,1,1,3]</span>
...
<div class="example-block">
**Input:** <span class="example-io">target = 10, position = [3], speed = [3]</span>
...
<div class="example-block">
**Input:** <span class="example-io">target = 100, position = [0,2,4], speed = [4,2,1]</span>

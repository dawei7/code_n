## General
**Competitive Approach — Percentage of Users Attended a Contest**

The query executes a structured relational pipeline for **Percentage of Users Attended a Contest**. It uses `GROUP BY` aggregation with PostgreSQL standard functions (`COALESCE`, `STRING_AGG`).
...
## Complexity detail
- **Time Complexity**: $O(u+r+c\log c)$ — Operation count proportional to input scale.

# Simplified Approach - Percentage of Users Attended a Contest
...
## Complexity detail
- **Time Complexity**: $O(u+r+c\log c)$ — Each input element is processed in a bounded number of direct operations.

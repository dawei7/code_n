## General
The optimal solution implements an idiomatic, readable, and production-ready approach for **Percentage of Users Attended a Contest**.
...
## Complexity detail
- **Time Complexity**: $O(u+r+c\log c)$ — Operational efficiency across problem constraints.

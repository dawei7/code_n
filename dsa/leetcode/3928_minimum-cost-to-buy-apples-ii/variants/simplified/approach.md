# Simplified Approach - Minimum Cost to Buy Apples II
...
## Complexity detail
- **Time Complexity**: $O(n log n (n + m))$ — Each input element is processed in a bounded number of direct operations.

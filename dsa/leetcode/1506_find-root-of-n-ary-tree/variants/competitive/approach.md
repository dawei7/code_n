...
The core task in **Find Root of N-Ary Tree** is to all the nodes of an **<a href="https://leetcode.com/explore/learn/card/n-ary-tree/">N-ary tree</a>** as an array of `Node` objects, where each node has a **unique value**. The algorithm processes the input using a single-pass linear iteration, maintaining state variables that update as each element is inspected to produce the result cleanly.

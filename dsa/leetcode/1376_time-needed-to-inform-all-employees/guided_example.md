# Guided Example: Time Needed to Inform All Employees
...
The objective for **Time Needed to Inform All Employees** is to evaluate tree properties by visiting nodes in topological hierarchy (post-order, pre-order, or level-order).

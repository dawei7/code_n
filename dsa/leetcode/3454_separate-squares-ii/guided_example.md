# Guided Example: Separate Squares II

We trace the logarithmic Array, Binary Search, Segment Tree, Sweep Line search on a representative problem instance.
...
The objective for **Separate Squares II** is to pinpoint the target value or optimal threshold in logarithmic $O(\log N)$ time.

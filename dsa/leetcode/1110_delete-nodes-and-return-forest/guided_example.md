...
We trace the hierarchical Array, Hash Table, Tree, Depth-First Search, Binary Tree traversal and subtree aggregation on a representative binary tree.

- **Input:** `{"root": [1, 2, 3, 4, 5, 6, 7], "to_delete": [3, 5]}`
- **Required output:** `[[1, 2, null, 4], [6], [7]]`
...
The objective for **Delete Nodes And Return Forest** is to evaluate tree properties by visiting nodes in topological hierarchy (post-order, pre-order, or level-order).

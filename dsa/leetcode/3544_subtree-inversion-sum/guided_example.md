# Guided Example: Subtree Inversion Sum
...
The objective for **Subtree Inversion Sum** is to evaluate tree properties by visiting nodes in topological hierarchy (post-order, pre-order, or level-order).

# Simplified Approach - Painting a Grid With Three Different Colors
...
## Complexity detail
- **Time Complexity**: $O(NS^2)$ — Each input element is processed in a bounded number of direct operations.
- **Space Complexity**: $O(S^2)$ — Utilizes standard auxiliary storage proportional to the active computation state.

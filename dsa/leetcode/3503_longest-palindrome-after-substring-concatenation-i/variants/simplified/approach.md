# Simplified Approach - Longest Palindrome After Substring Concatenation I
...
## Complexity detail
- **Time Complexity**: $O(n^2 + m^2 + nm)$ — Each input element is processed in a bounded number of direct operations.

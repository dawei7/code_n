## General
**Optimal Approach — My Calendar I**

The solution implements an direct algorithm tailored for My Calendar I. It utilizes Hash Map / Dictionary for $O(1)$ average lookup and frequency tracking to maintain optimal runtime bounds.

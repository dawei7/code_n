# Simplified Approach - Split and Merge Array Transformation
...
## Complexity detail
- **Time Complexity**: $O(n! * n^4)$ — Each input element is processed in a bounded number of direct operations.
- **Space Complexity**: $O(n! * n)$ — Utilizes standard auxiliary storage proportional to the active computation state.

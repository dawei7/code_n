# Guided Example: Number of Self-Divisible Permutations

We derive and execute the Array, Math, Dynamic Programming, Backtracking, Bit Manipulation, Number Theory, Bitmask recurrence on a representative problem instance.
...
The objective for **Number of Self-Divisible Permutations** is to compute the global optimal value by decomposing the problem into overlapping subproblems.

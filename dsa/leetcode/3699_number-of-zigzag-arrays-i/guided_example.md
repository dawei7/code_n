# Guided Example: Number of ZigZag Arrays I
...
The objective for **Number of ZigZag Arrays I** is to compute the global optimal value by decomposing the problem into overlapping subproblems.

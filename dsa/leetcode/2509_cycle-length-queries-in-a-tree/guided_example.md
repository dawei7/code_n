# Guided Example: Cycle Length Queries in a Tree

We trace the hierarchical Array, Tree, Binary Tree traversal and subtree aggregation on a representative binary tree.

- **Input:** `{"n": 3, "queries": [[5, 3], [4, 7], [2, 3]]}`
- **Required output:** `[4, 5, 3]`
...
The objective for **Cycle Length Queries in a Tree** is to evaluate tree properties by visiting nodes in topological hierarchy (post-order, pre-order, or level-order).

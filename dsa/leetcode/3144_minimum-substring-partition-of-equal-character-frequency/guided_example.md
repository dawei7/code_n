# Guided Example: Minimum Substring Partition of Equal Character Frequency

We derive and execute the Hash Table, String, Dynamic Programming, Counting recurrence on a representative problem instance.
...
The objective for **Minimum Substring Partition of Equal Character Frequency** is to compute the global optimal value by decomposing the problem into overlapping subproblems.

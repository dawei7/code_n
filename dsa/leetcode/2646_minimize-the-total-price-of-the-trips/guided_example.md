# Guided Example: Minimize the Total Price of the Trips

We trace the hierarchical Array, Dynamic Programming, Tree, Depth-First Search, Graph Theory traversal and subtree aggregation on a representative binary tree.
...
The objective for **Minimize the Total Price of the Trips** is to evaluate tree properties by visiting nodes in topological hierarchy (post-order, pre-order, or level-order).

...
**Input:** <span class="example-io">nums = [2, 2, 1], m = 4</span>
...
<div class="example-block">
**Input:** <span class="example-io">nums = [2, 1, 3], m = 5</span>
...
<div class="example-block">
**Input:** <span class="example-io">nums = [2, 3, 3, 2, 3], m = 6</span>

**Output:** <span class="example-io">true</span>

**Explanation:**

	- <span class="example-io">Split `[2, 3, 3, 2, 3]` to `[2]` and `[3, 3, 2, 3]`.</span>

	- <span class="example-io">Split `[3, 3, 2, 3]` to `[3, 3, 2]` and `[3]`.</span>

	- <span class="example-io">Split `[3, 3, 2]` to `[3, 3]` and `[2]`.</span>

	- <span class="example-io">Split `[3, 3]` to `[3]` and `[3]`.</span>

# Guided Example: Check if it is Possible to Split Array
...
The objective for **Check if it is Possible to Split Array** is to compute the global optimal value by decomposing the problem into overlapping subproblems.

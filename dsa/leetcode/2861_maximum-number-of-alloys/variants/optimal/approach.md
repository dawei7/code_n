## General
**Optimal Approach — Maximum Number of Alloys**
...
Sourced from `doocs/leetcode` (or refined to expert standard) in method `maxNumberOfAlloys`. This implementation is chosen for its exceptional readability, idiomatic Python 3 constructs, and clear structural separation of concerns suitable for technical software engineering interviews.

## Complexity detail
- **Time Complexity**: $O(kn log M)$ — Operation count proportional to input scale.

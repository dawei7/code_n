## General
The optimal solution implements an idiomatic, readable, and production-ready approach for **List the Products Ordered in a Period**.
...
## Complexity detail
- **Time Complexity**: $O(p+o+k\log k)$ — Operational efficiency across problem constraints.

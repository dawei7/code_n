...
We derive and execute the Array, Divide and Conquer, Dynamic Programming recurrence on a representative problem instance.
...
The objective for **Maximum Subarray** is to compute the global optimal value by decomposing the problem into overlapping subproblems.

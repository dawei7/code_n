# Guided Example: Maximum Total Value of Covered Indices
...
The objective for **Maximum Total Value of Covered Indices** is to compute the global optimal value by decomposing the problem into overlapping subproblems.

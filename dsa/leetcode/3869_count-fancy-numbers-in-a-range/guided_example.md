# Guided Example: Count Fancy Numbers in a Range
...
The objective for **Count Fancy Numbers in a Range** is to compute the global optimal value by decomposing the problem into overlapping subproblems.

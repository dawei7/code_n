...
def solve(l: int, r: int) -> int:
    ...
    def count_sum_good(bound: int) -> int:
        ...
        def digit_dp(index: int, tight: bool, digit_sum: int) -> int:
            ...
            for digit in range(limit + 1):
                total += digit_dp(index + 1, tight and digit == limit, digit_sum + digit)
            return total
    ...
    return count_sum_good(r) - count_sum_good(l - 1) + count_in_range(ordered_good) - count_in_range(ordered_overlap)

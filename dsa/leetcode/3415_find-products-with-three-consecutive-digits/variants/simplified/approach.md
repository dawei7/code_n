# Simplified Approach - Find Products with Three Consecutive Digits 
...
## Complexity detail
- **Time Complexity**: $O(S + n log n)$ — Each input element is processed in a bounded number of direct operations.

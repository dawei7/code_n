...
You are given an array `nums`. An array is considered **positive** if the sum of all numbers in each **<span data-keyword="subarray">subarray</span>** with **more than two** elements is positive.
...
**Input:** <span class="example-io">nums = [-10,15,-12]</span>
...
<div class="example-block">
**Input:** <span class="example-io">nums = [-1,-2,3,-1,2,6]</span>

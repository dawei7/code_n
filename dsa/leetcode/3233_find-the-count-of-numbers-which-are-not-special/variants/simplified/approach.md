# Simplified Approach - Find the Count of Numbers Which Are Not Special
...
## Complexity detail
- **Time Complexity**: $O(sqrt(r) log log sqrt(r))$ — Each input element is processed in a bounded number of direct operations.
- **Space Complexity**: $O(sqrt(r))$ — Utilizes standard auxiliary storage proportional to the active computation state.

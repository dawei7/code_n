# Simplified Approach - Calculate Orders Within Each Interval
...
## Complexity detail
- **Time Complexity**: $O(M + I log I)$ — Each input element is processed in a bounded number of direct operations.
- **Space Complexity**: $O(I)$ — Utilizes standard auxiliary storage proportional to the active computation state.

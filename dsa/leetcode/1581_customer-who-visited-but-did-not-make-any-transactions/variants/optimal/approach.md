## General
**Optimal Approach — Customer Who Visited but Did Not Make Any Transactions**

The query executes a structured relational pipeline for **Customer Who Visited but Did Not Make Any Transactions**. It uses `GROUP BY` aggregation with PostgreSQL standard functions (`COALESCE`, `STRING_AGG`).

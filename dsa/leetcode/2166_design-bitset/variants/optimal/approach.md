## General
**Optimal Approach — Design Bitset**

The solution implements an direct algorithm tailored for Design Bitset.
...
## Complexity detail
- **Time Complexity**: $O(Q + n)$ — Operation count proportional to input scale.

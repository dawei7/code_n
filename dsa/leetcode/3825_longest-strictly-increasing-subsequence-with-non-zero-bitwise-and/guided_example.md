# Guided Example: Longest Strictly Increasing Subsequence With Non-Zero Bitwise AND

We trace the logarithmic Array, Binary Search, Bit Manipulation, Enumeration search on a representative problem instance.
...
The objective for **Longest Strictly Increasing Subsequence With Non-Zero Bitwise AND** is to pinpoint the target value or optimal threshold in logarithmic $O(\log N)$ time.

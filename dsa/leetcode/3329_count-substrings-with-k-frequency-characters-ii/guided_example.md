# Guided Example: Count Substrings With K-Frequency Characters II
...
The objective for **Count Substrings With K-Frequency Characters II** is to find the optimal contiguous window without evaluating all $O(N^2)$ candidate subarrays.

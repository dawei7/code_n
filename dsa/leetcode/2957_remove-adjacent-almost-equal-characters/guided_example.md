# Guided Example: Remove Adjacent Almost-Equal Characters
...
The objective for **Remove Adjacent Almost-Equal Characters** is to compute the global optimal value by decomposing the problem into overlapping subproblems.

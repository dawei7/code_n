...
**Input:** <span class="example-io">nums = [1,2,3], forbidden = [3,2,1]</span>
...
<div class="example-block">
**Input:** <span class="example-io">nums = [4,6,6,5], forbidden = [4,6,5,5]</span>
...
<div class="example-block">
**Input:** <span class="example-io">nums = [7,7], forbidden = [8,7]</span>

**Output:** <span class="example-io">-1</span>

**Explanation:**

It is not possible to make `nums[i]` different from `forbidden[i]` for all indices.</div>

**Example 4:**

<div class="example-block">
**Input:** <span class="example-io">nums = [1,2], forbidden = [2,1]</span>

# Guided Example: Median of a Binary Search Tree Level

We trace the hierarchical Tree, Depth-First Search, Breadth-First Search, Binary Search Tree, Binary Tree traversal and subtree aggregation on a representative binary tree.
...
The objective for **Median of a Binary Search Tree Level** is to evaluate tree properties by visiting nodes in topological hierarchy (post-order, pre-order, or level-order).

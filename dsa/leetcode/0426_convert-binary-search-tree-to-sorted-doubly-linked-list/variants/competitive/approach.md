## General
**Competitive Approach — Convert Binary Search Tree to Sorted Doubly Linked List**

The solution implements an direct algorithm tailored for Convert Binary Search Tree to Sorted Doubly Linked List. It utilizes Hash Map / Dictionary for $O(1)$ average lookup and frequency tracking to maintain optimal runtime bounds.

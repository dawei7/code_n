...
To an integer array `arr` and a mapping function `fn`, return a new array with a transformation applied to each element, the JavaScript solution uses clean ES6+ techniques.

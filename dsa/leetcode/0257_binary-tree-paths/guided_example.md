...
We trace the hierarchical String, Backtracking, Tree, Depth-First Search, Binary Tree traversal and subtree aggregation on a representative binary tree.

- **Input:** `{"root": [1, 2, 3, null, 5]}`
- **Required output:** `["1->2->5", "1->3"]`
...
The objective for **Binary Tree Paths** is to evaluate tree properties by visiting nodes in topological hierarchy (post-order, pre-order, or level-order).

...
The objective for **Amount of Time for Binary Tree to Be Infected** is to evaluate tree properties by visiting nodes in topological hierarchy (post-order, pre-order, or level-order).

# Simplified Approach - Mark Elements on Array by Performing Queries
...
## Complexity detail
- **Time Complexity**: $O(n log n + m)$ — Each input element is processed in a bounded number of direct operations.

"""App-local reference solution for LeetCode 1830."""
...
def solve(s: str) -> int:
    ...
    for frequency in frequencies:
        denominator_inverse = denominator_inverse * inverse_factorial[frequency] % modulus
    ...
    for index, character in enumerate(s):
        ...
        operations += smaller * factorial[remaining - 1] % modulus * denominator_inverse
        operations %= modulus

        frequency = frequencies[character_index]
        denominator_inverse = denominator_inverse * frequency % modulus

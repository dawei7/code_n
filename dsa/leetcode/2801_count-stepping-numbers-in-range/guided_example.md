# Guided Example: Count Stepping Numbers in Range
...
The objective for **Count Stepping Numbers in Range** is to compute the global optimal value by decomposing the problem into overlapping subproblems.

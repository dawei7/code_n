# Simplified Approach - Apply Substitutions
...
## Complexity detail
- **Time Complexity**: $O(L + E)$ — Each input element is processed in a bounded number of direct operations.
- **Space Complexity**: $O(E + k)$ — Utilizes standard auxiliary storage proportional to the active computation state.

...
**Input:** <span class="example-io">replacements = [["A","abc"],["B","def"]], text = "%A%_%B%"</span>

**Output:** <span class="example-io">"abc_def"</span>
...
<div class="example-block">
**Input:** <span class="example-io">replacements = [["A","bce"],["B","ace"],["C","abc%B%"]], text = "%A%_%B%_%C%"</span>

**Output:** <span class="example-io">"bce_ace_abcace"</span>

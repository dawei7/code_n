# Guided Example: Extract Kth Character From The Rope Tree
...
- **Input:** `{"root": {"len": 10, "val": "", "left": {"len": 4, "val": "", "left": {"len": 0, "val": "g", "left": null, "right": null}, "right": {"len": 0, "val": "rta", "left": null, "right": null}}, "right": {"len": 0, "val": "abcpoe", "left": null, "right": null}}, "k": 6}`
- **Required output:** `"b"`
...
The objective for **Extract Kth Character From The Rope Tree** is to evaluate tree properties by visiting nodes in topological hierarchy (post-order, pre-order, or level-order).

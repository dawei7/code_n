# Guided Example: Closest Nodes Queries in a Binary Search Tree

We trace the logarithmic Array, Binary Search, Tree, Depth-First Search, Binary Search Tree, Binary Tree search on a representative problem instance.

- **Input:** `{"root": [6, 2, 13, 1, 4, 9, 15, null, null, null, null, null, null, 14], "queries": [2, 5, 16]}`
- **Required output:** `[[2, 2], [4, 6], [15, -1]]`
...
The objective for **Closest Nodes Queries in a Binary Search Tree** is to pinpoint the target value or optimal threshold in logarithmic $O(\log N)$ time.

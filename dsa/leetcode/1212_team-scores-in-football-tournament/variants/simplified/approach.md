# Simplified Approach - Team Scores in Football Tournament
...
## Complexity detail
- **Time Complexity**: $O(t+m)$ — Each input element is processed in a bounded number of direct operations.
- **Space Complexity**: $O(t+m)$ — Utilizes standard auxiliary storage proportional to the active computation state.

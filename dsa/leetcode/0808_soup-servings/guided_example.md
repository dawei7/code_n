...
We derive and execute the Math, Dynamic Programming, Probability and Statistics recurrence on a representative problem instance.
...
The objective for **Soup Servings** is to compute the global optimal value by decomposing the problem into overlapping subproblems.

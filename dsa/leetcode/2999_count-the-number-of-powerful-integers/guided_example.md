# Guided Example: Count the Number of Powerful Integers
...
The objective for **Count the Number of Powerful Integers** is to compute the global optimal value by decomposing the problem into overlapping subproblems.

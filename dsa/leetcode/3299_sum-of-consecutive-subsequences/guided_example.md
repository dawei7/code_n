# Guided Example: Sum of Consecutive Subsequences
...
The objective for **Sum of Consecutive Subsequences** is to compute the global optimal value by decomposing the problem into overlapping subproblems.

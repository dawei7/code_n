# Guided Example: Find the Level of Tree with Minimum Sum
...
The objective for **Find the Level of Tree with Minimum Sum** is to evaluate tree properties by visiting nodes in topological hierarchy (post-order, pre-order, or level-order).

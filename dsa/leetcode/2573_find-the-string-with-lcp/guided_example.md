...
We derive and execute the Array, String, Dynamic Programming, Greedy, Union-Find, Matrix recurrence on a representative problem instance.
...
The objective for **Find the String with LCP** is to compute the global optimal value by decomposing the problem into overlapping subproblems.

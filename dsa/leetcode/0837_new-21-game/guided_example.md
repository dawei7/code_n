...
We trace the dynamic Math, Dynamic Programming, Sliding Window, Probability and Statistics sliding window on a representative input instance.
...
The objective for **New 21 Game** is to find the optimal contiguous window without evaluating all $O(N^2)$ candidate subarrays.

# Guided Example: Maximum Strong Pair XOR II

We trace the dynamic Array, Hash Table, Bit Manipulation, Trie, Sliding Window sliding window on a representative input instance.
...
The objective for **Maximum Strong Pair XOR II** is to find the optimal contiguous window without evaluating all $O(N^2)$ candidate subarrays.

## General
**Competitive Approach — Unique Substrings With Equal Digit Frequency**
...
Sourced from `kamyu104/LeetCode-Solutions`. This implementation focuses on raw computational throughput in method `equalDigitFrequency`. It minimizes object instantiation overhead, avoids redundant memory passes, and leverages compact iteration loops.

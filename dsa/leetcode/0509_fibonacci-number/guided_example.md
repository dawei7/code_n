...
We derive and execute the Math, Dynamic Programming, Recursion, Memoization recurrence on a representative problem instance.
...
The objective for **Fibonacci Number** is to compute the global optimal value by decomposing the problem into overlapping subproblems.

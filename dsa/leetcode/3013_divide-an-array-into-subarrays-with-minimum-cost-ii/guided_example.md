# Guided Example: Divide an Array Into Subarrays With Minimum Cost II

We trace the dynamic Array, Hash Table, Sliding Window, Heap (Priority Queue) sliding window on a representative input instance.
...
The objective for **Divide an Array Into Subarrays With Minimum Cost II** is to find the optimal contiguous window without evaluating all $O(N^2)$ candidate subarrays.

...
- **Required output:** `[4, 5, 2, null, null, 3, 1]`
...
The objective for **Binary Tree Upside Down** is to evaluate tree properties by visiting nodes in topological hierarchy (post-order, pre-order, or level-order).

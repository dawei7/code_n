# Simplified Approach - Construct Target Array With Multiple Sums
...
## Complexity detail
- **Time Complexity**: $O(n \log n \log M)$ — Each input element is processed in a bounded number of direct operations.

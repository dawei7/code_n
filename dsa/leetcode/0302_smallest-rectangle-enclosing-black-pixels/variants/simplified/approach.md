# Simplified Approach - Smallest Rectangle Enclosing Black Pixels
...
## Complexity detail
- **Time Complexity**: $O(m \log n + n \log m)$ — Each input element is processed in a bounded number of direct operations.

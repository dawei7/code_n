...
<center>
<img src="images/282_Expression_Add_Operators_Diag_1.png" height="300"></center>
...
3. At every step, we have exactly 4 different recursive calls. The `NO OP` call simply extends the $\text{current}_{operand}$ by the current digit and moves ahead. Rest of the recursive calls correspond to `+`, `-`, and `*`.
...
<center>
<img src="images/282_Expression_Add_Operators_Diag_2.png" width="550"></center>

So far so good. Now let us add the `*` operator as well and see how building the expression on the fly like this breaks.

<center>
<img src="images/282_Expression_Add_Operators_Diag_3.png" width="550"></center>
...
<center>
<img src="images/282_Expression_Add_Operators_Diag_4.png" width="550"></center>

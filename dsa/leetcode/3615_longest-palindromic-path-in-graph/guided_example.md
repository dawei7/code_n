# Guided Example: Longest Palindromic Path in Graph

We derive and execute the String, Dynamic Programming, Bit Manipulation, Graph Theory, Bitmask recurrence on a representative problem instance.
...
The objective for **Longest Palindromic Path in Graph** is to compute the global optimal value by decomposing the problem into overlapping subproblems.

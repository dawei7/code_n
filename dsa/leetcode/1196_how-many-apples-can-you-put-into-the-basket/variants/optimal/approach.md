...
The core task in **How Many Apples Can You Put into the Basket** is to You have some apples and a basket that can carry up to `5000` units of weight. The algorithm processes the input using a single-pass linear iteration, maintaining state variables that update as each element is inspected to produce the result cleanly.

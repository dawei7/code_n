# Simplified Approach - Minimum Non-Zero Product of the Array Elements
...
## Complexity detail
- **Time Complexity**: $O(p)$ — Each input element is processed in a bounded number of direct operations.

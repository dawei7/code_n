# Simplified Approach - Triples with Bitwise AND Equal To Zero
...
## Complexity detail
- **Time Complexity**: $O(N^2+DU)$ — Each input element is processed in a bounded number of direct operations.

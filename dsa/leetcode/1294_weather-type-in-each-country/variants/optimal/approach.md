## General
The optimal solution implements an idiomatic, readable, and production-ready approach for **Weather Type in Each Country**.
...
## Complexity detail
- **Time Complexity**: $O(C+W)$ — Operational efficiency across problem constraints.

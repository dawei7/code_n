# Guided Example: Maximum Score Using Exactly K Pairs
...
The objective for **Maximum Score Using Exactly K Pairs** is to compute the global optimal value by decomposing the problem into overlapping subproblems.

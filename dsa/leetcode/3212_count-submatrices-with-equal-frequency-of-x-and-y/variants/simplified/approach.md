# Simplified Approach - Count Submatrices With Equal Frequency of X and Y
...
## Complexity detail
- **Time Complexity**: $O(r c)$ — Each input element is processed in a bounded number of direct operations.

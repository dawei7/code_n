...
We trace the dynamic Array, Math, Two Pointers, Dynamic Programming, Sliding Window sliding window on a representative input instance.
...
The objective for **Number of Smooth Descent Periods of a Stock** is to find the optimal contiguous window without evaluating all $O(N^2)$ candidate subarrays.

# Simplified Approach - Minimum Operations to Make All Array Elements Equal
...
## Complexity detail
- **Time Complexity**: $O(n log n + m log n)$ — Each input element is processed in a bounded number of direct operations.

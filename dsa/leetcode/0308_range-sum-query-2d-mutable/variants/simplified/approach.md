# Simplified Approach - Range Sum Query 2D - Mutable
...
## Complexity detail
- **Time Complexity**: $O((mn + q) \log m \log n)$ — Each input element is processed in a bounded number of direct operations.

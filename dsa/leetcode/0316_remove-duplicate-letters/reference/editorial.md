...
Note that the code in this section is a translated / commented version of the code [in this post](https://leetcode.com/problems/remove-duplicate-letters/discuss/76768/A-short-$\mathcal{O}(n)$-recursive-greedy-solution) originally written by [lixx2100](https://leetcode.com/lixx2100/).

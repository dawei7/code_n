# Simplified Approach - Sum of GCD of Formed Pairs
...
## Complexity detail
- **Time Complexity**: $O(N log N + N log V)$ — Each input element is processed in a bounded number of direct operations.

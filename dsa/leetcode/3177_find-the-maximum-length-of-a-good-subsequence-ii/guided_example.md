# Guided Example: Find the Maximum Length of a Good Subsequence II
...
The objective for **Find the Maximum Length of a Good Subsequence II** is to compute the global optimal value by decomposing the problem into overlapping subproblems.

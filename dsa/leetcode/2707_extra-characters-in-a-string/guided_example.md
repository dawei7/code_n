# Guided Example: Extra Characters in a String

We derive and execute the Array, Hash Table, String, Dynamic Programming, Trie recurrence on a representative problem instance.
...
The objective for **Extra Characters in a String** is to compute the global optimal value by decomposing the problem into overlapping subproblems.

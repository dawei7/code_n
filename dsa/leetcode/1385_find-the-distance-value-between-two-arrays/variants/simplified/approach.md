# Simplified Approach - Find the Distance Value Between Two Arrays
...
## Complexity detail
- **Time Complexity**: $O(m log m + n log m)$ — Each input element is processed in a bounded number of direct operations.

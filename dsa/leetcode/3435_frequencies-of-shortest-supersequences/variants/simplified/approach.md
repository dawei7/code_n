# Simplified Approach - Frequencies of Shortest Supersequences
...
## Complexity detail
- **Time Complexity**: $O(W + 2^C C^2)$ — Each input element is processed in a bounded number of direct operations.

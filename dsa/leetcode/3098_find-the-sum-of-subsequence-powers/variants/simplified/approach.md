# Simplified Approach - Find the Sum of Subsequence Powers
...
## Complexity detail
- **Time Complexity**: $O(k n^3)$ — Each input element is processed in a bounded number of direct operations.

# Guided Example: Find the Sum of Subsequence Powers
...
The objective for **Find the Sum of Subsequence Powers** is to compute the global optimal value by decomposing the problem into overlapping subproblems.

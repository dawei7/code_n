# Guided Example: Find the Count of Monotonic Pairs II

We derive and execute the Array, Math, Dynamic Programming, Combinatorics, Prefix Sum recurrence on a representative problem instance.
...
The objective for **Find the Count of Monotonic Pairs II** is to compute the global optimal value by decomposing the problem into overlapping subproblems.

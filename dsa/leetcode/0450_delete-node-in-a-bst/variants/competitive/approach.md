## General
**Competitive Approach — Delete Node in a BST**

The solution implements an direct algorithm tailored for Delete Node in a BST. It utilizes Binary Tree node traversal (`val`, `left`, `right`) to maintain optimal runtime bounds.

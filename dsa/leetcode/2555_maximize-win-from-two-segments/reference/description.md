...
<ul>
	<li>For example if `k = 2`, you can choose segments `[1, 3]` and `[2, 4]`, and you will win any prize <font face="monospace">i</font> that satisfies `1 <= prizePositions[i] <= 3` or `2 <= prizePositions[i] <= 4`.</li>
</ul>

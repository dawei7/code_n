# Guided Example: Maximize Win From Two Segments

We trace the dynamic Array, Binary Search, Sliding Window sliding window on a representative input instance.
...
The objective for **Maximize Win From Two Segments** is to find the optimal contiguous window without evaluating all $O(N^2)$ candidate subarrays.

# Guided Example: Number of Integers With Popcount-Depth Equal to K I

We derive and execute the Math, Dynamic Programming, Bit Manipulation, Combinatorics recurrence on a representative problem instance.
...
The objective for **Number of Integers With Popcount-Depth Equal to K I** is to compute the global optimal value by decomposing the problem into overlapping subproblems.

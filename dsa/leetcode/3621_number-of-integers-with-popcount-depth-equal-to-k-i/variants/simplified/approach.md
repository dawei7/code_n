# Simplified Approach - Number of Integers With Popcount-Depth Equal to K I
...
## Complexity detail
- **Time Complexity**: $O((log n)^2)$ — Each input element is processed in a bounded number of direct operations.

...
The objective for **Maximum Non Negative Product in a Matrix** is to compute the global optimal value by decomposing the problem into overlapping subproblems.

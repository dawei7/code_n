...
- $\text{team}_{name}$ - The name of the team in the `Teams` table.

- $\text{matches}_{played}$ - The number of matches played as either a home or away team.

- `points` - The total points the team has so far.

- $\text{goal}_{for}$ - The total number of goals scored by the team across all matches.

- $\text{goal}_{against}$ - The total number of goals scored by opponent teams against this team across all matches.

- $\text{goal}_{diff}$ - The result of $\text{goal}_{for} - \text{goal}_{against}$.

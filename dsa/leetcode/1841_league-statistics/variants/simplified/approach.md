# Simplified Approach - League Statistics
...
## Complexity detail
- **Time Complexity**: $O(m + t\log t)$ — Each input element is processed in a bounded number of direct operations.
- **Space Complexity**: $O(m + t)$ — Utilizes standard auxiliary storage proportional to the active computation state.

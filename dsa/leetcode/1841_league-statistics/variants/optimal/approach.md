## General
The optimal solution implements an idiomatic, readable, and production-ready approach for **League Statistics**.
...
## Complexity detail
- **Time Complexity**: $O(m + t\log t)$ — Operational efficiency across problem constraints.

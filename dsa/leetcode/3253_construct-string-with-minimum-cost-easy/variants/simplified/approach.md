# Simplified Approach - Construct String with Minimum Cost (Easy)
...
## Complexity detail
- **Time Complexity**: $O(nS)$ — Each input element is processed in a bounded number of direct operations.
- **Space Complexity**: $O(n+S)$ — Utilizes standard auxiliary storage proportional to the active computation state.

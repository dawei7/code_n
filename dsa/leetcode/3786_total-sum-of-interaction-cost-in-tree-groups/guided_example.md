# Guided Example: Total Sum of Interaction Cost in Tree Groups
...
The objective for **Total Sum of Interaction Cost in Tree Groups** is to evaluate tree properties by visiting nodes in topological hierarchy (post-order, pre-order, or level-order).

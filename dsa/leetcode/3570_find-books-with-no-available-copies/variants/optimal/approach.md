## General
The optimal solution implements an idiomatic, readable, and production-ready approach for **Find Books with No Available Copies**.
...
## Complexity detail
- **Time Complexity**: $O(B log B + R log R)$ — Operational efficiency across problem constraints.

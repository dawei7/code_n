# Simplified Approach - Kth Largest Element in a Stream
...
## Complexity detail
- **Time Complexity**: $O((m + s) \log k)$ — Each input element is processed in a bounded number of direct operations.

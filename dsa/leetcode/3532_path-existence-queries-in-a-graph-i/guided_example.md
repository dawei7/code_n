# Guided Example: Path Existence Queries in a Graph I

We trace the logarithmic Array, Hash Table, Binary Search, Union-Find, Graph Theory search on a representative problem instance.
...
The objective for **Path Existence Queries in a Graph I** is to pinpoint the target value or optimal threshold in logarithmic $O(\log N)$ time.

# Guided Example: Count of Substrings Containing Every Vowel and K Consonants II
...
The objective for **Count of Substrings Containing Every Vowel and K Consonants II** is to find the optimal contiguous window without evaluating all $O(N^2)$ candidate subarrays.

# Guided Example: Count Non Adjacent Subsets in a Rooted Tree
...
The objective for **Count Non Adjacent Subsets in a Rooted Tree** is to evaluate tree properties by visiting nodes in topological hierarchy (post-order, pre-order, or level-order).

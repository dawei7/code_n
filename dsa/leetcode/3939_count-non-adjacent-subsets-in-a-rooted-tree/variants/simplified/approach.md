# Simplified Approach - Count Non Adjacent Subsets in a Rooted Tree
...
## Complexity detail
- **Time Complexity**: $O(NK^2)$ — Each input element is processed in a bounded number of direct operations.

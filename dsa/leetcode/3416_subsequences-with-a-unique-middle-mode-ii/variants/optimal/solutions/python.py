...
def solve(nums: list[int]) -> int:
    ...
    for index, middle in enumerate(nums):
        ...
        sum_left_right_squared += left_middle * (
            right_middle * right_middle - old_right_middle * old_right_middle
        )
        ...
        other_left_right_squared = (
            sum_left_right_squared - left_middle * right_middle * right_middle
        )
        other_left_squared_right = (
            sum_left_squared_right - left_middle * left_middle * right_middle
        )

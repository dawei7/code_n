# Guided Example: Longest Uploaded Prefix

We trace the logarithmic Hash Table, Binary Search, Union-Find, Design, Binary Indexed Tree, Segment Tree, Heap (Priority Queue), Ordered Set search on a representative problem instance.

- **Input:** `{"n": 4, "operations": [["upload", [3]], ["longest", []], ["upload", [1]], ["longest", []], ["upload", [2]], ["longest", []]]}`
- **Required output:** `[null, 0, null, 1, null, 3]`
...
The objective for **Longest Uploaded Prefix** is to pinpoint the target value or optimal threshold in logarithmic $O(\log N)$ time.

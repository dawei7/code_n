...
We execute the single-pass Linked List, Divide and Conquer, Tree, Binary Search Tree, Binary Tree pointer manipulation on a representative linked list instance.

- **Input:** `{"head": [-10, -3, 0, 5, 9]}`
- **Required output:** `[0, -3, 9, -10, null, 5]`
...
The objective for **Convert Sorted List to Binary Search Tree** is to transform the linked structure by strictly updating `next` references in place.

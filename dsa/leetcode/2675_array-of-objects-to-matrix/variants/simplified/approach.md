# Simplified Approach - Array of Objects to Matrix
...
## Complexity detail
- **Time Complexity**: $O(S + k log k + rk)$ — Each input element is processed in a bounded number of direct operations.
- **Space Complexity**: $O(S + rk)$ — Utilizes standard auxiliary storage proportional to the active computation state.

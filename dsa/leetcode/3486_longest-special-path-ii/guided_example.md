# Guided Example: Longest Special Path II

We trace the hierarchical Array, Hash Table, Tree, Depth-First Search, Prefix Sum traversal and subtree aggregation on a representative binary tree.
...
The objective for **Longest Special Path II** is to evaluate tree properties by visiting nodes in topological hierarchy (post-order, pre-order, or level-order).

# Guided Example: Shortest Path in a Weighted Tree

We trace the hierarchical Array, Tree, Depth-First Search, Binary Indexed Tree, Segment Tree traversal and subtree aggregation on a representative binary tree.
...
The objective for **Shortest Path in a Weighted Tree** is to evaluate tree properties by visiting nodes in topological hierarchy (post-order, pre-order, or level-order).

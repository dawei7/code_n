# Guided Example: Find Subtree Sizes After Changes

We trace the hierarchical Array, Hash Table, String, Tree, Depth-First Search traversal and subtree aggregation on a representative binary tree.

- **Input:** `{"parent": [-1, 0, 0, 1, 1, 1], "s": "abaabc"}`
- **Required output:** `[6, 3, 1, 1, 1, 1]`
...
The objective for **Find Subtree Sizes After Changes** is to evaluate tree properties by visiting nodes in topological hierarchy (post-order, pre-order, or level-order).

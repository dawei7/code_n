# Guided Example: Find Sum of Array Product of Magical Sequences

We derive and execute the Array, Math, Dynamic Programming, Bit Manipulation, Combinatorics, Bitmask recurrence on a representative problem instance.

- **Input:** `{"m": 5, "k": 5, "nums": [1, 10, 100, 10000, 1000000]}`
- **Required output:** `991600007`
...
The objective for **Find Sum of Array Product of Magical Sequences** is to compute the global optimal value by decomposing the problem into overlapping subproblems.

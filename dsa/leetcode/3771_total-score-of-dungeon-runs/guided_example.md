# Guided Example: Total Score of Dungeon Runs

We trace the logarithmic Array, Binary Search, Prefix Sum search on a representative problem instance.
...
The objective for **Total Score of Dungeon Runs** is to pinpoint the target value or optimal threshold in logarithmic $O(\log N)$ time.

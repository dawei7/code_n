# Guided Example: Maximize the Number of Target Nodes After Connecting Trees I
...
The objective for **Maximize the Number of Target Nodes After Connecting Trees I** is to evaluate tree properties by visiting nodes in topological hierarchy (post-order, pre-order, or level-order).

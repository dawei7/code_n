# Guided Example: Find the Maximum Length of Valid Subsequence II
...
The objective for **Find the Maximum Length of Valid Subsequence II** is to compute the global optimal value by decomposing the problem into overlapping subproblems.

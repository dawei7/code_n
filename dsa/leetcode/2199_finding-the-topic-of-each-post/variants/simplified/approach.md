# Simplified Approach - Finding the Topic of Each Post
...
## Complexity detail
- **Time Complexity**: $O(pkL + t log t)$ — Each input element is processed in a bounded number of direct operations.

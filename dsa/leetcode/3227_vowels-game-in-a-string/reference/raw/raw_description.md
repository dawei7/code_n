...
You are given a string `s`, Alice and Bob will take turns playing the following game where Alice starts **first**:
	...
	- On Alice's turn, she has to remove any **non-empty** <span data-keyword="substring">substring</span> from `s` that contains an **odd** number of vowels.

	- On Bob's turn, he has to remove any **non-empty** <span data-keyword="substring">substring</span> from `s` that contains an **even** number of vowels.
...
**Input:** <span class="example-io">s = "leetcoder"</span>
...
<div class="example-block">
**Input:** <span class="example-io">s = "bbcd"</span>

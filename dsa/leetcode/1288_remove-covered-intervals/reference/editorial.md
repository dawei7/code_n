...
- If $end1 \ge end2$, the interval 2 is covered by the interval 1.
...
- If the current interval is not covered by the previous one $end > \text{prev}_{end}$, increase the number of non-covered intervals. Assign the current interval to be previous for the next step.

## General
The optimal solution implements an idiomatic, readable, and production-ready approach for **Find the Quiet Students in All Exams**.
...
## Complexity detail
- **Time Complexity**: $O(E \log E + S)$ — Operational efficiency across problem constraints.

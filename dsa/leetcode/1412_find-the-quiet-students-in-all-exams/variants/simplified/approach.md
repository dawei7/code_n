# Simplified Approach - Find the Quiet Students in All Exams
...
## Complexity detail
- **Time Complexity**: $O(E \log E + S)$ — Each input element is processed in a bounded number of direct operations.
- **Space Complexity**: $O(E + S)$ — Utilizes standard auxiliary storage proportional to the active computation state.

# Guided Example: Maximum Frequency of an Element After Performing Operations II

We trace the dynamic Array, Binary Search, Sliding Window, Sorting, Prefix Sum sliding window on a representative input instance.
...
The objective for **Maximum Frequency of an Element After Performing Operations II** is to find the optimal contiguous window without evaluating all $O(N^2)$ candidate subarrays.

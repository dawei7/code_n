# Guided Example: Minimum Cost to Make All Characters Equal

We derive and execute the String, Dynamic Programming, Greedy recurrence on a representative problem instance.
...
The objective for **Minimum Cost to Make All Characters Equal** is to compute the global optimal value by decomposing the problem into overlapping subproblems.

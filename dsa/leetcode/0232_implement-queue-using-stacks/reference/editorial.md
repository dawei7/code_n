...
![Push an element in queue](images/232_queue_using_stacksBPush.png){:width="539px"}
...
![Pop an element from queue](images/232_queue_using_stacksBPop.png){:width="539px"}
...
![Push an element in queue](images/232_queue_using_stacksAPush.png){:width="539px"}
...
* Time complexity : $O(1)$. Аppending an element to a stack is an $\mathcal{O}(1)$ operation.
...
![Pop an element from stack](images/232_queue_using_stacksAPop.png){:width="539px"}

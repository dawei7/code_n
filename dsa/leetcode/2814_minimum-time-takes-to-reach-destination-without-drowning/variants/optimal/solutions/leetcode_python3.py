    ...
    def minimumSeconds(self, land: List[List[str]]) -> int:
        ...
        while flood_queue:
            ...
            for dr, dc in directions:
                ...
                if 0 <= next_row < rows and 0 <= next_column < columns and land[next_row][next_column] == "." and flood_time[next_row][next_column] == float("inf"):
        ...
        while queue:
            ...
            for dr, dc in directions:
                ...
                if land[next_row][next_column] == "D":
                    return time + 1
                if land[next_row][next_column] == "." and (next_row, next_column) not in seen and time + 1 < flood_time[next_row][next_column]:

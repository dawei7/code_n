...
The objective for **Smallest String Starting From Leaf** is to evaluate tree properties by visiting nodes in topological hierarchy (post-order, pre-order, or level-order).

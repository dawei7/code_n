...
<center>
<img src="images/153_Minimum_Rotated_Sorted_Array_1.png" width="500"/>
</center>

In the above example `7 > 2`. This means that the array is still sorted and has no rotation.

<center>
<img src="images/153_Minimum_Rotated_Sorted_Array_2.png" width="500"/>
</center>
...
<center>
<img src="images/153_Minimum_Rotated_Sorted_Array_3.png" width="500"/>
</center>
...
<center>
<img src="images/153_Minimum_Rotated_Sorted_Array_4.png" width="500"/>
</center>
...
$\text{nums}[mid] > nums[mid + 1]$ Hence, **mid+1** is the smallest.

$nums[mid - 1] > \text{nums}[mid]$ Hence, **mid** is the smallest.

<center>
<img src="images/153_Minimum_Rotated_Sorted_Array_5.png" width="500"/>
</center>

In the above example. With the marked left and right pointers. The mid element is `2`. The element just before `2` is `7` and `7>2` i.e. $nums[mid - 1] > \text{nums}[mid]$. Thus we have found the point of inflection and `2` is the smallest element.

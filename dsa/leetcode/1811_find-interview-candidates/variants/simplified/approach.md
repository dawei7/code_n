# Simplified Approach - Find Interview Candidates
...
## Complexity detail
- **Time Complexity**: $O(C\log C + U)$ — Each input element is processed in a bounded number of direct operations.
- **Space Complexity**: $O(C + U)$ — Utilizes standard auxiliary storage proportional to the active computation state.

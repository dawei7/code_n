...
## Complexity detail
- **Time Complexity**: $O(C\log C + U)$ — Operation count proportional to input scale.
- **Space Complexity**: $O(C + U)$ — Auxiliary memory allocation bound.

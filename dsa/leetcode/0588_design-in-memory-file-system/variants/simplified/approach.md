# Simplified Approach - Design In-Memory File System
...
## Complexity detail
- **Time Complexity**: $O(P + k \log k + C)$ — Each input element is processed in a bounded number of direct operations.

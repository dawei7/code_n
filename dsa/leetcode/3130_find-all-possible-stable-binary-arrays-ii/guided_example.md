# Guided Example: Find All Possible Stable Binary Arrays II

We derive and execute the Dynamic Programming, Prefix Sum recurrence on a representative problem instance.
...
The objective for **Find All Possible Stable Binary Arrays II** is to compute the global optimal value by decomposing the problem into overlapping subproblems.

# Guided Example: Maximum Sum of Almost Unique Subarray
...
The objective for **Maximum Sum of Almost Unique Subarray** is to find the optimal contiguous window without evaluating all $O(N^2)$ candidate subarrays.

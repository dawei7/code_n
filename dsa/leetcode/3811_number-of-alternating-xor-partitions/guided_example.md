# Guided Example: Number of Alternating XOR Partitions

We derive and execute the Array, Hash Table, Dynamic Programming, Bit Manipulation recurrence on a representative problem instance.
...
The objective for **Number of Alternating XOR Partitions** is to compute the global optimal value by decomposing the problem into overlapping subproblems.

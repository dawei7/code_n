...
We execute the single-pass Linked List, Depth-First Search, Doubly-Linked List pointer manipulation on a representative linked list instance.

- **Input:** `{"head": [[1, []], [2, []], [3, [[7, []], [8, [[11, []], [12, []]]], [9, []], [10, []]]], [4, []], [5, []], [6, []]]}`
- **Required output:** `[1, 2, 3, 7, 8, 11, 12, 9, 10, 4, 5, 6]`
...
The objective for **Flatten a Multilevel Doubly Linked List** is to transform the linked structure by strictly updating `next` references in place.

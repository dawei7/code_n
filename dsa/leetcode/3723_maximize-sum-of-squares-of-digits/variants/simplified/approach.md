# Simplified Approach - Maximize Sum of Squares of Digits
...
## Complexity detail
- **Time Complexity**: $O(num)$ — Each input element is processed in a bounded number of direct operations.
- **Space Complexity**: $O(num)$ — Utilizes standard auxiliary storage proportional to the active computation state.

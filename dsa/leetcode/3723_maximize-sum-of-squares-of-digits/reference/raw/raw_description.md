...
**Input:** <span class="example-io">num = 2, sum = 3</span>
...
<div class="example-block">
**Input:** <span class="example-io">num = 2, sum = 17</span>

**Output:** <span class="example-io">"98"</span>
...
<div class="example-block">
**Input:** <span class="example-io">num = 1, sum = 10</span>

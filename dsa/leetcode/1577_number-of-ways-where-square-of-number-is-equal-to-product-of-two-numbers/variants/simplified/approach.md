# Simplified Approach - Number of Ways Where Square of Number Is Equal to Product of Two Numbers
...
## Complexity detail
- **Time Complexity**: $O(N^2 + M^2)$ — Each input element is processed in a bounded number of direct operations.
- **Space Complexity**: $O(N^2 + M^2)$ — Utilizes standard auxiliary storage proportional to the active computation state.

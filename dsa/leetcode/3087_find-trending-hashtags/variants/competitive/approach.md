## General
**Competitive Approach — Find Trending Hashtags**

The query executes a structured relational pipeline for **Find Trending Hashtags**. It uses `GROUP BY` aggregation with PostgreSQL standard functions (`COALESCE`, `STRING_AGG`).

# Simplified Approach - Sum of Digit Differences of All Pairs
...
## Complexity detail
- **Time Complexity**: $O(nD)$ — Each input element is processed in a bounded number of direct operations.

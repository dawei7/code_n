...
Only increases are allowed: a move changes one selected value from $\text{nums}[i]$ to $\text{nums}[i] + 1$. Different elements may receive different numbers of moves.

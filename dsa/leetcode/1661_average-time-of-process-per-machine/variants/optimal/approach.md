## General
**Optimal Approach — Average Time of Process per Machine**

The query executes a structured relational pipeline for **Average Time of Process per Machine**. It uses `GROUP BY` aggregation with PostgreSQL standard functions (`COALESCE`, `STRING_AGG`).

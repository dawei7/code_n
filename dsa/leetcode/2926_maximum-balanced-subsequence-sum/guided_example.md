# Guided Example: Maximum Balanced Subsequence Sum

We trace the logarithmic Array, Binary Search, Dynamic Programming, Binary Indexed Tree, Segment Tree search on a representative problem instance.
...
The objective for **Maximum Balanced Subsequence Sum** is to pinpoint the target value or optimal threshold in logarithmic $O(\log N)$ time.

# Simplified Approach - Find XOR Sum of All Pairs Bitwise AND
...
## Complexity detail
- **Time Complexity**: $O(p+q)$ — Each input element is processed in a bounded number of direct operations.

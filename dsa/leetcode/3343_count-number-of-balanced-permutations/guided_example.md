# Guided Example: Count Number of Balanced Permutations

We derive and execute the Math, String, Dynamic Programming, Combinatorics recurrence on a representative problem instance.
...
The objective for **Count Number of Balanced Permutations** is to compute the global optimal value by decomposing the problem into overlapping subproblems.

...
- **Required output:** `[1, null, 0, null, 1]`
...
The objective for **Binary Tree Pruning** is to evaluate tree properties by visiting nodes in topological hierarchy (post-order, pre-order, or level-order).

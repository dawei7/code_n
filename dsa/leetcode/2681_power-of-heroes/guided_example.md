# Guided Example: Power of Heroes

We derive and execute the Array, Math, Dynamic Programming, Sorting, Prefix Sum recurrence on a representative problem instance.
...
The objective for **Power of Heroes** is to compute the global optimal value by decomposing the problem into overlapping subproblems.

...
We execute the single-pass Linked List, Two Pointers, Divide and Conquer, Sorting, Merge Sort pointer manipulation on a representative linked list instance.
...
The objective for **Sort List** is to transform the linked structure by strictly updating `next` references in place.

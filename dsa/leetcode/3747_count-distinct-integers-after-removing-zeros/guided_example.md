# Guided Example: Count Distinct Integers After Removing Zeros

We derive and execute the Math, Dynamic Programming recurrence on a representative problem instance.
...
The objective for **Count Distinct Integers After Removing Zeros** is to compute the global optimal value by decomposing the problem into overlapping subproblems.

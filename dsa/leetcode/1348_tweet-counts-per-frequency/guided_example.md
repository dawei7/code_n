# Guided Example: Tweet Counts Per Frequency

We trace the logarithmic Hash Table, String, Binary Search, Design, Sorting, Ordered Set search on a representative problem instance.

- **Input:** `{"operations": ["TweetCounts", "recordTweet", "recordTweet", "recordTweet", "getTweetCountsPerFrequency", "getTweetCountsPerFrequency", "recordTweet", "getTweetCountsPerFrequency"], "arguments": [[], ["tweet3", 0], ["tweet3", 60], ["tweet3", 10], ["minute", "tweet3", 0, 59], ["minute", "tweet3", 0, 60], ["tweet3", 120], ["hour", "tweet3", 0, 210]]}`
- **Required output:** `[null, null, null, null, [2], [2, 1], null, [4]]`
...
The objective for **Tweet Counts Per Frequency** is to pinpoint the target value or optimal threshold in logarithmic $O(\log N)$ time.

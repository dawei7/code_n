...
![alt text](images/diff_cases.png)
...
![alt text](images/mutual_2nd_testcase.png)
...
![mutual_favs](images/mutual_favs.png)
...
- Build the reversed graph:
  - Iterate through each person in the `favorite` array, and for each person, add them to the reversed graph using $\text{favorite}[person]$ as the key.

# Simplified Approach - Partitioning Into Minimum Number Of Deci-Binary Numbers
...
## Complexity detail
- **Time Complexity**: $O(L)$ — Each input element is processed in a bounded number of direct operations.

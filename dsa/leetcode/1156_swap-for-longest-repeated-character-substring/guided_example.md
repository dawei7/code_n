...
The objective for **Swap For Longest Repeated Character Substring** is to find the optimal contiguous window without evaluating all $O(N^2)$ candidate subarrays.

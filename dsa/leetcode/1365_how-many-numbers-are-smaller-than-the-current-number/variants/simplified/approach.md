# Simplified Approach - How Many Numbers Are Smaller Than the Current Number
...
## Complexity detail
- **Time Complexity**: $O(n+U)$ — Each input element is processed in a bounded number of direct operations.

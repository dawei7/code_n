...
inputs = [[1],[2],[3]]
- **Output:** `6`
- **Explanation:** The code being executed is:
...
inputs = [[1,2],[3]]
- **Output:** `6`
- **Explanation:** curriedSum(1, 2)(3) should return the same value as sum(1, 2, 3).
...
inputs = [[],[],[1,2,3]]
- **Output:** `6`
- **Explanation:** You should be able to pass the parameters in any way, including all at once or none at all.
curriedSum()()(1, 2, 3) should return the same value as sum(1, 2, 3).
...
inputs = [[]]
- **Output:** `42`
- **Explanation:** currying a function that accepts zero parameters should effectively do nothing.
curriedLife() === 42

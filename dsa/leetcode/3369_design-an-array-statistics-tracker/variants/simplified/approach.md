# Simplified Approach - Design an Array Statistics Tracker 
...
## Complexity detail
- **Time Complexity**: $O(q log q)$ — Each input element is processed in a bounded number of direct operations.

# Guided Example: Design an Array Statistics Tracker 

We trace the logarithmic Hash Table, Binary Search, Design, Queue, Heap (Priority Queue), Data Stream, Ordered Set search on a representative problem instance.

- **Input:** `{"operations": ["StatisticsTracker", "addNumber", "addNumber", "addNumber", "addNumber", "getMean", "getMedian", "getMode", "removeFirstAddedNumber", "getMode"], "arguments": [[], [4], [4], [2], [3], [], [], [], [], []]}`
- **Required output:** `[null, null, null, null, null, 3, 4, 4, null, 2]`
...
The objective for **Design an Array Statistics Tracker ** is to pinpoint the target value or optimal threshold in logarithmic $O(\log N)$ time.

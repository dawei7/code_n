# Guided Example: Count Substrings That Satisfy K-Constraint I
...
The objective for **Count Substrings That Satisfy K-Constraint I** is to find the optimal contiguous window without evaluating all $O(N^2)$ candidate subarrays.

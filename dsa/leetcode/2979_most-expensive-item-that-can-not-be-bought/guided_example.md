# Guided Example: Most Expensive Item That Can Not Be Bought

We derive and execute the Math, Dynamic Programming, Number Theory recurrence on a representative problem instance.
...
The objective for **Most Expensive Item That Can Not Be Bought** is to compute the global optimal value by decomposing the problem into overlapping subproblems.

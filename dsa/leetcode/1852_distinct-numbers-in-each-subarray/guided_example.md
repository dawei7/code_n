...
The objective for **Distinct Numbers in Each Subarray** is to find the optimal contiguous window without evaluating all $O(N^2)$ candidate subarrays.

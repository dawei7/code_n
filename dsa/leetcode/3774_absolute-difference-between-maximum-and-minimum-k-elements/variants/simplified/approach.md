# Simplified Approach - Absolute Difference Between Maximum and Minimum K Elements
...
## Complexity detail
- **Time Complexity**: $O(N + V)$ — Each input element is processed in a bounded number of direct operations.
- **Space Complexity**: $O(V)$ — Utilizes standard auxiliary storage proportional to the active computation state.

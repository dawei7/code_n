...
**Input:** <span class="example-io">s = "1010", encCost = 2, flatCost = 1</span>
...
<div class="example-block">
**Input:** <span class="example-io">s = "1010", encCost = 3, flatCost = 10</span>
...
<div class="example-block">
**Input:** <span class="example-io">s = "00", encCost = 1, flatCost = 2</span>

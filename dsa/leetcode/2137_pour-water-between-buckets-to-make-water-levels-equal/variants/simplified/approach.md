# Simplified Approach - Pour Water Between Buckets to Make Water Levels Equal
...
## Complexity detail
- **Time Complexity**: $O(n \log(R / \varepsilon))$ — Each input element is processed in a bounded number of direct operations.

...
1. Initialize Search Bounds:
   ...
   - Determine the total number of houses, $numHouses = \text{houseRewards.size}()$.
...
4. Adjust Search Range:
   - If $housesRobbed \ge housesToRob$, reduce the reward constraint ($right = mid$).

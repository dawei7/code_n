# Simplified Approach - Group Sold Products By The Date
...
## Complexity detail
- **Time Complexity**: $O(R + P \log P)$ — Each input element is processed in a bounded number of direct operations.

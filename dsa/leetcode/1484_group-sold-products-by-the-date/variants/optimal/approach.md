## General
The optimal solution implements an idiomatic, readable, and production-ready approach for **Group Sold Products By The Date**.
...
## Complexity detail
- **Time Complexity**: $O(R + P \log P)$ — Operational efficiency across problem constraints.

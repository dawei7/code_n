...
<ul>
	<li>For example, if the student's answers were `[1, <u>0</u>, <u>1</u>]` and the mentor's answers were `[0, <u>0</u>, <u>1</u>]`, then their compatibility score is 2 because only the second and the third answers are the same.</li>
</ul>

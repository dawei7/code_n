# Simplified Approach - Count Almost Equal Pairs I
...
## Complexity detail
- **Time Complexity**: $O(n log n + n d^3)$ — Each input element is processed in a bounded number of direct operations.
- **Space Complexity**: $O(n + d^2)$ — Utilizes standard auxiliary storage proportional to the active computation state.

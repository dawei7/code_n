# Simplified Approach - Maximize Subarray Sum After Removing All Occurrences of One Element
...
## Complexity detail
- **Time Complexity**: $O(n log n)$ — Each input element is processed in a bounded number of direct operations.

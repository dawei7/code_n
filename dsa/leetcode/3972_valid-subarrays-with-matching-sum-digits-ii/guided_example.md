# Guided Example: Valid Subarrays With Matching Sum Digits II

We trace the dynamic Array, Hash Table, Sliding Window, Prefix Sum sliding window on a representative input instance.
...
The objective for **Valid Subarrays With Matching Sum Digits II** is to find the optimal contiguous window without evaluating all $O(N^2)$ candidate subarrays.

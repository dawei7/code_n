# Simplified Approach - Minimum Array Sum
...
## Complexity detail
- **Time Complexity**: $O(n * op1 * op2)$ — Each input element is processed in a bounded number of direct operations.
- **Space Complexity**: $O(op1 * op2)$ — Utilizes standard auxiliary storage proportional to the active computation state.

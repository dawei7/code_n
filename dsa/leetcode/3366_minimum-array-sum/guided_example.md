# Guided Example: Minimum Array Sum
...
The objective for **Minimum Array Sum** is to compute the global optimal value by decomposing the problem into overlapping subproblems.

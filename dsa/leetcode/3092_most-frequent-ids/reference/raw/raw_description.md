...
**Input:** <span class="example-io">nums = [2,3,2,1], freq = [3,2,-3,1]</span>

**Output:** <span class="example-io">[3,3,2,2]</span>
...
<div class="example-block">
**Input:** <span class="example-io">nums = [5,5,3], freq = [2,-2,1]</span>

**Output:** <span class="example-io">[2,0,1]</span>

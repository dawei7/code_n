# Guided Example: Balance a Binary Search Tree

We trace the hierarchical Divide and Conquer, Greedy, Tree, Depth-First Search, Binary Search Tree, Binary Tree traversal and subtree aggregation on a representative binary tree.

- **Input:** `{"root": [1, null, 2, null, 3, null, 4]}`
- **Required output:** `[2, 1, 3, null, null, null, 4]`
...
The objective for **Balance a Binary Search Tree** is to evaluate tree properties by visiting nodes in topological hierarchy (post-order, pre-order, or level-order).

# Guided Example: Shortest Subarray With OR at Least K II

We trace the dynamic Array, Bit Manipulation, Sliding Window sliding window on a representative input instance.
...
The objective for **Shortest Subarray With OR at Least K II** is to find the optimal contiguous window without evaluating all $O(N^2)$ candidate subarrays.

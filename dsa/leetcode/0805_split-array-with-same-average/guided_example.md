...
We derive and execute the Array, Hash Table, Math, Dynamic Programming, Bit Manipulation, Bitmask recurrence on a representative problem instance.
...
The objective for **Split Array With Same Average** is to compute the global optimal value by decomposing the problem into overlapping subproblems.

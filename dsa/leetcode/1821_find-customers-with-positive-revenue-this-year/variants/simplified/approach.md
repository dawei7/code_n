# Simplified Approach - Find Customers With Positive Revenue this Year
...
## Complexity detail
- **Time Complexity**: $O(r)$ — Each input element is processed in a bounded number of direct operations.
- **Space Complexity**: $O(o)$ — Utilizes standard auxiliary storage proportional to the active computation state.

# Guided Example: Find the Power of K-Size Subarrays I
...
The objective for **Find the Power of K-Size Subarrays I** is to find the optimal contiguous window without evaluating all $O(N^2)$ candidate subarrays.

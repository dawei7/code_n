...
![Courses](images/630_Course_Schedule_III_1.PNG)

2. $(a+b)>x$, $(a+b) ≤ y$: In this case, as is evident from the figure, both the courses can be taken only by taking course $a$ before $b$.

![Courses](images/630_Course_Schedule_III_2.PNG)

3. $(a+b)>x$, $(a+b) ≤ y$: In this case also, both the courses can be taken only by taking course $a$ before $b$.

![Courses](images/630_Course_Schedule_III_3.PNG)

4. $(a+b)>y$: In this case, irrespective of the order in which we take the courses, only one course can be taken.

![Courses](images/630_Course_Schedule_III_4.PNG)
...
If the course can be taken, we increment the number of courses taken and obtain the number of courses that can be taken by passing the updated time and courses' index. i.e. we make the function call $schedule(courses, i + 1, time + \text{duration}_{i})$. Let's say, we store the number of courses that can be taken by taking the current course in $taken$ variable.
...
In order to remove this redundancy, we make use of a memoization array $memo$, such that $\text{memo}[i][j]$ is used to store the result of the function call `schedule(courses, i, time)`. Thus, whenever the same function call is made again, we can return the result directly from the $memo$ array. This helps to prune the search space to a great extent.
...
For each course being considered currently(let's say $i^{th}$ course), we try to take this course. But, to be able to do so, the current course should end before its corresponding end day i.e. $time + duration_i ≤ end\_day_i$. Here, $duration_i$ refers to the duration of the $i^{th}$ course and $end\_day_i$ refers to the end day of the $i^{th}$ course.
...
![Slide 1](images/slideshow_630_Course_Schedule_III_630_Course_Schedule_IIISlide1.PNG)

![Slide 2](images/slideshow_630_Course_Schedule_III_630_Course_Schedule_IIISlide2.PNG)

![Slide 3](images/slideshow_630_Course_Schedule_III_630_Course_Schedule_IIISlide3.PNG)

![Slide 4](images/slideshow_630_Course_Schedule_III_630_Course_Schedule_IIISlide4.PNG)

![Slide 5](images/slideshow_630_Course_Schedule_III_630_Course_Schedule_IIISlide5.PNG)

![Slide 6](images/slideshow_630_Course_Schedule_III_630_Course_Schedule_IIISlide6.PNG)

![Slide 7](images/slideshow_630_Course_Schedule_III_630_Course_Schedule_IIISlide7.PNG)

![Slide 8](images/slideshow_630_Course_Schedule_III_630_Course_Schedule_IIISlide8.PNG)

![Slide 9](images/slideshow_630_Course_Schedule_III_630_Course_Schedule_IIISlide9.PNG)

![Slide 10](images/slideshow_630_Course_Schedule_III_630_Course_Schedule_IIISlide10.PNG)

![Slide 11](images/slideshow_630_Course_Schedule_III_630_Course_Schedule_IIISlide11.PNG)

![Slide 12](images/slideshow_630_Course_Schedule_III_630_Course_Schedule_IIISlide12.PNG)

![Slide 13](images/slideshow_630_Course_Schedule_III_630_Course_Schedule_IIISlide13.PNG)
...
Thus, whenever we update the $count$ to indicate that one more course has been taken, we also update the $\text{courses}[count]$ entry to
...
* Time complexity : $O(n*m)$. We iterate over a total of $n$ elements of the $courses$ array. For every element, we can traverse over at most $m$ number of elements. Here, $m$ refers to the final length of the $valid\_list$.

* Space complexity : $O(n)$. The $valid\_list$ can contain at most $n$ courses.
<br />
<br />

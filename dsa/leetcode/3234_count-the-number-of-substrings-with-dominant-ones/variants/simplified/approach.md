# Simplified Approach - Count the Number of Substrings With Dominant Ones
...
## Complexity detail
- **Time Complexity**: $O(n sqrt(n))$ — Each input element is processed in a bounded number of direct operations.

## General
The optimal solution implements an idiomatic, readable, and production-ready approach for **Active Users**.
...
## Complexity detail
- **Time Complexity**: $O(L\log L+A)$ — Operational efficiency across problem constraints.

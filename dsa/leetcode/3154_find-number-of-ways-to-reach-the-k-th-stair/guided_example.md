# Guided Example: Find Number of Ways to Reach the K-th Stair

We derive and execute the Math, Dynamic Programming, Bit Manipulation, Memoization, Combinatorics recurrence on a representative problem instance.
...
The objective for **Find Number of Ways to Reach the K-th Stair** is to compute the global optimal value by decomposing the problem into overlapping subproblems.

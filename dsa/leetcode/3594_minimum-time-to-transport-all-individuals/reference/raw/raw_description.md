...
**Input:** <span class="example-io">n = 1, k = 1, m = 2, time = [5], mul = [1.0,1.3]</span>

**Output:** <span class="example-io">5.00000</span>
...
<div class="example-block">
**Input:** <span class="example-io">n = 3, k = 2, m = 3, time = [2,5,8], mul = [1.0,1.5,0.75]</span>

**Output:** <span class="example-io">14.50000</span>
...
<div class="example-block">
**Input:** <span class="example-io">n = 2, k = 1, m = 2, time = [10,10], mul = [2.0,2.0]</span>

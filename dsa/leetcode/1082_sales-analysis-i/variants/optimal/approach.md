## General
**Optimal Approach — Sales Analysis I**

The query executes a structured relational pipeline for **Sales Analysis I**. It uses `GROUP BY` aggregation with PostgreSQL standard functions (`COALESCE`, `STRING_AGG`).

# Simplified Approach - Check if an Original String Exists Given Two Encoded Strings
...
## Complexity detail
- **Time Complexity**: $O(n_1n_2B)$ — Each input element is processed in a bounded number of direct operations.
- **Space Complexity**: $O(n_1n_2B)$ — Utilizes standard auxiliary storage proportional to the active computation state.

...
We trace the hierarchical Tree, Depth-First Search, Binary Search Tree, Binary Tree traversal and subtree aggregation on a representative binary tree.

- **Input:** `{"root": [1, 3, null, null, 2]}`
- **Required output:** `[3, 1, null, null, 2]`
...
The objective for **Recover Binary Search Tree** is to evaluate tree properties by visiting nodes in topological hierarchy (post-order, pre-order, or level-order).

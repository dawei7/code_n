# Guided Example: Select Cells in Grid With Maximum Score

We derive and execute the Array, Dynamic Programming, Bit Manipulation, Matrix, Bitmask recurrence on a representative problem instance.
...
The objective for **Select Cells in Grid With Maximum Score** is to compute the global optimal value by decomposing the problem into overlapping subproblems.

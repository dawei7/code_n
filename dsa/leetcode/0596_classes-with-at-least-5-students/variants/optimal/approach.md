## General
**Optimal Approach — Classes With at Least 5 Students**

The query executes a structured relational pipeline for **Classes With at Least 5 Students**. It uses `GROUP BY` aggregation with PostgreSQL standard functions (`COALESCE`, `STRING_AGG`).

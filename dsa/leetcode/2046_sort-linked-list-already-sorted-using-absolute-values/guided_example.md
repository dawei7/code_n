...
We execute the single-pass Linked List, Two Pointers, Sorting pointer manipulation on a representative linked list instance.

- **Input:** `{"head": [0, 2, -5, 5, 10, -10]}`
- **Required output:** `[-10, -5, 0, 2, 5, 10]`
...
The objective for **Sort Linked List Already Sorted Using Absolute Values** is to transform the linked structure by strictly updating `next` references in place.

## General
**Optimal Approach — Capital Gain/Loss**

The query executes a structured relational pipeline for **Capital Gain/Loss**. It uses `GROUP BY` aggregation with PostgreSQL standard functions (`COALESCE`, `STRING_AGG`).

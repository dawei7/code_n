## General
**Competitive Approach — Capital Gain/Loss**

The query executes a structured relational pipeline for **Capital Gain/Loss**. It uses SQL projections and filtering predicates.

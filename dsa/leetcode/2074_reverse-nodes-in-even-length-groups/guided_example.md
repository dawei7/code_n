...
- **Required output:** `[5, 6, 2, 3, 9, 1, 4, 8, 3, 7]`
...
The objective for **Reverse Nodes in Even Length Groups** is to transform the linked structure by strictly updating `next` references in place.

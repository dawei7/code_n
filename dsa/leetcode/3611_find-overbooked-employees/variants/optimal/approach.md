## General
The optimal solution implements an idiomatic, readable, and production-ready approach for **Find Overbooked Employees**.
...
## Complexity detail
- **Time Complexity**: $O(M log M + E log E)$ — Operational efficiency across problem constraints.

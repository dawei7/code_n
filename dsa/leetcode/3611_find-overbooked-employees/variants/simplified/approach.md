# Simplified Approach - Find Overbooked Employees
...
## Complexity detail
- **Time Complexity**: $O(M log M + E log E)$ — Each input element is processed in a bounded number of direct operations.
- **Space Complexity**: $O(M + E)$ — Utilizes standard auxiliary storage proportional to the active computation state.

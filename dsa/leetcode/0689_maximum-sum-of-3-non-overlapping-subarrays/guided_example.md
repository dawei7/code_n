...
We trace the dynamic Array, Dynamic Programming, Sliding Window, Prefix Sum sliding window on a representative input instance.
...
The objective for **Maximum Sum of 3 Non-Overlapping Subarrays** is to find the optimal contiguous window without evaluating all $O(N^2)$ candidate subarrays.

...
We trace the hierarchical Array, Hash Table, Tree, Depth-First Search, Breadth-First Search, Design traversal and subtree aggregation on a representative binary tree.

- **Input:** `{"operations": ["LockingTree", "lock", "unlock", "unlock", "lock", "upgrade", "lock"], "arguments": [[[-1, 0, 0, 1, 1, 2, 2]], [2, 2], [2, 3], [2, 2], [4, 5], [0, 1], [0, 1]]}`
- **Required output:** `[null, true, false, true, true, true, false]`
...
The objective for **Operations on Tree** is to evaluate tree properties by visiting nodes in topological hierarchy (post-order, pre-order, or level-order).

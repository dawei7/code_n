## General
**Competitive Approach — Number of Pairs of Interchangeable Rectangles**
...
Sourced from `kamyu104/LeetCode-Solutions`. This implementation focuses on raw computational throughput in method `interchangeableRectangles`. It minimizes object instantiation overhead, avoids redundant memory passes, and leverages compact iteration loops.

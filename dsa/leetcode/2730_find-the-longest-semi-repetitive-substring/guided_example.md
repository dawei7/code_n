# Guided Example: Find the Longest Semi-Repetitive Substring
...
The objective for **Find the Longest Semi-Repetitive Substring** is to find the optimal contiguous window without evaluating all $O(N^2)$ candidate subarrays.

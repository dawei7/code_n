# Guided Example: Cousins in Binary Tree II

We trace the hierarchical Hash Table, Tree, Depth-First Search, Breadth-First Search, Binary Tree traversal and subtree aggregation on a representative binary tree.

- **Input:** `{"root": [5, 4, 9, 1, 10, null, 7]}`
- **Required output:** `[0, 0, 0, 7, 7, null, 11]`
...
The objective for **Cousins in Binary Tree II** is to evaluate tree properties by visiting nodes in topological hierarchy (post-order, pre-order, or level-order).

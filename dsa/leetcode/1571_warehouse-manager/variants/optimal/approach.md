## General
The optimal solution implements an idiomatic, readable, and production-ready approach for **Warehouse Manager**.
...
## Complexity detail
- **Time Complexity**: $O(W \log W)$ — Operational efficiency across problem constraints.

# Guided Example: Count Negative Numbers in a Sorted Matrix

We trace the logarithmic Array, Binary Search, Matrix search on a representative problem instance.
...
The objective for **Count Negative Numbers in a Sorted Matrix** is to pinpoint the target value or optimal threshold in logarithmic $O(\log N)$ time.

# Guided Example: Painting the Walls
...
The objective for **Painting the Walls** is to compute the global optimal value by decomposing the problem into overlapping subproblems.

# Guided Example: Find the Maximum Length of a Good Subsequence I
...
The objective for **Find the Maximum Length of a Good Subsequence I** is to compute the global optimal value by decomposing the problem into overlapping subproblems.

## General
The optimal solution implements an idiomatic, readable, and production-ready approach for **Find the Missing IDs**.
...
## Complexity detail
- **Time Complexity**: $O((m+c)\log(c+1))$ — Operational efficiency across problem constraints.

# Guided Example: All Elements in Two Binary Search Trees

We trace the hierarchical Tree, Depth-First Search, Binary Search Tree, Sorting, Binary Tree traversal and subtree aggregation on a representative binary tree.

- **Input:** `{"root1": [2, 1, 4], "root2": [1, 0, 3]}`
- **Required output:** `[0, 1, 1, 2, 3, 4]`
...
The objective for **All Elements in Two Binary Search Trees** is to evaluate tree properties by visiting nodes in topological hierarchy (post-order, pre-order, or level-order).

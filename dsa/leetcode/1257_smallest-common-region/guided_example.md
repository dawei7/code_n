# Guided Example: Smallest Common Region

We trace the hierarchical Array, Hash Table, String, Tree, Depth-First Search, Breadth-First Search traversal and subtree aggregation on a representative binary tree.
...
The objective for **Smallest Common Region** is to evaluate tree properties by visiting nodes in topological hierarchy (post-order, pre-order, or level-order).

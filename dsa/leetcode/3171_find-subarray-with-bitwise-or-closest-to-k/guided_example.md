# Guided Example: Find Subarray With Bitwise OR Closest to K

We trace the logarithmic Array, Binary Search, Bit Manipulation, Segment Tree search on a representative problem instance.
...
The objective for **Find Subarray With Bitwise OR Closest to K** is to pinpoint the target value or optimal threshold in logarithmic $O(\log N)$ time.

...
The objective for **Count Nodes Equal to Average of Subtree** is to evaluate tree properties by visiting nodes in topological hierarchy (post-order, pre-order, or level-order).

# Guided Example: Zigzag Level Sum of Binary Tree
...
The objective for **Zigzag Level Sum of Binary Tree** is to evaluate tree properties by visiting nodes in topological hierarchy (post-order, pre-order, or level-order).

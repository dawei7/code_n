...
When writing your own solution, remember that we need to compare values in the nodes, not the nodes themselves. $\text{node}_{1}.val = \text{node}_{2}.val$ is the *correct* way of comparing the nodes. $\text{node}_{1} = \text{node}_{2}$ will *not work* the way you expect.
...
When given the head node (or any other node), referred to as `currentNode`, the algorithm firstly checks the *rest* of the Linked List. If it discovers that further down that the Linked List is *not* a palindrome, then it returns `false`. Otherwise, it checks that $\text{currentNode.val} = \text{frontPointer.val}$. If not, then it returns `false`. Otherwise, it moves `frontPointer` forward by 1 node and returns `true` to say that from this point forward, the Linked List is a valid palindrome.
...
![Slide 1](images/slideshow_234_Palindrome_Linked_List_Slide1.PNG)

![Slide 2](images/slideshow_234_Palindrome_Linked_List_Slide2.PNG)

![Slide 3](images/slideshow_234_Palindrome_Linked_List_Slide3.PNG)

![Slide 4](images/slideshow_234_Palindrome_Linked_List_Slide4.PNG)

![Slide 5](images/slideshow_234_Palindrome_Linked_List_Slide5.PNG)

![Slide 6](images/slideshow_234_Palindrome_Linked_List_Slide6.PNG)

![Slide 7](images/slideshow_234_Palindrome_Linked_List_Slide7.PNG)

![Slide 8](images/slideshow_234_Palindrome_Linked_List_Slide8.PNG)

![Slide 9](images/slideshow_234_Palindrome_Linked_List_Slide9.PNG)

![Slide 10](images/slideshow_234_Palindrome_Linked_List_Slide10.PNG)

![Slide 11](images/slideshow_234_Palindrome_Linked_List_Slide11.PNG)

![Slide 12](images/slideshow_234_Palindrome_Linked_List_Slide12.PNG)

![Slide 13](images/slideshow_234_Palindrome_Linked_List_Slide13.PNG)

![Slide 14](images/slideshow_234_Palindrome_Linked_List_Slide14.PNG)

![Slide 15](images/slideshow_234_Palindrome_Linked_List_Slide15.PNG)

![Slide 16](images/slideshow_234_Palindrome_Linked_List_Slide16.PNG)

![Slide 17](images/slideshow_234_Palindrome_Linked_List_Slide17.PNG)

![Slide 18](images/slideshow_234_Palindrome_Linked_List_Slide18.PNG)

![Slide 19](images/slideshow_234_Palindrome_Linked_List_Slide19.PNG)

![Slide 20](images/slideshow_234_Palindrome_Linked_List_Slide20.PNG)

![Slide 21](images/slideshow_234_Palindrome_Linked_List_Slide21.PNG)

![Slide 22](images/slideshow_234_Palindrome_Linked_List_Slide22.PNG)

![Slide 23](images/slideshow_234_Palindrome_Linked_List_Slide23.PNG)

![Slide 24](images/slideshow_234_Palindrome_Linked_List_Slide24.PNG)

![Slide 25](images/slideshow_234_Palindrome_Linked_List_Slide25.PNG)

![Slide 26](images/slideshow_234_Palindrome_Linked_List_Slide26.PNG)

![Slide 27](images/slideshow_234_Palindrome_Linked_List_Slide27.PNG)

![Slide 28](images/slideshow_234_Palindrome_Linked_List_Slide28.PNG)

![Slide 29](images/slideshow_234_Palindrome_Linked_List_Slide29.PNG)

![Slide 30](images/slideshow_234_Palindrome_Linked_List_Slide30.PNG)

![Slide 31](images/slideshow_234_Palindrome_Linked_List_Slide31.PNG)

![Slide 32](images/slideshow_234_Palindrome_Linked_List_Slide32.PNG)

![Slide 33](images/slideshow_234_Palindrome_Linked_List_Slide33.PNG)

![Slide 34](images/slideshow_234_Palindrome_Linked_List_Slide34.PNG)

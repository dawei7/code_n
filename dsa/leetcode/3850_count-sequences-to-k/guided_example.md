# Guided Example: Count Sequences to K

We derive and execute the Array, Math, Dynamic Programming, Memoization, Number Theory recurrence on a representative problem instance.
...
The objective for **Count Sequences to K** is to compute the global optimal value by decomposing the problem into overlapping subproblems.

# Simplified Approach - Total Sales Amount by Year
...
## Complexity detail
- **Time Complexity**: $O(P + S + R)$ — Each input element is processed in a bounded number of direct operations.
- **Space Complexity**: $O(P + S)$ — Utilizes standard auxiliary storage proportional to the active computation state.

## General
**Competitive Approach — Shortest and Lexicographically Smallest Beautiful String**
...
Sourced from `kamyu104/LeetCode-Solutions`. This implementation focuses on raw computational throughput in method `shortestBeautifulSubstring`. It minimizes object instantiation overhead, avoids redundant memory passes, and leverages compact iteration loops.

# Guided Example: Shortest and Lexicographically Smallest Beautiful String

We trace the dynamic String, Sliding Window sliding window on a representative input instance.

- **Input:** `{"s": "100011001", "k": 3}`
- **Required output:** `"11001"`
...
The objective for **Shortest and Lexicographically Smallest Beautiful String** is to find the optimal contiguous window without evaluating all $O(N^2)$ candidate subarrays.

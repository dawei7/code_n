# Guided Example: Count Paths With the Given XOR Value

We derive and execute the Array, Dynamic Programming, Bit Manipulation, Matrix recurrence on a representative problem instance.
...
The objective for **Count Paths With the Given XOR Value** is to compute the global optimal value by decomposing the problem into overlapping subproblems.

# Guided Example: Distinct Gate Paths to LCA
...
The objective for **Distinct Gate Paths to LCA** is to evaluate tree properties by visiting nodes in topological hierarchy (post-order, pre-order, or level-order).

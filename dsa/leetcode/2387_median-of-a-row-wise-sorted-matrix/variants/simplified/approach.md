# Simplified Approach - Median of a Row Wise Sorted Matrix
...
## Complexity detail
- **Time Complexity**: $O(m log n log V)$ — Each input element is processed in a bounded number of direct operations.

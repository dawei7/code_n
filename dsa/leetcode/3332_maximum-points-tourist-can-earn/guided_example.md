# Guided Example: Maximum Points Tourist Can Earn
...
The objective for **Maximum Points Tourist Can Earn** is to compute the global optimal value by decomposing the problem into overlapping subproblems.

# Guided Example: Earliest Second to Mark Indices I
...
The objective for **Earliest Second to Mark Indices I** is to pinpoint the target value or optimal threshold in logarithmic $O(\log N)$ time.

...
We execute the single-pass Array, Linked List, Stack, Design, Doubly-Linked List, Data Stream pointer manipulation on a representative linked list instance.
...
- **Required output:** `[null, null, null, "facebook.com", "google.com", "facebook.com", null, "linkedin.com", "google.com", "leetcode.com"]`
...
The objective for **Design Browser History** is to transform the linked structure by strictly updating `next` references in place.

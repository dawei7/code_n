# Guided Example: Reverse Odd Levels of Binary Tree
...
- **Required output:** `[2, 5, 3, 8, 13, 21, 34]`
...
The objective for **Reverse Odd Levels of Binary Tree** is to evaluate tree properties by visiting nodes in topological hierarchy (post-order, pre-order, or level-order).

# Simplified Approach - Distinct Prime Factors of Product of Array
...
## Complexity detail
- **Time Complexity**: $O(n sqrt M)$ — Each input element is processed in a bounded number of direct operations.

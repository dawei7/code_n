# Guided Example: Valid Subarrays With Matching Sum Digits I

We trace the dynamic Array, Hash Table, Sliding Window, Enumeration, Prefix Sum sliding window on a representative input instance.
...
The objective for **Valid Subarrays With Matching Sum Digits I** is to find the optimal contiguous window without evaluating all $O(N^2)$ candidate subarrays.

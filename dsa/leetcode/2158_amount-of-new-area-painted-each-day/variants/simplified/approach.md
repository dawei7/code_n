# Simplified Approach - Amount of New Area Painted Each Day
...
## Complexity detail
- **Time Complexity**: $O((n + p) \alpha(p))$ — Each input element is processed in a bounded number of direct operations.

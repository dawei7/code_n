...
- **Output:** `[3,3,1]`
- **Explanation:** On day 0, paint everything between 1 and 4.
...
![](images/screenshot-2022-02-01-at-17-17-45-diagram-drawio-diagrams-net.png)
...
![](images/screenshot-2022-02-01-at-17-19-49-diagram-drawio-diagrams-net.png)

- **Input:** $paint = [[1,5],[2,4]]$
- **Output:** `[4,0]`
- **Explanation:** On day 0, paint everything between 1 and 5.
...
- $\text{paint}[i].length = 2$

- $0 \le \text{start}_{i} < \text{end}_{i} \le 5 * 10^{4}$

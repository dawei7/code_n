# Guided Example: Find the Maximum Sequence Value of Array
...
The objective for **Find the Maximum Sequence Value of Array** is to compute the global optimal value by decomposing the problem into overlapping subproblems.

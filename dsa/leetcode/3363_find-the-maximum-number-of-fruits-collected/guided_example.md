# Guided Example: Find the Maximum Number of Fruits Collected
...
The objective for **Find the Maximum Number of Fruits Collected** is to compute the global optimal value by decomposing the problem into overlapping subproblems.

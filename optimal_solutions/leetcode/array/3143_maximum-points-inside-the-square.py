...
def solve(points: list[list[int]], s: str) -> int:
    ...
    for i in range(len(points)):
        ...
        if char in min_dist:
            ...
            # The square must be smaller than the distance of the second point
            # found for this specific character.
            second_min_dist = min(second_min_dist, dist, min_dist[char])
